...
var PictureListFrame=Class({create:function(a,b){this.currentPageIndex=BookInfo.getCurrentPageIndex()||1;this.imageWidth=100;this.callback=a;this.options=b||{};this.showNavigation=!1!==this.options.showNavigation;this.showPageInfo=!1!==this.options.showPageInfo;this.leftButtonUrl=form_icons.print_left?"data:image/png;base64,"+form_icons.print_left:uiBaseURL+"print_left.png";this.rightButtonUrl=form_icons.print_right?"data:image/png;base64,"+form_icons.print_right:uiBaseURL+"print_right.png";this.initDefaultDom();
this.initHtml();this.initEvent();this.fillContent(this.currentPageIndex)},initDefaultDom:function(){this.thumbnail=$("<div class='thumbnail'></div>");this.page=$("<div class='page'></div>");this.image=$("<img alt='' />");this.noThumbBg=$("<div style='display:none;margin: 0 auto;background:"+bookConfig.pageBackgroundColor+"; width:100px;height:130px;'></div>");this.options.leftButton?(this.leftBtn=this.options.leftButton,this.rightBtn=this.options.rightButton):(this.leftBtn=$('\n        <button class="aria-label-button" aria-label=\''+
getLanguage("ariaPreviousPage","previous page")+"'>\n          <img alt='' aria-hidden=\"true\" class='leftBtn button_hover' src='"+this.leftButtonUrl+"'/>\n        </button>\n      "),this.rightBtn=$('\n        <button class="aria-label-button" aria-label=\''+getLanguage("ariaNextPage","next page")+"'>\n          <img alt='' aria-hidden=\"true\" class='rightBtn button_hover' src='"+this.rightButtonUrl+"'/>\n        </button>\n      "));this.thumbnail.append(this.noThumbBg).append(this.image);this.thumbnail.append(this.page)},
resetBtnSrc:function(){this.options.leftButton?(this.leftBtn=this.options.leftButton,this.rightBtn=this.options.rightButton):(this.leftBtn.attr("src",this.leftButtonUrl),this.rightBtn.attr("src",this.rightButtonUrl))},initEvent:function(){var a=this;this.leftBtn.on(_event._click,function(){a.fillContent(a.currentPageIndex-1)});this.rightBtn.on(_event._click,function(){a.fillContent(a.currentPageIndex+1)})},fillContent:function(a){var b=this;1>a||a>bookConfig.totalPageCount||(1==a?this.leftBtn.css({opacity:"0.4",
cursor:"auto"}):this.leftBtn.css({opacity:"1",cursor:"pointer"}),a==bookConfig.totalPageCount?this.rightBtn.css({opacity:"0.4",cursor:"auto"}):this.rightBtn.css({opacity:"1",cursor:"pointer"}),this.currentPageIndex=a,pageResourceLoad(a,"thumb",function(c,d){c.match(/^none/)?(b.noThumbBg.css({display:"block"}),b.image.css({display:"none"})):(b.image.attr("src",c),b.noThumbBg.css({display:"none"}),b.image.css({display:"inline-block",width:b.imageWidth+"px",height:"130px",objectFit:"contain"}))}),this.fillPage(a),
this.callback&&this.callback(a))},fillPage:function(a){this.page.html(a+"/"+bookConfig.totalPageCount)},getPageIndex:function(){return this.currentPageIndex},updateVisibility:function(){this.showNavigation&&1<bookConfig.totalPageCount?(this.stage.find(this.leftBtn).length||this.stage.prepend(this.leftBtn),this.stage.find(this.rightBtn).length||this.stage.append(this.rightBtn),this.leftBtn.show(),this.rightBtn.show()):(this.leftBtn.hide(),this.rightBtn.hide());this.showPageInfo?(this.thumbnail.find(this.page).length||
this.thumbnail.append(this.page),this.page.show()):this.page.hide()},setNavigationVisible:function(a){this.showNavigation=a;this.updateVisibility()},setPageInfoVisible:function(a){this.showPageInfo=a;this.updateVisibility()},setControlsVisible:function(a){this.showPageInfo=this.showNavigation=a;this.updateVisibility()}}),PictureListForm=Class({initHtml:function(){this.stage=$("<div class='"+(this.options&&this.options.className?this.options.className:"pictureList_win10")+"'></div>");this.stage.append(this.thumbnail);
this.updateVisibility()},getDom:function(){return this.stage}}).extend(PictureListFrame),AnalysisPrint=Class({create:function(a,b){b=void 0===b?{}:b;this.printArea=$("<div class='print-area' style='width:100%;height:100%;position:absolute;left:0;top:0;'></div>");this.button=a;this.parent=b.parent||tmpContainer;this.options=b;this.initPrintEvent()},getImageSizeForMM:function(a,b){return a/210>=b/297?{width:210,height:Math.floor(210*b/a)}:{width:Math.floor(297*a/b),height:297}},getImageSizeForInches:function(a,
b){return a/7.18>=b/10.61?{width:7.18,height:Number.fixed(7.18*b/a,2)}:{width:Number.fixed(10.61*a/b,2),height:10.61}},getImageSizeForIE:function(a,b){return a/8>=b/11.3?{width:8,height:Number.fixed(8*b/a,2)}:{width:Number.fixed(11.3*a/b,2),height:11.3}},printPages:function(a){var b=this,c,d,e,g,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(!a||!a.length||!parseBool(bookConfig.PrintButtonVisible))return k.return();b.initLoadPrint();c=0;b.printArea.empty();b.printArray=[];d=
function(l,m,p,n){var q=this,t,r,x,u,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){switch(w.nextAddress){case 1:return t=$("<div style='position:relative;width:100%;height:100%;'></div>"),r=$(p),l&&-1<l.indexOf("none")&&!l.startsWith("data:image")&&m&&0>m.indexOf("none")&&(r=$(m)),void 0===n&&(n=p),w.setCatchFinallyBlocks(2),w.yield(q.createCompositeImage(r,l),4);case 4:(x=w.yieldResult)&&(r=$(x));w.leaveTryBlock(3);break;case 2:u=w.enterCatchBlock(),console.error("Canvas\u935a\u581f\u579a\u6fb6\u8fab\u89e6:",
u);case 3:t.append(r);$(r).parent().css({"text-align":"center",width:"100%",height:"100%"});r.css({"text-align":"center","max-width":"100%","max-height":"100%"});"stretch"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%"}):"fill"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%","object-fit":"cover"}):$(r).parent().css({display:"flex","justify-content":"center","align-items":"center"});q.printArray[n]=t;c++;if(c==a.length){for(v=0;v<q.printArray.length;v++)q.printArray[v]&&
q.printArea.append(q.printArray[v]);q.printArea.printArea({onReady:q.hidePrintLoading.bind(q)})}w.jumpToEnd()}})};e=BookInfo.getBook().pageWidth;g=BookInfo.getBook().pageHeight;f={};for(h=0;h<a.length;f={$jscomp$loop$prop$page$6:f.$jscomp$loop$prop$page$6},h++)f.$jscomp$loop$prop$page$6=a[h],getPageDir(f.$jscomp$loop$prop$page$6,"normal").then(function(l){return function(m){var p=e,n=g;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),
p=2*e,n=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$6).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$6,q,d.bind(b),p,n)}):pageResourceLoad(l.$jscomp$loop$prop$page$6,"normal",d.bind(b),p,n)}}(f));k.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),h=new Image;h.crossOrigin="anonymous";h.onload=function(){var k,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==
n.nextAddress)return n.setCatchFinallyBlocks(2),g.width=h.naturalWidth,g.height=h.naturalHeight,f.drawImage(h,0,0),n.yield(c.createWatermarkWithPageWatermark(h.naturalWidth,h.naturalHeight),4);if(2!=n.nextAddress)return(k=n.yieldResult)?f.drawImage(k,0,0):console.log("watermarkCanvas error"),l=g.toDataURL("image/png"),m=document.createElement("img"),m.src=l,m.style.cssText=a[0].style.cssText,d(m),n.leaveTryBlock(0);p=n.enterCatchBlock();console.error("canvas error:",p);d(null);n.jumpToEnd()})};h.onerror=
function(){console.log("img.onerror:",b);d(null)};h.src=b}catch(k){console.log("createCompositeImage error:",k),d(null)}})},createWatermarkWithPageWatermark:function(a,b){return new Promise(function(c){if(parseBool(bookConfig.PrintButtonVisible)&&bookConfig.printWatermark)try{var d=document.createElement("canvas");d.width=a;d.height=b;var e=new WatermarkCore(d),g=BookInfo.getBook().pageWidth,f=BookInfo.getBook().pageHeight,h=Math.min(a/g,b/f),k={position:bookConfig.watermarkPosition,width:(bookConfig.watermarkWidth||
100)*h,height:(bookConfig.watermarkHeight||50)*h,opacity:bookConfig.watermarkOpacity,spacing:(bookConfig.watermarkSpacing||50)*h,rotation:bookConfig.watermarkRotation,watermarkEdgeMargin:(bookConfig.watermarkEdgeMargin||12)*h,watermarkImage:new Image};if(bookConfig.printWatermarkFile){if(k.watermarkImage.src=bookConfig.printWatermarkFile,k.watermarkImage.onload=function(){try{bookConfig.watermarkHeight||(k.height=k.width*k.watermarkImage.height/k.watermarkImage.width),e.applyWatermark(k),c(d)}catch(l){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",
l),c(null)}},k.watermarkImage.complete)try{bookConfig.watermarkHeight||(k.height=k.width*k.watermarkImage.height/k.watermarkImage.width),e.applyWatermark(k),c(d)}catch(l){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",l),c(null)}}else c(null)}catch(l){console.error("\u9352\u6d98\u7f13\u59d8\u6751\u5d43canvas\u6fb6\u8fab\u89e6:",l),c(null)}else c(null)})},getPrintImgType:function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return b=
"normal",e.yield(getPageDir(a,"thumb"),2);if(3!=e.nextAddress)return c=e.yieldResult,e.yield(getPageDir(a,"previewPage"),3);d=e.yieldResult;c.match(/none/)?d.match(/none/)||(b="previewPage"):b="thumb";return e.return(b)})},getPages:function(a){if("all"==a){a=[];for(var b=1;b<=bookConfig.totalPageCount;b++)a.push(b);return a}return"current"==a?this.options.getCurrentPages?this.options.getCurrentPages():BookInfo.getCurrentPages():getPagesByRange(a)},initPrintEvent:function(){this.button.bind(_event._click,
function(a){this.printType=this.button.printType;switch(this.printType){case "printAll":var b=this.getPages("all");this.printPages(b);break;case "printCurrent":b=this.getPages("current");this.printPages(b);break;case "printRange":var c=$("#print_range_num").val();if(0>=parseInt(c))return;b=this.getPages(c);this.printPages(b)}if("printAll"===this.printType){var d="print_all_pages";var e="all pages"}else"printCurrent"===this.printType?(d="print_page_"+b.join("_"),e=b.join("_")):"printRange"===this.printType&&
(a=c.replace(/,/g,"_"),d="print_page_"+a,e=a);BookEvent.trigger("customEvent",[d,{printed_page:e}]);BookEvent.trigger("print",[BookInfo.getCurrentPageIndex(),"printAll"==this.printType?"all":b.join(","),this.printType])}.bind(this))},initPrintStack:function(a){window.printLoadStack&&(window.printLoadStack.destroy(),window.printLoadStack=null);window.printLoadStack||(window.printLoadStack=new PdfLoadArray(a.length))},initLoadPrint:function(){this.printLoad||(this.printLoad=$("<div class='posterContainer'></div>"),
this.printLoad.css({display:"none","z-index":"10001",position:"absolute",left:"0",top:"0",width:"100%",height:"100%",background:"rgba(11,11,11,0.7)"}),this.printLoad.bind("click",function(a){a.stopPropagation();window.printLoadStack&&window.printLoadStack.destroy();this.hidePrintLoading()}.bind(this)),this.loadingIcon=$("<img alt='' style='position:absolute;transform : translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);left : 50%;top : 50%;z-index:1112' src='"+uiBaseURL+"loading.gif' />"),
this.printLoad.append(this.loadingIcon),this.parent.append(this.printLoad));this.showPrintLoading()},showPrintLoading:function(){this.printLoad&&this.printLoad.fadeIn(200)},hidePrintLoading:function(){this.printLoad&&this.printLoad.fadeOut(200)}}),PrintElements=Class({create:function(a){this._super(a);this.printOnUrl=form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";this.printOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+
"print_off.png";this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("\n        <div class='printAll item button' print='printAll'>\n          <span class='aria-label-title'>"+getLanguage("frmPrintall","Print All Pages")+"</span>\n          <img alt='' src='"+this.printOffUrl+"'/>\n        </div>\n      "),this.printCurrent=$("\n        <div class='printCurrent item on button' print='printCurrent'>\n          <span class='aria-label-title'>\n          "+
getLanguage("frmPrintcurrent","Print Current Pages")+"\n          </span>\n          <img alt='' src='"+this.printOnUrl+"'/>\n        </div>\n      "),this.printRange=$("\n        <div class='printRange item button' print='printRange'>\n          <input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'>\n          <label for='print_range_num' class='aria-label-title'>"+getLanguage("frmPrintRange","Print Range")+"</label>\n          <img alt='' src='"+
this.printOffUrl+"'/>\n        </div>\n      ")):(this.printAll=$("\n        <div class='printAll item button' print='printAll'>\n          <img alt='' src='"+this.printOffUrl+"'/>\n          <span class='aria-label-title'>"+getLanguage("frmPrintall","Print All Pages")+"</span>\n        </div>\n      "),this.printCurrent=$("\n        <div class='printCurrent item on button' print='printCurrent'>\n          <img alt='' src='"+this.printOnUrl+"'/>\n          <span class='aria-label-title'>"+getLanguage("frmPrintcurrent",
"Print Current Pages")+"</span>\n        </div>\n      "),this.printRange=$("\n        <div class='printRange item button' print='printRange'>\n          <img alt='' src='"+this.printOffUrl+"'/>\n          <label for='print_range_num' class='aria-label-title'>\n            "+getLanguage("frmPrintRange","Print Range")+"\n          </label>\n          <input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'>\n        </div>\n      "));this.printButton=$("\n      <div class='printButton title button'>"+
getLanguage("frmPrintbtn","Print")+"</div>\n    ");this.printButton.printType="printCurrent";this.analysis=new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},pickElements:function(a){a.printOnUrl=this.printOnUrl;a.printOffUrl=this.printOffUrl;a.printAll=this.printAll;a.printCurrent=this.printCurrent;a.printRange=this.printRange;a.printButton=this.printButton;a.pictureListForm=this.pictureListForm},initEvent:function(a){this.printAll.click(function(b){this.buttonEvent(a,
...
this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("\n        <div class='printAll item button' print='printAll'>\n          <span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span>\n          <div class='print_icon'>"+this.getOffIcon()+"</div>\n        </div>\n      "),this.printCurrent=$("\n        <div class='printCurrent item on button' print='printCurrent'>\n          <span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span>\n          <div class='print_icon'>"+
this.getOnIcon()+"</div>\n        </div>\n      "),this.printRange=$("\n        <div class='printRange item button' print='printRange'>\n          <div class='print_icon'>"+this.getOffIcon()+"</div>\n          <input id='print_range_num' dir='rtl' placeholder='"+getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'>\n          <label for='print_range_num' class='title'>"+getLanguage("frmPrintRange","Print Range")+"</label>\n        </div>\n      ")):(this.printAll=$("\n        <div class='printAll item button' print='printAll'>\n          <div class='print_icon'>"+
this.getOffIcon()+"</div>\n          <span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span>\n        </div>\n      "),this.printCurrent=$("\n        <div class='printCurrent item on button' print='printCurrent'>\n          <div class='print_icon'>"+this.getOnIcon()+"</div>\n          <span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span>\n        </div>\n      "),this.printRange=$("\n        <div class='printRange item button' print='printRange'>\n          <div class='print_icon'>"+
this.getOffIcon()+"</div>\n          <label for='print_range_num' class='title'>\n            "+getLanguage("frmPrintRange","Print Range")+"\n          </label>\n          <input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'>\n        </div>\n      "));this.printButton=$("\n      <div class='printButton title button' role='button'>"+getLanguage("frmPrintbtn","Print")+"</div>\n    ");this.printButton.printType="printCurrent";this.analysis=new AnalysisPrint(this.printButton);
...
color:this.fontColor})},initHtml:function(){this._super()},appendPrintOptions:function(a){this.emptyTips=$('<div><span class="empty-printoptions-tips" >'+getLanguage("emptyPrintOptionsTips","No printing options.")+"</span></div>");this.emptyTips.css({height:"150px",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});a=a||this.stage;bookConfig.printOptions&&0<bookConfig.printOptions.length?(0<=bookConfig.printOptions.indexOf("all")&&a.append(this.printAll),
0<=bookConfig.printOptions.indexOf("current")&&a.append(this.printCurrent),0<=bookConfig.printOptions.indexOf("range")&&a.append(this.printRange),a.append(this.printButton)):a.append(this.emptyTips)},changeIconColor:function(){this._super();this.pictureListForm.leftBtn.changeButtonColor(this.fontColor);this.pictureListForm.rightBtn.changeButtonColor(this.fontColor);this.changeItemColor()},resetColorChanged:function(){this._super();this.printAll.find("img")[0].colorChanged=!1;this.printCurrent.find("img")[0].colorChanged=
!1;this.printRange.find("img")[0].colorChanged=!1;this.pictureListForm&&(this.pictureListForm.leftBtn[0].colorChanged=!1,this.pictureListForm.rightBtn[0].colorChanged=!1)},resetIconSrc:function(){this._super();this.stage.find(".item").find("img").attr("src",this.elements.printOffUrl);this.stage.find(".on").find("img").attr("src",this.elements.printOnUrl);this.pictureListForm&&this.pictureListForm.resetBtnSrc()},changeItemColor:function(){this.printCurrent.changeButtonColor(this.fontColor);this.printRange.changeButtonColor(this.fontColor);
this.printAll.changeButtonColor(this.fontColor)},onShow:function(){this.changeIconColor()}}).extend(FadeOutFadeForm),PhonePrintForm=Class({create:function(a){this.elements=new PhonePrintElements(this);this._super(a)},onCreate:function(){this.printAll.css({"background-color":this.fontColor,color:this.mainColor});this.printCurrent.css({"background-color":this.fontColor,color:this.mainColor});this.printRange.css({"background-color":this.fontColor,color:this.mainColor});this.printButton.css({"background-color":this.fontColor,
color:this.mainColor});this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){this.title.append(this.close);this.stage.append(this.title);this.appendPrintOptions()},changeItemColor:function(){},onShow:function(){this.favicon&&this.favicon.changeButtonColor(this.fontColor)},initEvent:function(){},appendPrintOptions:function(){this.emptyTips=$('<div><span class="no-files-prompt" >'+getLanguage("emptyPrintOptionsTips","No printing options.")+"</span></div>");
this.emptyTips.css({height:"150px",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});var a=this.stage;bookConfig.printOptions&&0<bookConfig.printOptions.length?(0<=bookConfig.printOptions.indexOf("all")&&a.append(this.printAll),0<=bookConfig.printOptions.indexOf("current")&&a.append(this.printCurrent),0<=bookConfig.printOptions.indexOf("range")&&a.append(this.printRange),a.append(this.printButton)):a.append(this.emptyTips)}}).extend(PhoneFormFrame),
DownloadElements=Class({create:function(a){this._super(a);this.downloadOnUrl=form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";this.downloadOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+"print_off.png";this.initConfig();this.initElements();this.initEvent(a);this.pickElements(a);bookConfig.isEncryptionBook&&!BookRestrict.open&&this.setRestrictMode()},initConfig:function(){this.service=new DownloadService({downloadconfig:window.downloadconfig});
this.downloadconfig=this.service.downloadconfig},initElements:function(){this.rightToLeft?(this.downloadAll=$("<div class='buttondownloadAll item' download='downloadAll'><span class='title'>"+getLanguage("DownloadFullPublication","Full Publication")+"</span><img alt='' src='"+this.downloadOffUrl+"'/></div>"),this.downloadCurrent=$("<div class='button downloadCurrent item' download='downloadCurrent'><span class='title'>"+getLanguage("DownloadCurrentPage","Current Page")+" </span><span class='page'>"+
this.pageIndex+"</span><img alt='' src='"+this.downloadOffUrl+"'/></div>"),this.downloadAttachments=$("<div class='button downloadAttachments item' download='downloadAttachments'><span class='title'>"+getLanguage("DownloadAttachedFiles","Attached Files")+"</span><img alt='' src='"+this.downloadOffUrl+"'/></div>")):(this.downloadAll=$("<div class='button downloadAll item' download='downloadAll'><img alt='' src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadFullPublication","Full Publication")+
"</span></div>"),this.downloadCurrent=$("<div class='button downloadCurrent item' download='downloadCurrent'><img alt='' src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadCurrentPage","Current Page")+"</span><span class='page'>"+this.pageIndex+"</span></div>"),this.downloadAttachments=$("<div class='button downloadAttachments item' download='downloadAttachments'><img alt='' src='"+this.downloadOffUrl+"'/><span class='title'>"+getLanguage("DownloadAttachedFiles","Attached Files")+
"</span></div>"));this.downloadButton=$("<div class='button downloadButton title button_hover'>"+getLanguage("btnDownload","Download")+"</div>");this.restrictedTips=$("<div class='download-restricted-tips'>*"+getLanguage("downloadRestrictionTips","English"==UserGroups?"Download access for this book is restricted by the publisher.":"\u89e3\u9664\u9605\u8bfb\u9650\u5236\u540e\u624d\u80fd\u4e0b\u8f7d\u3002")+"</div>");this.restrictedTips.css({color:"#ff6d6d","line-height":"14px","margin-top":"8px","text-align":"left"});
this.noFilesAvailablePrompt=$('<div><span class="no-files-prompt" >'+getLanguage("noFilesAvailablePrompt","No Files Available!")+"</span></div>");this.noFilesAvailablePrompt.css({height:"100%",width:"100%",display:"flex","align-items":"center","justify-content":"center","font-size":"20px"});this.downloadingTips=$("<div class='download-loading-tips'>"+getLanguage("downloadingTips","English"===UserGroups?"Downloading...":"\u6b63\u5728\u4e0b\u8f7d\uff0c\u8bf7\u7a0d\u7b49...")+"</div>");this.downloadingTips.css({color:Color(bookConfig.formFontColor?
bookConfig.formFontColor:bookConfig.iconColor).toString(),padding:"0 20px"});this.downloadButton.downloadType=downloadconfig.hideDownloadSinglePage?downloadconfig.pdf?"downloadAll":"downloadAttachments":"downloadCurrent";this[this.downloadButton.downloadType].find("img").attr("src",this.downloadOnUrl);this[this.downloadButton.downloadType].addClass("on");this.selectAttachments=$('\n      <select aria-label="'+getLanguage("SelectFileToDownload","Select file to download")+'" id="download-select-attachments">\n      </select>\n      ');
this.selectAttachments.css({display:"downloadAttachments"===this.downloadButton.downloadType?"inline-block":"none"});var a=this.downloadconfig.attachments;if(a&&0<a.length){for(var b=0;b<a.length;b++){var c=a[b];this.selectAttachments.append($("<option value='"+c.file+"'>"+c.name+"</option>"))}var d=this;this.currentAttachmentName=this.selectAttachments.find("option")[0].innerText;this.selectAttachments.on("change",function(){d.currentAttachmentName=this.options[this.selectedIndex].innerText})}this.pictureListForm=
new PictureListForm(this.gotoPage.bind(this));this.pageIndex=this.pictureListForm.getPageIndex()},setRestrictMode:function(){var a=this;this.downloadButton.removeClass("button_hover");this.downloadButton.addClass("disable");BookEvent.bindEvent("fillBookRestrict",function(b,c){c&&a.removeRestrictMode()})},removeRestrictMode:function(){this.downloadButton.removeClass("disable");this.downloadButton.addClass("button_hover");this.restrictedTips&&this.restrictedTips.remove()},gotoPage:function(a){this.pageIndex=
a;this.downloadCurrent.find(".page").html(a)},pickElements:function(a){a&&(a.downloadAll=this.downloadAll,a.downloadCurrent=this.downloadCurrent,a.downloadAttachments=this.downloadAttachments,a.selectAttachments=this.selectAttachments,a.downloadButton=this.downloadButton,a.pictureListForm=this.pictureListForm,a.noFilesAvailablePrompt=this.noFilesAvailablePrompt,a.restricted=this.restricted,a.restrictedTips=this.restrictedTips)},get restricted(){return this.service.isRestricted()},initEvent:function(a){var b=
this;this.downloadAll.click(function(c){this.buttonEvent(a,c.delegateTarget)}.bind(this));this.downloadCurrent.click(function(c){this.buttonEvent(a,c.delegateTarget)}.bind(this));this.downloadAttachments.click(function(c){this.buttonEvent(a,c.delegateTarget)}.bind(this));this.verify=!1;this.downloadButton.click(function(){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(b.restricted)return d.return();c=function(){var e,g,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){e=
b.downloadButton.downloadType;g=b.pageIndex;f=b.currentAttachmentName||"";h=b.selectAttachments[0].value;return k.yield(b.service.doDownload(e,g,f,h,b.downloadButton,b.downloadingTips),0)})};if(b.service.isRestricted())return d.return();b.service.ensurePasswordThen(c);d.jumpToEnd()})})},buttonEvent:function(a,b){var c=a.stage.find(".on");c.find("img").attr("src",this.downloadOffUrl);c.find("img")[0].colorChanged=!1;c.removeClass("on");$(b).find("img").attr("src",this.downloadOnUrl);$(b).find("img")[0].colorChanged=
!1;$(b).addClass("on");b=$(b).attr("download");a.downloadButton.downloadType=b;a.changeItemColor();"downloadAttachments"==b?a.selectAttachments.show():a.selectAttachments.hide()},changeLanguage:function(){this.selectAttachments.attr("aria-label",getLanguage("SelectFileToDownload","Select file to download"));this.downloadAll.find(".title").html(getLanguage("DownloadFullPublication","Full Publication"));this.downloadCurrent.find(".title").html(getLanguage("DownloadCurrentPage","Current Page"));this.downloadAttachments.find(".title").html(getLanguage("DownloadAttachedFiles",
...
color:this.fontColor});this.borderColor=this.mainColorObj.reduce(26);this.itemBgColor=this.mainColorObj.add(24)},initHtml:function(){var a=this;this.restricted&&(this.loadingBox=$("<img alt='' src='"+uiBaseURL+"loading.svg'/>"),this.loadingBox.css({position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)"}),this.content1.append(this.restrictedTips),BookRestrict.isLoaded||(this.content1.hide(),this.content2.hide(),this.content.append(this.loadingBox),BookEvent.bindEvent("onLoadBookRestrict",
...
this.panel.find(".download-password-subTitle").text(getLanguage("downloadPasswordSubTitle","\u8bf7\u8f93\u5165\u5bc6\u7801\u4e0b\u8f7d"));this.panel.find(".download-password-confirm").text(getLanguage("downloadPasswordConfirm","\u786e\u5b9a"));this.panel.find(".download-password-input").attr("placeholder",getLanguage("downloadPasswordPlaceholder","\u8bf7\u8f93\u5165\u4e0b\u8f7d\u5bc6\u7801"))}});var DownloadService=function(a){this.downloadconfig=a&&a.downloadconfig||window.downloadconfig||{}};
DownloadService.prototype.hasFiles=function(){var a=this.downloadconfig||{};return!a.hideDownloadSinglePage||!!a.pdf||a.attachments&&0<a.attachments.length};DownloadService.prototype.getInitialType=function(){var a=this.downloadconfig||{};return a.hideDownloadSinglePage?a.pdf?"downloadAll":"downloadAttachments":"downloadCurrent"};DownloadService.prototype.isRestricted=function(){return!(!bookConfig.isEncryptionBook||BookRestrict.open)};
DownloadService.prototype.ensurePasswordThen=function(a){var b=this.downloadconfig||{};b.code?(this._passwordPanel||(this._passwordPanel=new DownloadPasswordPanel({parent:$("body"),code:b.code,callback:a})),this._passwordPanel.showOrHide()):a()};
DownloadService.prototype.buildUrl=function(a,b,c){var d=this,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){return 1==g.nextAddress?(e=d.downloadconfig||{},"downloadAll"===a?g.return(e.pdf&&e.pdf.url?e.pdf.url:""):"downloadCurrent"!==a?g.jumpTo(2):g.yield(getPageDir(b,"normal"),3)):2!=g.nextAddress?g.return(g.yieldResult):"downloadAttachments"===a?g.return(c||""):g.return("")})};
DownloadService.prototype.doDownload=function(a,b,c,d,e,g){var f=this,h,k,l,m,p,n,q,t,r,x;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h={downloadAll:"download_full_publication",downloadCurrent:"download_page_"+b,downloadAttachments:"download_attachment_"+c},"downloadCurrent"===a?BookEvent.trigger("customEvent",[h[a],{downloaded_page:b}]):BookEvent.trigger("customEvent",[h[a]]),u.yield(f.buildUrl(a,b,d),2);k=u.yieldResult;if("object"===typeof k){if("downloadCurrent"===
a)f._loadImageToCanvas(k,function(v,w){f._createAndTriggerDownload(w.toDataURL("image/png"),"page"+b+".png")});else for(l=0;l<k.length;l++)m=k[l],bookConfig.isEncryptionBook||(m=m.removeStartFrom("?")),window.open(m,"_blank");return u.return()}if("string"===typeof k&&-1<k.indexOf(".zip")&&"downloadAttachments"!==a)return f._pdfLoadingTask&&(f._pdfLoadingTask.pause(),f._pdfLoadingTask.destroy()),f._pdfLoadingTask=new PdfLoadingTask(b,"normal",windowWidth,windowHeight,function(v){f._createAndTriggerDownload(v.toDataURL("image/png"),
"page"+b+".png")}),f._pdfLoadingTask.start(),u.return();if(-1<k.indexOf(".js"))return pageResourceLoad(b,"normal",function(v){f._createAndTriggerDownload(v,"page"+b+".png")}),u.return();"downloadCurrent"===a&&isSupportWebp&&!bookConfig.isEncryptionBook&&(k=k.removeStartFrom("?"),-1<k.indexOf("webp")&&(k+="?x-oss-process=image/format,jpg"));if(k.match(/^none/))return p=document.createElement("canvas"),n=p.getContext("2d"),p.width=bookConfig.largePageWidth,p.height=bookConfig.largePageWidth,n.fillStyle=
bookConfig.pageBackgroundColor,n.fillRect(0,0,bookConfig.largePageWidth,bookConfig.largePageHeight),f._createAndTriggerDownload(p.toDataURL("image/png"),"page"+b+".png"),u.return();q="";"downloadCurrent"===a&&(q=b+".jpg");"downloadAttachments"===a&&(q=c||"");if(location.protocol.match("file:"))return/^\/\//i.test(k)&&(k="https://"+k),"English"==UserGroups&&"downloadAll"==a&&(t=window.location.href,k=k.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(t))),window.open(k),u.return();if("downloadAll"===
a)return"English"===UserGroups&&(r=window.location.href,k=k.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(r))),bookConfig.isEncryptionBook&&(x=BookRestrict.getRestrictToken(),k=appendParamToUrl(k,"code="+x)),window.open(k,"_blank"),u.return();if(isAndroid()&&isWeChat()||isPad())return window.open(k,"_blank"),u.return();if((!isPhone()&&!isPad()||_agent_.browser.safari)&&/fliphtml5|yunzhan365|anyflip|pubhtml5/.test(location.host))return f._createAndTriggerDownload(k,q),u.return();new DownloadFile({url:k,
downloadName:q,downloadButton:e,downloadingTips:g});u.jumpToEnd()})};DownloadService.prototype._createAndTriggerDownload=function(a,b,c){a=$('<a href="'+a+'" download="'+b+'" target="'+(void 0===c?"_blank":c)+'"></a>');a[0].click();a.remove()};
DownloadService.prototype._loadImageToCanvas=function(a,b){var c=document.createElement("canvas"),d=c.getContext("2d");c.style.position="relative";c.width=bookConfig.largePageWidth;c.height=bookConfig.largePageHeight;c.style.width=bookConfig.largePageWidth+"px";c.style.height=bookConfig.largePageHeight+"px";Promise.all(a.map(function(e){return new Promise(function(g,f){var h=new Image;h.crossOrigin="Anonymous";h.src=e.replace(/^http:/,"https:");h.onload=function(){g(h)};h.onerror=function(){f(Error("Failed to load image: "+
e))}})})).then(function(e){e.forEach(function(g){var f=g.naturalWidth,h=g.naturalHeight;if(bookConfig.largePageWidth/bookConfig.largePageHeight>f/h){var k=bookConfig.largePageHeight;var l=f/h*k}else l=bookConfig.largePageWidth,k=h/f*l;d.drawImage(g,(bookConfig.largePageWidth-l)/2,(bookConfig.largePageHeight-k)/2,l,k)});b&&b(a,c)}).catch(function(){b&&b(a,c)})};global.DownloadService=DownloadService;
...
this.addItem(language[a].language)},addItem:function(a){var b=this;if(a){var c=a;if(isPhone()||isPad())c="&nbsp;&nbsp;&nbsp;"+a;var d=$("\n      <button class='item'>\n        <span class='title'>"+c+"</span>\n        <img alt='' aria-hidden='true' src='"+this.choosedUrl+"'/>\n      </button>");a.toLowerCase()===bookConfig.language.toLowerCase()&&(d.addClass("focus"),this.currentItem=d);d.on(_event._click,function(){b.refreshLanguage(a);b.currentItem=d;b.scrollBox.find(".focus").removeClass("focus");
d.addClass("focus");BookEvent.trigger("customEvent",["change_lang_to_"+a.toLowerCase()])});this.scrollList.append(d);this.itemArray.push(d)}},refreshLanguage:function(a){changeLanguage(a)},initEvent:function(a){},pickElements:function(a){a.choosedUrl=this.choosedUrl;a.itemArray=this.itemArray;a.scrollBox=this.scrollBox},changeLanguage:function(){}}).extend(FormElements);
Class("PcLanguageForm",{create:function(a){this.elements=new LanguageElements(this);this._super(a)},onCreate:function(){this.close.changeButtonColor(this.color);this._super()},initEvent:function(){var a=this;this._super();this.stage.on(_event._click,function(){return a.hide()});for(var b=0;b<this.itemArray.length;b++)this.itemArray[b].on(_event._click,function(){return a.hide()})},initHtml:function(){this.title.append(this.close);this.stage.append(this.title);this.stage.append(this.scrollBox)},onResize:function(){},
onShow:function(){}}).extend(FadeOutFadeForm);
...
this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){bookConfig.helpContentFileURL?this.image=$("<div></div>"):(this.helpUrl=form_icons.help_form?"data:image/png;base64,"+form_icons.help_form:uiBaseURL+"help_form.png",this.image=$("<img alt='' class='logo' src='"+this.helpUrl+"'/>"),this.title1=$("<p class='description'>"+getLanguage("lblHelp1","Drag the page corner to view")+"</p>"),this.title2=$("<p class='description'>"+getLanguage("lblHelp2","Double click to zoom in, out")+
...
$("<canvas style='z-index:1;left: 50%;top: 50%;position: absolute;-webkit-transform: translate(-50%,-50%) scale("+this.scale+");transform: translate(-50%,-50%) scale("+this.scale+");'></canvas>");this.ctx=this.canvas[0].getContext("2d");this.thumb=$("<img alt='' crossOrigin='Anonymous' style='border: 1px solid #e5e5e5;width: 100%;height: 100%;position: absolute;left:0;bottom: 0;'/>");this.cvsBg=$("<img alt='' crossOrigin='Anonymous' src='"+uiBaseURL+"posterBg.jpg' />");this.qrcodeBox=$("<div style='border: 1px solid #e5e5e5;'></div>");
...
left:"0",top:"0",width:"100%",height:"100%"});isPhone()||isPad()?(this.topTitle.css({"-webkit-transform":"translateY(0)",transform:"translateY(0)"}),this.alertText.css({display:"none"}),this.pcDownload.css({display:"block"})):(this.topTitle.css({"-webkit-transform":"translateY(-30px)",transform:"translateY(-30px)"}),this.pcDownload.css({display:"block"}),this.alertText.css({display:"none"}))},resizeCss:function(){this.alertText.css({width:this.width-37+"px"});this.posterImgOuter.css({width:684*this.scale+
...
facebook_screenshot=share_screenshot="";$('meta[name="description"]').attr("content")&&(share_description=$('meta[name="description"]').attr("content"));bookConfig.socialShareLink&&(share_url=bookConfig.socialShareLink);this.refreshList()},getList:function(){return this.shareList},getThumbUrl:function(){var a=getMeta("og:image");a.match(/^none/)&&(a="");return-1<a.indexOf("../")?a.replace("../","/"):a},getLogoPath:function(a){var b=uiBaseURL,c=".svg";if(isPhone()||isPad())try{window.htmlConfig&&window.htmlConfig.phoneTemplate&&
window.htmlConfig.phoneTemplate.path&&"Modern"==window.htmlConfig.phoneTemplate.name&&(b=window.htmlConfig.phoneTemplate.path,c="_phone.svg")}catch(d){console.warn("Failed to get phone logo path:",d)}return b+a.replace(".svg",c)},refreshList:function(){this.url=Metacharacter(share_url);this.title=Metacharacter(share_title);this.screenshot=Metacharacter(share_screenshot);this.description=Metacharacter(share_description);this.shareList=window.shareObj&&0<window.shareObj.length?this.initShareList():
this.initDefaultShareList()},initShareList:function(){if(!window.shareObj||0>=window.shareObj.length)return[];for(var a=window.shareObj.length,b=[],c=0;c<a;c++){var d=window.shareObj[c];if("mobile"!=d.filter||isPC())if("pc"!=d.filter||!isPC()||d.specail)d=this.fixItemInfo(d),b.push(d)}return b},fixItemInfo:function(a){if(a){var b=share_url,c="",d="";try{c=window.parent.location.href,d=window.top.location.href}catch(h){}var e=window.document.title,g=share_screenshot;a.name&&"facebook"==a.name.toLowerCase()&&
(g=facebook_screenshot);var f=a.url+"";0<=f.indexOf("${url_no_page}")&&(f=f.remove("${url_no_page}"),b=b.removeStartFrom("#p="),c=c.removeStartFrom("#p="),d=d.removeStartFrom("#p="));f=f.replaceAll("${url}",b,!0);f=f.replaceAll("${url_no_page}",b,!0);f=f.replaceAll("${url_parent}",c,!0);f=f.replaceAll("${url_top}",d,!0);"baidutieba"==a.type?(b=g.replace("https","http"),f=f.replaceAll("${shot-img}",b,!0)):f=f.replaceAll("${shot-img}",g,!0);f=f.replaceAll("${title}",e,!0);share_description||(f=f.replace("&desc=${description}",
""),f=f.replace("&text=${description}",""));e=this.getLogoPath(a.logo+"");b=a.title+"";c=a.popUp;return a.name&&"facebook"==a.name.toLowerCase()?{logo:e,url:"javascript:ShareToFaceBook({url:share_url, title:share_title, screenshot:facebook_screenshot, description:share_description})",title:b,type:a.type}:"qrcode"==a.name?{url:"javascript:openQRCode()",logo:e,title:b,type:a.type}:c?{url:"javascript:openPopUp("+c+")",logo:e,title:b}:"qqShare"==a.type&&(isPhone()||isPad())?{url:"javascript:sharePhoneQQ()",
logo:e,title:b,type:a.type}:"poster"==a.type?{url:"javascript:showPoster()",type:"poster",logo:e,title:b}:"copy"==a.type?{url:"",type:"copy",logo:e,title:b}:{url:f,logo:e,title:b,type:a.type}}},initDefaultShareList:function(){var a=[{logo:this.getLogoPath(isBelowIE9()?"facebook.png":"facebook.svg"),url:"javascript:ShareToFaceBook({url:share_url, title:share_title, screenshot:facebook_screenshot, description:share_description})",title:"Facebook",name:"facebook",type:"facebook"},{logo:this.getLogoPath(isBelowIE9()?
"twitter.png":"twitter.svg"),url:"https://twitter.com/intent/tweet?url="+this.url+"&text="+this.title,title:"Twitter",name:"twitter",type:"twitter"},{logo:this.getLogoPath("instagram.svg"),url:"javascript:ShareToInstagram()",title:"Instagram",name:"instagram",type:"instagram"},{logo:this.getLogoPath("pinterest.svg"),url:"https://www.pinterest.com/pin/create/button/?url="+this.url,title:"Pinterest",name:"pinterest",type:"pinterest"},{logo:this.getLogoPath("whatsapp.svg"),url:"https://wa.me/?text="+
this.url,title:"WhatsApp",name:"whatsapp",type:"whatsapp"},{logo:this.getLogoPath(isBelowIE9()?"email.png":"email.svg"),url:getEmailUrl(),title:getLanguage("shareItem_email","Email"),name:"email",type:"email"},{logo:this.getLogoPath(isBelowIE9()?"copy.png":"link.svg"),url:"",type:"copy",title:getLanguage("shareItem_copy","Copy"),filter:"pc"},{logo:this.getLogoPath(isBelowIE9()?"qrcode.png":"qrcode.svg"),url:"javascript:openQRCode()",type:"qrcode",title:getLanguage("shareItem_qrcode","QRcode"),filter:"pc",
specail:!0},{logo:this.getLogoPath("poster.svg"),url:"javascript:showPoster()",title:getLanguage("shareItem_poster","Poster"),name:"poster",type:"poster"}],b={logo:this.getLogoPath(isBelowIE9()?"more.png":"more.svg"),url:"javascript:openNavigator({url:share_url, title:share_title,description:share_description})",title:getLanguage("shareItem_more","More"),name:"share_more",type:"share_more"};navigator&&navigator.share&&a.push(b);return("string"===typeof bookConfig.socialSharingList||Array.isArray(bookConfig.socialSharingList))&&
...
a=$("<img alt='' style='position:absolute;top:0;right:0;max-width:90%;max-height:90%;' src='"+a+"'/>");b.append(a);$("body").append(b);b.onClick(function(){b.hide();b.remove()})},ShareToFaceBook=function(a){var b=function(){var d=getHost(window.location.href).toLowerCase();if(-1<d.indexOf("fliphtml5.com"))return"759223277462081";if(-1<d.indexOf("pubhtml5.com"))return"552959651503135";if(-1<d.indexOf("anyflip.com"))return"3188867394510608";if(-1<d.indexOf("flipbuilder.com"))return"506045156879233";
if(bookConfig.facebookAppId)return bookConfig.facebookAppId},c=function(){FB.ui({method:"share",href:share_url.toString()},function(d){})};(function(){var d=getHost(window.location.href).toLowerCase();(-1<d.indexOf("fliphtml5.com")||-1<d.indexOf("pubhtml5.com")||-1<d.indexOf("anyflip.com")||-1<d.indexOf("flipbuilder.com")||bookConfig.facebookAppId)&&global.FB?(FB.init({appId:b(),status:!0,xfbml:!1,version:"v2.4"}),c()):window.open("http://www.facebook.com/sharer.php?u="+share_url.toString())})()},
getEmailUrl=function(){if(!bookConfig.btnShareWithEmailSubject&&!bookConfig.btnShareWithEmailBody)return"https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&su="+share_title+"&body="+(share_title+"%0D%0A"+encodeURIComponent(share_url));var a=bookConfig.btnShareWithEmailSubject?bookConfig.btnShareWithEmailSubject:share_title,b=bookConfig.btnShareWithEmailBody?bookConfig.btnShareWithEmailBody:share_description,c=bookConfig.btnShareWithEmailTo||"";b=b.replaceAll("{link}",share_url,!0);b=b.replaceAll("{thumb}",
share_screenshot,!0);b=b.replaceAll("{title}",share_title,!0);c&&(c=encodeURIComponent(c));a&&(a=encodeURIComponent(a));b&&(b=encodeURIComponent(b));return"mailto:"+c+"?subject="+a+"&body="+b};
...
shareItemDefaultTitles[a]:void 0;return b&&a?getLanguage(b,a):this.info.title},initItem:function(){-1<this.info.url.indexOf("javascript")?this.link=$("<a ></a>"):this.info.type&&"copy"==this.info.type?(this.link=$("<a id='copy_url' data-clipboard-action='copy' ></a>"),copyHref(this.link[0])):this.link=$("<a target='_blank' href='"+this.info.url+"'></a>");this.item=$("<div class='item'></div>");this.logo=$("<img alt='' class='logo' src='"+this.info.logo+"'/>");var a=this.getLocalizedTitle();this.title=
$('<div class="logo_title">'+a+"</div>");this.link.append(this.item);this.info.logo&&this.item.append(this.logo);this.item.append(this.title);this.item.css({color:this.info.fontColor})},initEvent:function(){this.link.bind("touchend",function(){BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),this.info.title,!1])}.bind(this));-1<this.info.url.indexOf("javascript")&&this.link.bind(_event._click,function(){eval(this.info.url.remove("javascript:"));return!1}.bind(this))},appendTo:function(a){this.parent=
a;this.parent.append(this.link)},changeLanguage:function(){var a=this.getLocalizedTitle();this.title.html(a)}}),ShareElements=Class({create:function(a){this._super(a);this.itemArray=[];global.share_url=window.location.href.removeStartFrom("#p=");this.initElements();this.initEvent(a);this.pickElements(a);this.added=!1;this.setCurrentBoxStyle()},initElements:function(){this.shareCurrentChecked=!1;this.searchOnUrl=form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";
this.searchOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+"print_off.png";this.analysisShare=new AnalysisShare;this.sharePanelTitle=$("<div class='link_title share_title'>"+getLanguage("frmPanelTitle","Share to")+":</div>");this.linkBox=$("<div class='link_Box'></div>");this.linkTitle=$("<div class='link_title'>"+getLanguage("frmLinkLabel","Link")+":</div>");this.linkArea=$("<input aria-label='"+getLanguage("ariaShareLink","Book link")+"' class='link_input'></input>");
this.copy1=$("<div role='button' tabindex=0 aria-label='"+getLanguage("ariaCopy","copy")+"' class='copy button_hover'>"+getLanguage("lblCopy","Copy")+"</div>");this.codeBox=$("<div class='codeBox'></div>");this.codeButton=$("<div class='codeButton'>\n        <span class='qrcode active'>\n          "+getLanguage("frmShareQRcode","QRCode")+"\n        </span>\n        <span class='miniProgram' >\n        "+getLanguage("frmShareSmallProgram","smallProgram")+"\n        </span>\n        </div>");this.shareCode=
...
this.bigMiniProgramCode.css("left","-195px"));this.shareCode.append(this.bigCodeBox);this.miniProgramCode.append(this.bigMiniProgramCode);this.shareCurrentPageBox=$("<div class='shareCurrentPageBox shareCurrentPageLink'></div>");this.shareCurrentCheck=$("<img alt='' class='shareCurrentPage' src="+this.searchOffUrl+" />");this.shareCurrentPageTitle1=$("<div class='shareCurrentPageTitle'>"+getLanguage("DownloadCurrentPage","Current Page")+"</div>");this.sharePanel=$("<div class='sharePanel'></div>");
this.initQRCode()},getQrCodeBoxStatus:function(){var a=this,b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return d.yield(a.hasQrcode(),2);b=d.yieldResult;c=a.hasMiniProgram();return d.return(b||c)})},hasQrcode:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return bookConfig.socialSharingList&&0<bookConfig.socialSharingList.length?c.return(bookConfig.socialSharingList.includes("qrcode")):c.yield(a.analysisShare.getList(),
...
c.length)return q.return();d=c.filter(function(t){return"mobile"===t.filter&&!isPC()||"pc"===t.filter&&isPC()?!1:!0});if(!d.length)return b.sharePanel.show(),null==(e=b.codeBox)||e.css({left:"50%",transform:"translateX(-50%)"}),a&&a(!0),q.return();b.loading=$("<img alt='' src=\""+uiBaseURL+'loading.gif" style="position: absolute;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"/>');$(b.sharePanel[0].parentElement.parentElement).append(b.loading);g={};for(f=0;f<d.length;g={$jscomp$loop$prop$obj$8:g.$jscomp$loop$prop$obj$8},
f++)g.$jscomp$loop$prop$obj$8=d[f],h=void 0,g.$jscomp$loop$prop$obj$8.type&&"copy"==g.$jscomp$loop$prop$obj$8.type?(h=$("<a aria-label='"+g.$jscomp$loop$prop$obj$8.title+"' tabindex='0' class='share-item' id='copy_url' data-clipboard-action='copy' title='"+g.$jscomp$loop$prop$obj$8.title+"'>\n            <img alt='' src='"+g.$jscomp$loop$prop$obj$8.logo+"'/>\n          </a>"),copyHref(h[0]),BookEvent.trigger("customEvent",["copy_share_link"])):h=-1<g.$jscomp$loop$prop$obj$8.url.indexOf("javascript")?
$("<a data-type='"+g.$jscomp$loop$prop$obj$8.type+"' aria-label='"+g.$jscomp$loop$prop$obj$8.title+"' tabindex='0' class='share-item' onclick='"+g.$jscomp$loop$prop$obj$8.url.remove("javascript:")+";return false;' title='"+g.$jscomp$loop$prop$obj$8.title+"'>\n            <img alt='' src='"+g.$jscomp$loop$prop$obj$8.logo+"'/>\n          </a>"):$("<a data-type='"+g.$jscomp$loop$prop$obj$8.type+"' aria-label='"+g.$jscomp$loop$prop$obj$8.title+"' tabindex='0' class='share-item' target = '_blank' href='"+
g.$jscomp$loop$prop$obj$8.url+"' title='"+g.$jscomp$loop$prop$obj$8.title+"'>\n            <img alt='' src='"+g.$jscomp$loop$prop$obj$8.logo+"'/>\n          </a>"),b.sharePanel.append(h),b.itemArray.push(h),k=b,h.bind(_event._end,function(t){return function(){var r=$(this).attr("title");BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),r,k.shareCurrentChecked]);r=t.$jscomp$loop$prop$obj$8.type;"share_more"==r&&(r="other_method");"twitter"==r&&(r="x");r&&BookEvent.trigger("customEvent",["click_share_with_"+
r])}}(g));for(m=l=0;m<b.itemArray.length;m++)p=b.itemArray[m],n=p.find("img")[0],n.onload=function(){l++;l==b.itemArray.length&&(b.loading.remove(),b.sharePanel.show(),a&&a())};q.jumpToEnd()})},initEvent:function(a){this.copy1.bind(_event._click,function(){BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),getLanguage("lblCopy","Copy"),self.shareCurrentChecked]);BookEvent.trigger("customEvent",["copy_share_link"]);this.copyFrom(this.linkArea)}.bind(this));this.linkArea.bind(_event._click,function(){this.linkArea.select()}.bind(this));
this.shareCurrentCheck.bind(_event._click,function(){this.shareCurrentChecked=!this.shareCurrentChecked;this.afterCheckClick()}.bind(this));this.linkArea.bind("mousedown touchstart pointerdown mouseover mousemove",function(b){b.stopPropagation()});this.initCodeEvent();this.linkInputChnagedEvent()},afterCheckClick:function(){this.fillArea(this.shareCurrentChecked,"link");this.shareCurrentCheck.attr("src",this.shareCurrentChecked?this.searchOnUrl:this.searchOffUrl);this.shareCurrentCheck[0].colorChanged=
!1;this.shareCurrentCheck.changeButtonColor(this.fontColor)},initCodeEvent:function(){bookConfig.SmallProgramUrl&&(this.codeButton.find(".qrcode").bind("click",function(){this.codeButton.find(".qrcode").addClass("active");this.codeButton.find(".miniProgram").removeClass("active");this.shareCode.show();this.miniProgramCode.hide();BookEvent.trigger("share",[BookInfo.getCurrentPages().join("-"),getLanguage("frmShareQRcode","QRCode"),this.shareCurrentChecked])}.bind(this)),this.codeButton.find(".miniProgram").bind("click",
...
this.shareCode&&(this.shareCode.bind("mouseenter",function(){this.initBigCode();this.bigCodeBox.fadeIn("100")}.bind(this)),this.shareCode.bind("mouseleave",function(){this.bigCodeBox.fadeOut("100")}.bind(this)))},initBigCode:function(){this.bigShareCode||(this.bigShareCode=$("<div class='bigShareCode'></div>"),this.bigCodeBox.append(this.bigShareCode));var a=share_url;a&&0<=a.toLowerCase().indexOf("file:")&&(a="index.html");this.shareCurrentChecked&&(a=a+"#p="+getShownPageNumber(BookInfo.getCurrentPageIndex()));
this.bigShareCode.empty().qrcode({width:160,height:160,render:global.isIE8()?"":"image",text:a})},linkInputChnagedEvent:function(){if(this.linkArea)this.linkArea.on("input propertychange change",function(){var a=this,b,c,d,e,g,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return b=a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),share_url=b,a.analysisShare.refreshList(),(c=a.analysisShare.shareList)?k.jumpTo(2):k.yield(a.analysisShare.getList(),
3);2!=k.nextAddress&&(c=k.yieldResult);d=c;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$10:e.$jscomp$loop$prop$type$10},g++)f=a.itemArray[g],e.$jscomp$loop$prop$type$10=f.attr("data-type"),(h=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$10}}(e)))&&(-1<h.url.indexOf("javascript")?f.attr("onclick",h.url.remove("javascript:")+";return false;"):f.attr("href",h.url));k.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=
...
b={email:"Email",copy:"Copy",qrcode:"QRcode",poster:"Poster",share_more:"More",facebook:"Facebook",twitter:"Twitter",instagram:"Instagram",pinterest:"Pinterest",whatsapp:"WhatsApp",linkedin:"LinkedIn"},c=0;c<this.itemArray.length;c++){var d=this.itemArray[c],e=d.attr("data-type"),g=a[e];e=b[e];g&&e&&(g=getLanguage(g,e),d.attr("aria-label",g),d.attr("title",g))}}}).extend(FormElements),PcShareFrame=Class({create:function(a){this.elements=new ShareElements(this);this._super(a)},onCreate:function(){this.initColorCss();
this.stage.css({display:"none"});bookConfig.socialSharingList&&0<bookConfig.socialSharingList.length&&!bookConfig.socialSharingList.includes("copy")&&this.linkBox.css({display:"none"});bookConfig.addCurrentPage&&this.content.css({height:"215px"});this._super()},initColorCss:function(){this.elements.fontColor=this.fontColor;this.stage.css({"background-color":this.mainColorObj.rgba(this.formOpacity),color:this.fontColor})},initSwiperCss:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==
c.nextAddress)return c.yield(a.getQrCodeStatus(),2);(b=c.yieldResult)?bookConfig.RightToLeft?a.swiperContainer.css({"border-right":"1px solid "+a.fontColorObj.rgba(.3)}):a.swiperContainer.css({"border-left":"1px solid "+a.fontColorObj.rgba(.3)}):a.swiperContainer.css({right:"initial",left:"0px"});c.jumpToEnd()})},initSwiper:function(){this.swiperContainer=$("<div class='swiperContainer'></div>");this.shareStage=$("<div class='shareStage stage'></div>");this.shareSwiper=$("<div class='shareSwiper swiper'></div>");
this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.shareSwiper.append(this.sharePanel);this.shareStage.append(this.shareSwiper);this.shareStage.append(this.progress);this.progress.append(this.progressBar);this.swiperContainer.append(this.shareStage);this.shareStage.scroll({},Direction.top,"win10")},initHtml:function(){this._super()},resetColorChanged:function(){this._super();bookConfig.addCurrentPage&&(this.shareCurrentCheck[0].colorChanged=
!1,this.elements.shareCurrentChecked?this.shareCurrentCheck.attr("src",this.elements.searchOnUrl):this.shareCurrentCheck.attr("src",this.elements.searchOffUrl))},changeIconColor:function(){this._super();this.changeItemColor()},changeItemColor:function(){this.elements.fontColor=this.fontColor;this.shareCurrentCheck.changeButtonColor(this.fontColor)},onShow:function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){if(1==b.nextAddress)return b.yield(a.initSwiperCss(),2);a.changeIconColor();
a.shareStage.refreshData();a.elements.addItem(function(c){a.stage[0].style.display="inline-block";a.setA11yAndFocus();var d;c&&(null==(d=a.swiperContainer)?0:d.length)&&a.swiperContainer.css({display:"none"})});b.jumpToEnd()})}}).extend(FadeOutFadeForm),PhoneShareForm=Class({create:function(a){this.elements=new ShareElements(this);this.items=[];this._super(a)},onCreate:function(){this.stage.css({color:this.fontColor});this.close.changeButtonColor(this.fontColor);this.back.css({color:this.fontColor});
this.favicon&&this.favicon.changeButtonColor(this.fontColor);this._super()},initHtml:function(){var a="Back";"Chinese"==UserGroups&&(a="\u8fd4\u56de");a=getLanguage("btnBack",a);this.back=$("<div class='back'><img alt='' src='"+(window.zoom_icons&&zoom_icons["arrow-left"]?"data:image/png;base64,"+zoom_icons["arrow-left"]:uiBaseURL+"arrow-left.png")+"'/><span>"+a+"</span></div>");this.stage.append(this.back);this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):
this.title.prepend(this.favicon));this.stage.append(this.close);this.stage.append(this.qrcode);this.hideQRCode()},initSwiper:function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return a.shareSwiper=$("<div class='shareSwiper stage'></div>"),a.shareSwiperList=$("<div class='swiper'></div>"),c.yield(a.analysisShare.getList(),2);b=c.yieldResult;if(!b||0>b.length)return c.return();a.refreshSwiper(a.shareSwiperList,b);a.shareSwiper.append(a.shareSwiperList);
isPhone()||isPad()?a.shareSwiper.css({"overflow-y":"auto","overflow-x":"hidden","-webkit-overflow-scrolling":"touch"}):(a.shareSwiper.css({overflow:"hidden"}),a.shareSwiperList.css({top:0,left:0,width:"100%",position:"absolute"}),a.progress=$("<div class='progress'></div>"),a.progressBar=$("<div class='progressBar'></div>"),a.shareSwiper.append(a.progress),a.progress.append(a.progressBar),a.shareSwiper.scroll({},Direction.top));a.stage.append(a.shareSwiper);c.jumpToEnd()})},refreshSwiper:function(a,
...
1E3)},initElements:function(){this.contactTitle=$("<span class='content_title contact_title'>"+getLanguage("frmaboutcaption","Contact")+"</span>");this.descriptionTitle=$("<span class='content_title description_title'>"+getLanguage("frmaboutDESCRIPTION","Description")+"</span>");this.logo=$("\n      <a \n        class='aboutLogo' \n        rel='noopener noreferrer' \n        target='_blank' \n        style='display:none;background:url("+bookConfig.CompanyLogoFile+") center center no-repeat;background-size:contain;'\n        href='"+
bookConfig.AboutWebsite+"'\n        aria-label='"+getLanguage("ariaProfileLogo","profile logo")+"'\n      ></a>\n    ");this.initDom();this.resetAboutHtml();bookConfig.AboutWebsite&&this.logo.attr("href",bookConfig.AboutWebsite)},resetAboutHtml:function(){bookConfig.CompanyLogoFile?this.logo.css({display:"inline-block",background:"url('"+bookConfig.CompanyLogoFile+"') center center no-repeat","background-size":"contain",marginBottom:"10px"}):this.logo.css({display:"none"});this.strViews=getLanguage("frmaboutViews",
global.aboutReadTimesCaptions);rightToLeft?(this.author.html("<div class='content rtl'>"+bookConfig.AboutAuthor+"</div><span class='title'>:  "+getLanguage("frmaboutAUTHOR","Author")+"</span>"),this.address.html("<div class='content rtl'>"+bookConfig.AboutAddress+"</div><span class='title'>:  "+getLanguage("frmaboutADDRESS","Address")+"</span>"),this.email.html((bookConfig.AboutEmail?"<a href='mailto:"+bookConfig.AboutEmail+"' target='_blank'><span class='content'>"+bookConfig.AboutEmail+"</span></a>":
"<span class='content'></span>")+"<span class='title'>:  "+getLanguage("frmaboutEMAIL","Email")+"</span>"),this.website.html((bookConfig.AboutWebsite?"<a href='"+bookConfig.AboutWebsite+"' target='_blank'><span class='content'>"+bookConfig.AboutWebsite+"</span></a>":"<span class='content'></span>")+"<span class='title'>:  "+getLanguage("frmaboutWEBSITE","Website")+"</span>"),this.mobile.html((bookConfig.AboutMobile?"<a href='tel:"+bookConfig.AboutMobile+"' target='_blank'><span class='content'>"+
bookConfig.AboutMobile+"</span></a>":"<span class='content'></span>")+"<span class='title'>:  "+getLanguage("frmaboutMOBILE","Mobile")+"</span>"),this.description.html("<span class='content rtl'>"+bookConfig.AboutDescription.replaceAll("  ","&ensp;")+"</span></div>"),this.views.html("<div class='content rtl'>"+this.ReadTimes+"</div><span class='title'>:  "+getLanguage("frmaboutViews",this.strViews)+"</span>")):(this.author.html("<span class='title'>"+getLanguage("frmaboutAUTHOR","Author")+":  </span><span class='content'>"+
bookConfig.AboutAuthor+"</span>"),this.address.html("<span class='title'>"+getLanguage("frmaboutADDRESS","Address")+":  </span><span class='content'>"+bookConfig.AboutAddress+"</span>"),this.email.html("<span class='title'>"+getLanguage("frmaboutEMAIL","Email")+":  </span>"+(bookConfig.AboutEmail?"<a href='mailto:"+bookConfig.AboutEmail+"' target='_blank'><span class='content'>"+bookConfig.AboutEmail+"</span></a>":"<span class='content'></span>")),this.website.html("<span class='title'>"+getLanguage("frmaboutWEBSITE",
"Website")+":  </span>"+(bookConfig.AboutWebsite?"<a href='"+bookConfig.AboutWebsite+"' target='_blank'><span class='content'>"+bookConfig.AboutWebsite+"</span></a>":"<span class='content'></span>")),this.mobile.html("<span class='title'>"+getLanguage("frmaboutMOBILE","Mobile")+":  </span>"+(bookConfig.AboutMobile?"<a href='tel:"+bookConfig.AboutMobile+"' target='_blank'><span class='content'>"+bookConfig.AboutMobile+"</span></a>":"<span class='content'></span>")),this.description.html("<span class='content'>"+
...
var BookmarkElements=Class({create:function(a){this._super(a);this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.input=$("<input aria-label='"+getLanguage("ariaAddBookmark","add bookmark")+"' class='input_title ' placeholder='"+FormInfo.getFormTitle("bookmark")+"'></input>");this.colorSelection=$("<input aria-label='"+getLanguage("ariaColorSelection","color selection")+"' class='colorSelection' readonly type='text' color='#ff0000' style='background:#ff0000;'></input>");
this.setRandom();this.rightToLeft?this.initRightToLeftDefaultDom():this.initLeftToRightDefaultDom();this.remove=$("<div class='removeAll button_hover'>"+getLanguage("lblRemoveAll","Remove All")+"</div>")},initRightToLeftDefaultDom:function(){this.leftAddPage=$("<div class='add_page button_hover'><span class='pageIndex'></span> <span class='title'>"+getLanguage("lblAddToPage","Add To Page")+"</span></div>");this.rightAddPage=$("<div class='add_page left button_hover'><span class='pageIndex'></span> <span class='title'>"+
getLanguage("lblAddToPage","Add To Page")+"</span></div>");this.bookmarkListTitle=$("<div class='list_title'><span class='edit'>"+getLanguage("lblEdit","Edit")+"</span><span class='description'>"+getLanguage("lblDescription","Title")+"</span><span class='page'>"+getLanguage("lblPage","Page")+"</span></div>")},initLeftToRightDefaultDom:function(){this.leftAddPage=$("<div class='add_page left'><span class='title'>"+getLanguage("lblAddToPage","Add To Page")+"</span> <span class='pageIndex'></span></div>");
this.rightAddPage=$("<div class='add_page'><span class='title'>"+getLanguage("lblAddToPage","Add To Page")+"</span> <span class='pageIndex'></span></div>");this.bookmarkListTitle=$("<div class='list_title'><span class='page'>"+getLanguage("lblPage","Page")+"</span><span class='description'>"+getLanguage("lblDescription","Title")+"</span><span class='edit'>"+getLanguage("lblEdit","Edit")+"</span></div>")},getColor:function(){return this.colorSelection.attr("color")},pickElements:function(a){a&&(a.input=
this.input,a.colorSelection=this.colorSelection,a.remove=this.remove,a.leftAddPage=this.leftAddPage,a.rightAddPage=this.rightAddPage,a.bookmarkListTitle=this.bookmarkListTitle)},setRandom:function(){var a=getRandomColor();this.colorSelection.attr("color",a);this.colorSelection.css("background",a)},initEvent:function(a){this.leftAddPage.click(function(){var b={pageIndex:this.leftPageIndex,caption:this.input.val(),color:this.getColor()};a.addItem(b);BookEvent.trigger("customEvent",["add_bookmark_to_page_"+
this.leftPageIndex,{add_bookmark_to_page:this.leftPageIndex}])}.bind(this));this.rightAddPage.click(function(){var b={pageIndex:this.rightPageIndex,caption:this.input.val(),color:this.getColor()};a.addItem(b);BookEvent.trigger("customEvent",["add_bookmark_to_page_"+this.rightPageIndex,{add_bookmark_to_page:this.rightPageIndex}])}.bind(this));this.remove.click(function(){a.removeAll()}.bind(this));this.input.bind("mousedown touchstart pointerdown mouseover mousemove",function(b){b.stopPropagation()});
this.colorSelection.bind(_event._up,function(b){b.stopPropagation();global.colorPanel&&global.colorPanel.showOrHide({e:b,elem:this.colorSelection,closeAlpha:!0})}.bind(this))},refreshElements:function(){this.refreshAddPageButtonOnPc();this.refreshAddPageButtonOnPhone()},refreshAddPageButtonOnPc:function(){if(!isPhone()&&!isPad()){0>=this.bookmarkList.getLength()?this.remove.hide():this.remove.show();var a=BookInfo.getCurrentPages();this.leftPageIndex=parseInt(a[0]);this.rightPageIndex=parseInt(a[1]);
this.showOrHideAddPageBtn();this.focusAddPageBtn()}},refreshAddPageButtonOnPhone:function(){if((isPhone()||isPad())&&toolBar.buttons&&toolBar.buttons.find("PhoneBookmarkButton",!0).get(0)){for(var a=BookInfo.getCurrentPages(),b=0;b<a.length;b++)if(this.bookmarkList.inList(a[b])){toolBar.buttons.find("PhoneBookmarkButton",!0).get(0).setAsAdded();return}toolBar.buttons.find("PhoneBookmarkButton",!0).get(0).setAsUnAdded()}},showOrHideAddPageBtn:function(){this.leftPageIndex?(this.leftAddPage.find(".pageIndex").html(getShownPageNumber(this.leftPageIndex)),
this.leftAddPage.show()):this.leftAddPage.hide();this.rightPageIndex?(this.rightAddPage.find(".pageIndex").html(getShownPageNumber(this.rightPageIndex)),this.rightAddPage.show()):this.rightAddPage.hide()},focusAddPageBtn:function(){this.leftPageIndex&&!this.bookmarkList.inList(this.leftPageIndex)?(this.leftAddPage.removeClass("disable"),this.leftAddPage.addClass("usable"),this.leftAddPage.addClass("button_hover")):(this.leftAddPage.addClass("disable"),this.leftAddPage.removeClass("usable"),this.leftAddPage.removeClass("button_hover"));
this.rightPageIndex&&!this.bookmarkList.inList(this.rightPageIndex)?(this.rightAddPage.removeClass("disable"),this.rightAddPage.addClass("usable"),this.rightAddPage.addClass("button_hover")):(this.rightAddPage.addClass("disable"),this.rightAddPage.removeClass("usable"),this.rightAddPage.removeClass("button_hover"))},changeLanguage:function(){this.input.attr("placeholder",FormInfo.getFormTitle("tableOfContent"));this.remove.html(getLanguage("lblRemoveAll","Remove All"));this.leftAddPage.find(".title").html(getLanguage("lblAddToPage",
"Add To Page"));this.rightAddPage.find(".title").html(getLanguage("lblAddToPage","Add To Page"));this.bookmarkListTitle.find(".edit").html(getLanguage("lblEdit","Edit"));this.bookmarkListTitle.find(".description").html(getLanguage("lblDescription","Title"));this.bookmarkListTitle.find(".page").html(getLanguage("lblPage","Page"));var a=this.bookmarkListPanel.bookmarkSwiperList;a.find(".save").attr("title",getLanguage("lblSave","Save"));a.find(".cancel").attr("title",getLanguage("lblCancel","Cancel"));
a.find(".edit").attr("title",getLanguage("lblEdit","Edit"));a.find(".delete").attr("title",getLanguage("lblDelete","Delete"))}}).extend(FormElements),BookmarkItem=Class({create:function(a,b){this.callback=b;var c;this.color=null!=(c=a.color)?c:"#66D566";var d;this.caption=null!=(d=a.caption)?d:"";this.parm={color:this.color,caption:this.caption,pageIndex:parseInt(a.pageIndex)};this.item=$("<div class='item' pageIndex='"+parseInt(a.pageIndex)+"' id='bookmark_item"+parseInt(a.pageIndex)+"'></div>");
this.saveUrl=form_icons.save?"data:image/png;base64,"+form_icons.save:uiBaseURL+"save.png";this.cancelUrl=form_icons.cancel?"data:image/png;base64,"+form_icons.cancel:uiBaseURL+"cancel.png";this.editUrl=form_icons.edit?"data:image/png;base64,"+form_icons.edit:uiBaseURL+"edit.png";this.deleteUrl=form_icons["delete"]?"data:image/png;base64,"+form_icons["delete"]:uiBaseURL+"delete.png";this.fontColor=a.fontColor;this.pageCaption=getShownPageNumber(parseInt(a.pageIndex));this.pageIndex=parseInt(a.pageIndex);
...
"</span>");this.title=$("\n      <input class='title' aria-label='"+getLanguage("ariaBookmarkTitle","bookmark title")+"' type='text' value='' disabled='disabled' />\n    ");this.title.val(this.caption);this.colorSelection=$("\n      <input class='colorSelection' readonly type='text' style='background:"+this.color+"' id='colorSelection' aria-label='"+getLanguage("ariaColorSelection","color selection")+"' />\n    ");this.colorSelection.attr("color",this.color);this.save=$("\n      <button class='save aria-label-button' title='"+
getLanguage("lblSave","Save")+"'>\n       <img alt='' style='position: relative;' src='"+this.saveUrl+"' aria-hidden='true' />\n      </button>\n    ");this.cancel=$("\n      <button class='cancel aria-label-button' title='"+getLanguage("lblCancel","Cancel")+"'>\n       <img alt='' style='position: relative;' src='"+this.cancelUrl+"' aria-hidden='true' />\n      </button>\n    ");this.edit=$("\n      <button class='edit aria-label-button' title='"+getLanguage("lblEdit","Edit")+"'>\n       <img alt='' style='position: relative;' src='"+
this.editUrl+"' aria-hidden='true' />\n      </button>\n    ");this.deleteIcon=$("\n      <button class='delete aria-label-button' title='"+getLanguage("lblDelete","Delete")+"'>\n       <img alt='' style='position: relative;' src='"+this.deleteUrl+"' aria-hidden='true' />\n      </button>\n    ");this.title.css({color:this.fontColor})},appendTo:function(a){a.append(this.item)},insertBefore:function(a){this.item.insertBefore(a)},insertAfter:function(a){this.item.insertAfter(a)},initEvent:function(){this.edit.onTap(function(){this.startEdit()}.bind(this));
this.cancel.onTap(function(){this.endEdit();this.cancelData()}.bind(this));this.save.onTap(function(){this.endEdit();this.saveData()}.bind(this));this.deleteIcon.onTap(function(){this.item.remove();this.callback.deleteItem(this.parm.pageIndex)}.bind(this));this.item.onTap(function(){this.judgeToSaveOrCancel();gotoPageFun(this.pageIndex,!1,"bookmark");BookEvent.trigger("customEvent",["click_bookmark_on_panel_to_"+this.pageIndex,{click_bookmark_on_panel_to:this.pageIndex}])}.bind(this));this.title.bind("keypress",
function(a){"13"==a.keyCode&&(this.endEdit(),this.saveData())}.bind(this));this.item.bind("mouseover",function(){global.bookmark.editingItem!=this&&this.item.css({background:this.colorObj.rgba(.1)})}.bind(this));this.item.bind("mouseleave",function(){global.bookmark.editingItem!=this&&this.item.css({"background-color":"transparent"})}.bind(this));this.colorSelection.bind(_event._up,function(a){a.stopPropagation();global.colorPanel&&global.colorPanel.showOrHide({e:a,elem:this.colorSelection,closeAlpha:!0})}.bind(this))},
saveData:function(){var a=this.colorSelection.attr("color"),b=this.title.val();if(b!=this.caption||a!=this.color)this.caption=b,this.color=a,this.parm={pageIndex:this.pageIndex,caption:this.caption,color:this.color},this.callback.editItem(this.parm)},cancelData:function(){var a=this.colorSelection.attr("color");this.title.val()!=this.caption&&this.title.val(this.caption);a!=this.color&&this.colorSelection.attr("color",this.color)},endEdit:function(){this.colorSelection.hide();this.cancel.hide();this.save.hide();
this.edit.show();this.title.css({background:"transparent",color:this.fontColor});this.title.attr("disabled","disabled");global.bookmark.editingItem=null},startEdit:function(){this.judgeToSaveOrCancel();this.lightItem();this.colorSelection.show();this.cancel.show();this.save.show();this.edit.hide();this.title.css({background:"#ffffff",color:"#000000"});this.title.removeAttr("disabled");global.bookmark.editingItem=this;this.cancel.changeButtonColor(this.fontColor);this.save.changeButtonColor(this.fontColor)},
judgeToSaveOrCancel:function(){global.bookmark.editingItem&&global.bookmark.editingItem!=this&&(global.bookmark.editingItem.cancelData(),global.bookmark.editingItem.endEdit())},lightItem:function(){$(".bookmarkItem_focus").css({background:"transparent"});$(".bookmarkItem_focus").removeClass("bookmarkItem_focus");this.item.addClass("bookmarkItem_focus");this.item.css({background:this.colorObj.rgba(.25)})},changeLanguage:function(){this.save.attr("title",getLanguage("lblSave","Save"));this.cancel.attr("title",
getLanguage("lblCancel","Cancel"));this.edit.attr("title",getLanguage("lblEdit","Edit"));this.deleteIcon.attr("title",getLanguage("lblDelete","Delete"))},refreshImage:function(){var a=this;getPageDir(this.pageIndex,"thumb",originTotalPageCount).then(function(b){a.itemImg&&(b.match(/^none/)?a.itemImg.css({background:bookConfig.pageBackgroundColor}):a.itemImg.css({background:"url("+b+") center center no-repeat","background-size":"contain"}))}).catch(function(b){console.log("Error refreshing image:",
b)})}}),PhoneBookmarkItem=Class({create:function(a,b){this.parm=a;this.color=a.color;this.pageCaption="P:"+parseInt(a.pageIndex);this.pageIndex=parseInt(a.pageIndex);this.callback=b;this.item=$("<div class='item'></div>");this.page=$("<span class='page'>P:"+getShownPageNumber(this.pageIndex)+"</span>");this.caption=$("<span class='title'>page:"+getShownPageNumber(this.pageIndex)+"</span>");this.deleteBtn=$("<span class='delete button' role='button'></span>");this.item.append(this.page);passwardType()||
this.refreshImage();this.item.append(this.caption);this.item.append(this.deleteBtn);this.initEvent()},appendTo:function(a){a.append(this.item)},initEvent:function(){this.deleteBtn.on(_event._click,function(){this.item.remove();this.callback.deleteItem(this.pageIndex)}.bind(this));this.item.on(_event._click,function(){gotoPageFun(this.pageIndex,!1,"bookmark");BookEvent.trigger("customEvent",["click_bookmark_on_panel_to_"+this.pageIndex,{click_bookmark_on_panel_to:this.pageIndex}]);bookmark.hide()}.bind(this))},
changeLanguage:function(){},refreshImage:function(){var a=this;getPageDir(this.pageIndex,"thumb",originTotalPageCount).then(function(b){a.item.find(".thumbnail").remove();b.match(/^none/)?a.image=$("<div class='thumbnail' style='display: inline-block;background:"+bookConfig.pageBackgroundColor+";width:60px;'></div>"):a.image=$("<img alt='' class='thumbnail' src='"+b+"'/>");isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||a.image.css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&
...
b+"px")},refreshSideEdge:function(a){setBookVerticalMargin({bookmarkHeight:(void 0===a?0:a)?0:70})}}),PhoneBookmarkListPanel=Class({create:function(a){this._super(a)},onCreate:function(){},newItem:function(a){return new PhoneBookmarkItem(a,this.callback)}}).extend(BookmarkListPanel),PcBookmarkFrame=Class({create:function(a){this.elements=new BookmarkElements(this);this.bookmarkListPanel=new PcBookmarkListPanel(this);this.elements.bookmarkList=this.bookmarkListPanel.bookmarkList;this.elements.bookmarkListPanel=
...
global.frmTableOfContent.visible&&global.frmTableOfContent.hide();this.refreshItemsImage()},refreshItemsImage:function(){this.bookmarkListPanel.refreshItemsImage()}}).extend(SlideForm),PhoneBookmarkFrame=Class({create:function(a){this.elements=new BookmarkElements(this);this.bookmarkListPanel=new PhoneBookmarkListPanel(this);this.elements.bookmarkList=this.bookmarkListPanel.bookmarkList;this.elements.bookmarkListPanel=this.bookmarkListPanel;this._super(a)},onCreate:function(){this.favicon&&this.favicon.changeButtonColor(this.fontColor);
this._super()},initHtml:function(){this.title.append(this.close);this.stage.append(this.title);this.stage.append(this.bookmarkListPanel.bookmarkSwiper);this.refreshPanel()},refreshPanel:function(){this.bookmarkListPanel.refreshPanel();this.elements.refreshElements()},addItem:function(a){a&&a.pageIndex&&!this.bookmarkListPanel.inList(a.pageIndex)&&(this.bookmarkListPanel.addItem(a),this.refreshPanel())},deleteItem:function(a){this.bookmarkListPanel.deleteItem(a);this.refreshPanel()},refreshItem:function(a){this.bookmarkListPanel.refreshItem(a)},
refreshItemsImage:function(){this.bookmarkListPanel.refreshItemsImage()},onResize:function(){this._super();this.bookmarkListPanel.onResize(this.width,windowHeight-61);this.refreshPanel()},initEvent:function(){},onShow:function(){this.favicon&&this.favicon.changeButtonColor(this.fontColor);this.refreshItemsImage()}}).extend(PhoneFormFrame),PhoneBookmarkForm=Class({}).extend(PhoneBookmarkFrame),TableOfContentElements=Class({create:function(a){this._super(a);this.callBack=a;this.tableItems=[];this.checkConfig();
this.initElements();this.initEvent(a);this.pickElements(a)},checkConfig:function(){for(var a=function(d){if(d&&d.children&&0!=d.children.length)for(var e=d.children.length,g=0;g<e;g++)d.children[g].level=parseInt(d.children[g].level)+1,a(d.children[g])},b=ols.length,c=0;c<b;c++)0==parseInt(ols[c].level)&&(ols[c].level=parseInt(ols[c].level)+1,a(ols[c]))},initElements:function(){this.searchButtonUrl=form_icons.search_form?"data:image/png;base64,"+form_icons.search_form:uiBaseURL+"search_form.png";
this.input=$("<input type='search' aria-label='"+getLanguage("ariaSearchTableOfContents","search table of contents")+"' class='input_search' placeholder='"+FormInfo.getFormTitle("tableOfContent")+"'></input>");bookConfig.RightToLeft&&this.input.attr("dir","rtl");this.searchButton=$("<img alt='' class='searchButton button' src='"+this.searchButtonUrl+"'/>");this.result=$("<p style='display:none;margin:0 27px;'>"+getLanguage("lblPages","Found Pages")+" <span style='color:"+bookConfig.searchKeywordFontColor+
";'>0</span></p>");this.tableofcontentSwiper=$("<div class='stage'></div>");this.tableofcontentSwiperList=$("<ul class='swiper'></ul>");this.refreshSwiper(this.tableofcontentSwiperList,ols);this.tableofcontentSwiper.append(this.tableofcontentSwiperList);isPhone()||isPad()?this.tableofcontentSwiper.css({overflow:"auto","-webkit-overflow-scrolling":"touch"}):(this.progress=$("<div class='progress'></div>"),this.progressBar=$("<div class='progressBar'></div>"),this.tableofcontentSwiper.append(this.progress),
this.progress.append(this.progressBar),this.tableofcontentSwiper.scroll({},Direction.top))},expandItems:function(){for(var a=0;a<this.tableItems.length;a++)this.tableItems[a].expand()},collapseItems:function(){for(var a=0;a<this.tableItems.length;a++)this.tableItems[a].collapse()},refreshItems:function(a){for(var b=0;b<this.tableItems.length;b++)this.tableItems[b].fontColor=a,this.tableItems[b].colorObj=Color(a),this.tableItems[b].resetItemColor&&this.tableItems[b].resetItemColor()},refreshSwiper:function(a,
b){for(var c=b.length,d=0;d<c;d++)this.addItem(a,b[d])},addItem:function(a,b){b=this.callBack.newItem(a,b,this.refresh.bind(this));a.append(b.getItem());b.unfolding();this.tableItems.push(b)},refresh:function(){isPhone()||isPad()||this.tableofcontentSwiper.refreshData()},initEvent:function(a){this.searchButton.onTap(function(b){this.searchStart()}.bind(this));this.input.on("input propertychange change",function(b){this.searchStart();b.stopPropagation()}.bind(this));this.input.bind("mousedown touchstart pointerdown mouseover mousemove",
function(b){b.stopPropagation()})},searchStart:function(){this.tableofcontentSwiperList.empty();var a=this.input.val().toLowerCase();BookEvent.trigger("search",[BookInfo.getCurrentPages().join("-"),a,"table of content"]);""===a?(this.result.css({display:"none"}),this.refreshSwiper(this.tableofcontentSwiperList,ols),this.refresh()):(a=this.matchKey(a),this.refreshSwiper(this.tableofcontentSwiperList,a),this.refresh(),a.length?this.result.css({display:"none"}):this.result.css({display:"block"}))},matchKey:function(a){var b=
[],c=function(d){for(var e=[],g=0;g<d.length;g++){var f={caption:d[g].caption,page:d[g].page,level:d[g].level,url:d[g].url};d[g].children&&0<d[g].children.length&&(f.children=c(d[g].children));if(0<=d[g].caption.toLowerCase().indexOf(a))e.push(f);else if(f.children&&0<f.children.length)for(var h=0;h<f.children.length;h++)e.push(f.children[h])}return e};return b=c(ols)},pickElements:function(a){a.input=this.input;a.searchButton=this.searchButton;a.result=this.result;a.searchButtonUrl=this.searchButtonUrl;
a.tableofcontentSwiper=this.tableofcontentSwiper;a.tableofcontentSwiperList=this.tableofcontentSwiperList;a.progress=this.progress;a.progressBar=this.progressBar},changeLanguage:function(){this.input.attr("placeholder",FormInfo.getFormTitle("tableOfContent"))}}).extend(FormElements),PcTableOfContentFrame=Class({create:function(a){this.elements=new TableOfContentElements(this);this._super(a)},onCreate:function(){this.initColorCss()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.9*
this.formOpacity),color:this.fontColor})},resetFormItems:function(){this.elements.refreshItems(this.fontColor)},initHtml:function(){this.stage.addClass("win10_border");this.stage.append(this.title);this.favicon&&(bookConfig.RightToLeft?this.title.append(this.favicon):this.title.prepend(this.favicon));bookConfig.isTabelOfContentSearchBarVisible&&(this.stage.append(this.input),this.stage.append(this.searchButton));this.stage.append(this.close);this.stage.append(this.tableofcontentSwiper);this.parent.append(this.stage)},
newItem:function(a,b,c){return new PcTableOfContentItem(a,b,c)},onResize:function(){var a=Math.max(windowHeight-bookConfig.topMargin-bookConfig.bottomMargin-toolBar.getHeight(),1);toolBar.getWidth();var b=toolBar.getTopHeight()+10;this.width=250;this.height=a-87;this.maxHeight=this.height-75;this.stage.css({height:this.height+"px",top:b+"px"});this.tableofcontentSwiper.css("height",this.maxHeight+"px");this.elements.refresh()},onShow:function(){this.changeIconColor();global.bookmark&&global.bookmark.visible&&
global.bookmark.hide();global.frmSearch&&global.frmSearch.visible&&global.frmSearch.hide()}}).extend(SlideForm),TableOfContentItem=Class({create:function(a,b,c){this.callback=c;this.level=parseInt(ols[0].level)?parseInt(b.level):parseInt(b.level)+1;this.children=[];this.parent=a;this.parm=b;this.parm.caption=HTMLString.toText(this.parm.caption);this.hasChild=b.children&&0<b.children.length;this.item=$("<li aria-label='"+getLanguage("ariaPage","page")+" "+this.parm.page+"' class='item'></li>").css({padding:"5px 10px"});
this.fontColor=b.fontColor;this.colorObj=Color(this.fontColor);this.initArrowUrl();this.initDefaultDom();this.initHtml(a,b);this.initCss();this.initEvent()},initArrowUrl:function(){this.expandUrl=form_icons.arrow?"data:image/png;base64,"+form_icons.arrow:uiBaseURL+"arrow.png";this.collapseUrl=rightToLeft?form_icons.arrow3?"data:image/png;base64,"+form_icons.arrow3:uiBaseURL+"arrow3.png":form_icons.arrow2?"data:image/png;base64,"+form_icons.arrow2:uiBaseURL+"arrow2.png"},getItem:function(){return this.item},
initDefaultDom:function(){rightToLeft?this.initRightToLeftDefaultDom():this.initLeftToRightDefaultDom();this.arrow&&(this.arrow[0].colorChanged=!1,this.arrow.changeButtonColor(this.fontColor))},initRightToLeftDefaultDom:function(){LanguageTool.isRightToLeft(this.parm.caption)?this.description=$("<p class='description rtl'>"+this.parm.caption+"</p>"):this.description=$("<p class='description'>"+this.parm.caption+"</p>");this.hasChild&&(this.arrow=$("<img alt='' class='arrow' src='"+this.collapseUrl+
"'/>"),this.arrow.css("right",10*(this.level-1)+"px"));bookConfig.isTableOfContentPagesVisible?(this.page=$("<span class='page'>"+this.parm.page+"</span>"),this.page.css("margin-right",10*(this.level-1)+15+"px")):this.description.css("margin-right",10*(this.level-1)+15+"px")},initLeftToRightDefaultDom:function(){this.description=$("<p class='description'>"+this.parm.caption+"</p>");this.hasChild&&(this.arrow=$("<img alt='' class='arrow' src='"+this.collapseUrl+"'/>"),this.arrow.css("left",10*(this.level-
1)+"px"));this.description.css("margin-left",10*(this.level-1)+15+"px");bookConfig.isTableOfContentPagesVisible&&(this.page=$("<span class='page'>"+this.parm.page+"</span>"))},initHtml:function(a,b){rightToLeft?this.initRightToLeftHtml():this.initLeftToRightHtml()},initCss:function(){bookConfig.isTableOfContentPagesVisible&&this.item.css({display:"flex","justify-content":"space-between","align-items":"center"})},initRightToLeftHtml:function(){this.item.append(this.description);bookConfig.isTableOfContentPagesVisible&&
this.item.append(this.page);this.arrow&&this.item.append(this.arrow)},initLeftToRightHtml:function(){this.arrow&&this.item.append(this.arrow);this.item.append(this.description);bookConfig.isTableOfContentPagesVisible&&this.item.append(this.page)},initEvent:function(){this.item.onTap(function(){this.parm.url?window.open(getRealURL(this.parm.url),"_blank"):(gotoPageFun(parseInt(this.parm.page),!1,"table of content"),(isPhone()||isPad())&&global.frmTableOfContent.hide())}.bind(this));this.item.bind("mouseover",
function(){this.item.css({background:this.colorObj.rgba(.1)})}.bind(this));this.item.bind("mouseleave",function(){this.isExpand||this.item.css({"background-color":"transparent"})}.bind(this));this.hasChild&&(this.arrow&&this.arrow.click(function(){this.onSwitch()}.bind(this)),this.arrow.bind("mousedown touchstart pointerdown mouseover mousemove click",function(a){a.stopPropagation()}))},expand:function(a){this.hasChild&&(0==this.children.length?this.addChildren():this.showChildren(),this.setAsExpand(),
a&&this.callback())},collapse:function(a){if(this.hasChild){for(var b=0;b<this.children.length;b++)this.children[b].hide(),this.children[b].collapse();this.setAsCollapse();a&&this.callback()}},setAsExpand:function(){this.isExpand=!0;this.arrow&&(this.arrow.attr("src",this.expandUrl),this.arrow[0].colorChanged=!1,this.arrow.changeButtonColor(this.fontColor));this.item.css({"font-weight":"bold","background-color":this.colorObj.rgba(.1)})},setAsCollapse:function(){this.isExpand=!1;this.arrow&&(this.arrow.attr("src",
this.collapseUrl),this.arrow[0].colorChanged=!1,this.arrow.changeButtonColor(this.fontColor));this.item.css({"font-weight":"","background-color":""})},addChildren:function(){var a=this.parm.children.length;this.itemList=$("<ul class='itemList'></ul>");for(var b=0;b<a;b++){this.parm.children[b].fontColor=this.fontColor;var c=new (global[this.getClassName()])(this.parent,this.parm.children[b],this.callback);this.itemList.append(c.getItem());this.children.push(c)}this.itemList.insertAfter(this.item)},
...
onShow:function(){},onResize:function(){this._super();this.numberSwiper.css("max-height",windowHeight/2+"px");this.elements.refresh()}}).extend(FadeOutFadeForm),VideoGalleryElements=Class({create:function(a){this._super(a);this.initVideoList();this.videoList&&0!=this.videoList.length&&(this.initElements(),this.initEvent(a),this.pickElements(a))},initVideoList:function(){this.videoList=videoList},initElements:function(){this.content=$("<div class='video_content'></div>");this.video=$("<iframe type='text/html' class='video' src='' allowfullscreen frameborder='0'></iframe>");
rightToLeft?this.initRightToLeftDefaultDom():this.initLeftToRightDefaultDom();this.initSwiper()},initRightToLeftDefaultDom:function(){this.info=$("<div class='info'><span class='title rtl'>"+this.videoList[0].title+"</span><p class='description rtl'>"+this.videoList[0].description+"</p></div>")},initLeftToRightDefaultDom:function(){this.info=$("<div class='info'><span class='title'>"+this.videoList[0].title+"</span><p class='description'>"+this.videoList[0].description+"</p></div>")},initSwiper:function(){if(this.videoList&&
!(1>=this.videoList.length)){this.videoListTitle=$("<sapn class='title'>"+getLanguage("frmVideoListTitle","Video list")+"</span>");this.videoSwiper=$("<div class='videoSwiper stage'></div>");var a=$("<div class='swiper' style=''></div>");this.progress=$("<div class='progress'></div>");var b=$("<div class='progressBar'></div>");this.refreshSwiper(a,this.videoList);this.videoSwiper.append(a);this.videoSwiper.append(this.progress);this.progress.append(b)}},refreshSwiper:function(a,b){for(var c=b.length,
d=0;d<c;d++)this.addItem(a,b[d])},addItem:function(a,b){if(a&&b){var c=function(){this.playVideo(b)}.bind(this);c=new VideoGalleryItem(b,c);a.append(c.getDom())}},playVideo:function(a){BookEvent.trigger("playMedia",["video gallery",BookInfo.getCurrentPages().join("-"),a.id,a.type,(new Date).getTime()]);var b=getProtocal();if("youtube"===a.type){var c=getYouTubeIdFromUrl(a.id);c=b+"www.youtube.com/embed/"+c+"?autoplay=1&wmode=transparent"}"vimeo"===a.type&&(c=getVimeoIdFromUrl(a.id),c=b+"player.vimeo.com/video/"+
c+"?autoplay=1&wmode=transparent&portrait=0");this.video.attr("src",c).attr("title",a.title||"Video player");b=this.info.find(".title");c=this.info.find(".description");b.text(a.title||"");c.text(a.description||"");this.video.attr("aria-describedby",c.attr("id"));BookEvent.trigger("customEvent",["play_video_gallery_"+a.title,{video_gallery_title:a.title}])},initEvent:function(a){this.videoSwiper&&(isPhone()||isPad()?this.videoSwiper.scroll({},Direction.left):this.videoSwiper.scroll({},Direction.top,
"win10"))},pickElements:function(a){a.videoList=this.videoList;a.content=this.content;a.video=this.video;a.info=this.info;a.videoListTitle=this.videoListTitle;a.videoSwiper=this.videoSwiper;a.progress=this.progress},changeLanguage:function(){this.videoListTitle&&this.videoListTitle.html(getLanguage("frmVideoListTitle","Video list"))}}).extend(FormElements),PcVideoGalleryFrame=Class({create:function(a){this.elements=new VideoGalleryElements(this);this._super(a)},onCreate:function(){this.initColorCss();
...
(clearInterval(this.timer),this.timer=null)},imgChange:function(a){1>=this.photoArray.length||this.moving||(a||(a=this.thumbnails[this.index]),a.siblings().removeClass("focus"),a.addClass("focus"),this.newImg=this.images[this.index],this.setImageCss(this.images[this.index]),this.moving=!0,this.newImg.fadeIn(300,function(){this.oldImg&&this.oldImg.fadeOut();this.oldImg=this.newImg;this.moving=!1}.bind(this)))},initImages:function(){for(var a=0;a<this.photoArray.length;a++){var b=$("<img alt='' src='"+
this.photoArray[a]+"'/>"),c=$('\n        <div id="thumb'+a+'" class="thumbBox">\n          <img alt=\'\' src="'+this.photoArray[a]+'"/>\n          <div class="thumbBG"></div>\n        </div>\n      ');this.images.push(b);this.thumbnails.push(c)}},setThumbnal:function(){this.thumbLeft=0;this.thumbLeft=65*this.thumbnails.length>this.pageWidth?this.thumbLeft:(this.pageWidth-65*this.thumbnails.length)/2;for(var a=0;a<this.thumbnails.length;a++){var b=this.thumbnails[a],c=b.find("img");this.thumbEvent(b);
c.css({position:"relative",width:"100%",height:"100%","object-fit":"contain"});this.setThumbImg(c,b);b.css({left:this.thumbLeft+"px"});this.thumbContainer.append(b);this.thumbLeft+=65}},setThumbImg:function(a,b){a.on("load",function(c,d){d.append(c)}.bind(this,a,b))},setPhotoImage:function(){var a=this.images[this.index];a.on("load",function(b,c){for(var d=0;d<b.images.length;d++)b.images[b.index]!=b.images[d]&&b.images[d].css({display:"none"});return function(){b.setImageCss(c)}}(this,a))},setImageCss:function(a){this.imgTop=
...
a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),c="<iframe frameborder='0'  width='240' height='210'  title='"+window.document.title+"' src='"+b+"' type='text/html' allowfullscreen='true' scrolling='no' marginwidth='0' marginheight='0'></iframe>",a.insertArea&&a.insertArea.val(c),share_url=b,a.analysisShare.refreshList(),k.yield(a.analysisShare.getList(),2);d=k.yieldResult;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$12:e.$jscomp$loop$prop$type$12},g++)f=a.itemArray[g],
e.$jscomp$loop$prop$type$12=f.attr("data-type"),(h=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$12}}(e)))&&(-1<h.url.indexOf("javascript")?f.attr("onclick",h.url.remove("javascript:")+";return false;"):f.attr("href",h.url));k.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=a.val(),copyToClipboard(a)}}},changeLanguage:function(){this.copy1.html(getLanguage("lblCopy","Copy"))},initColorConfig:function(){this.mainColor=
...
showOrHide:function(a){this.visible?this.show(a):a?this.updatePosition(a):this.hide()},_calculateAndSetPosition:function(a){if(a){this.arrow.css({"border-top-color":Color(this.mainColor).rgba(.95)});if("top"==this.direction){var b=0>a.left-179?0:a.left+343>windowWidth?windowWidth-343:a.left-179;var c=a.top-258-17;0>c&&(c=0);this.stage.css({left:b+"px",top:c+"px"});this.arrow.css({transform:"rotate(0)",left:a.left-b-12+"px",bottom:"-22px",right:"auto",top:"auto"})}else c=a.top-129,this.arrow.css({transform:"rotate(-90deg)",
left:"auto",bottom:"auto",right:"-22px",top:"133px"}),c+258>windowHeight&&(c=windowHeight-258,this.arrow.css({top:258-(windowHeight-4-a.top)+"px"})),0>c&&(c=0),b=0>a.left-368?0:a.left-368,this.stage.css({left:b+"px",top:c+"px"});this.stage.css({zIndex:3E3})}},updatePosition:function(a){this._calculateAndSetPosition(a)},show:function(a){this._calculateAndSetPosition(a);this.stage.fadeIn(function(){this.visible=!1}.bind(this));this.shareStage.refreshData();this.onShow()},changeItemColor:function(){this.shareCurrentCheck.changeButtonColor(this.fontColor)},
onShow:function(){var a=this;this.changeItemColor();this.elements.addItem(function(b){a.stage[0].style.display="inline-block";if(b){var c;null==(c=a.swiperContainer)||c.css({display:"none"})}})},hide:function(){this.stage.fadeOut(function(){this.visible=!0}.bind(this));this.onHide()},onHide:function(){}});var PcDownloadForm=Class({get hasFiles(){return window.downloadconfig?!downloadconfig.hideDownloadSinglePage||downloadconfig.pdf||downloadconfig.attachments&&0<downloadconfig.attachments.length:!1},create:function(a){this.elements=new DownloadElements(this);this._super(a)},onCreate:function(){this.initColorCss();this._super()},initColorCss:function(){this.stage.css({"background-color":this.mainColorObj.rgba(.95*this.formOpacity),color:this.fontColor});this.borderColor=this.mainColorObj.add(32);this.itemBgColor=
...
this.content1.append(this.noFilesAvailablePrompt);this.content2=$("<div class='content2'></div>");this.content2.append(this.pictureListForm.getDom());this.content.append(this.content2);this.content.append(this.content1);this.downloadContent.append(this.content);this.restricted&&(this.loadingBox=$("<img alt='' src='"+uiBaseURL+"loading.svg'/>"),this.loadingBox.css({position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)"}),this.content.css({height:"100%"}),this.downloadContent.css({height:"100%"}),
