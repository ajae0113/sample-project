...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(y,u){return"function"==typeof y?function(r){try{m(y(r))}catch(t){q(t)}}:u}var m,q,p=new f(function(y,u){m=y;q=u});this.callWhenSettled_(l(h,m),l(k,q));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
break;case 2:k(m.result_);break;default:throw Error("Unexpected state: "+m.state_);}}var m=this;null==this.onSettledCallbacks_?g.asyncExecute(l):this.onSettledCallbacks_.push(l);this.isRejectionHandled_=!0};f.resolve=d;f.reject=function(h){return new f(function(k,l){l(h)})};f.race=function(h){return new f(function(k,l){for(var m=$jscomp.makeIterator(h),q=m.next();!q.done;q=m.next())d(q.value).callWhenSettled_(k,l)})};f.all=function(h){var k=$jscomp.makeIterator(h),l=k.next();return l.done?d([]):new f(function(m,
q){function p(r){return function(t){y[r]=t;u--;0==u&&m(y)}}var y=[],u=0;do y.push(void 0),u++,d(l.value).callWhenSettled_(p(y.length-1),q),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
function isBelowIE8(){return _agent_.browser.msie?8>_agent_.browser.version?!0:!1:!1}function isBelowIE10(){return _agent_.browser.msie?10>_agent_.browser.version?!0:!1:!1}function isMacOSChrome(){var b=navigator.userAgent.toLowerCase();return/macintosh/.test(b)&&_agent_.browser.chrome}function getDeviceType(){return _agent_.browser.device===_agent_.browser.DEVICE_PHONE?"mobile":_agent_.browser.device===_agent_.browser.DEVICE_PAD?"tablet":"PC"}
function getOSVersionWithMinor(){var b=navigator.userAgent;return/windows nt/i.test(b)?(b=b.match(/windows nt ([\d.]+)/i))?b[1]:String(_agent_.system.version):/windows phone/i.test(b)?(b=b.match(/windows phone ([\d.]+)/i))?b[1]:String(_agent_.system.version):/wpdesktop/i.test(b)?(b=b.match(/wpdesktop\s*([\d.]+)/i))?b[1]:String(_agent_.system.version):/iphone|ipad/i.test(b)?(b=b.match(/os (\d+[_.\d]*)/i))?b[1].replace(/_/g,"."):String(_agent_.system.version):/android/i.test(b)?(b=b.match(/android ([\d.]+)/i))?
b[1]:String(_agent_.system.version):/macintosh/i.test(b)?(b=b.match(/os x (\d+[_.\d]*)/i))?b[1].replace(/_/g,"."):String(_agent_.system.version):/blackberry/i.test(b)?(b=b.match(/blackberry ([\d.]+)/i))?b[1]:String(_agent_.system.version):String(_agent_.system.version||"0")}
function getDeviceOS(){var b=_agent_.system.name||"",c=getOSVersionWithMinor(),d=b.toLowerCase().replace(/\s+/g,"_");b===_agent_.system.IOS&&(d="ios");b===_agent_.system.MAC&&(d="mac");b===_agent_.system.WINDOWS&&(d="windows");b===_agent_.system.ANDROID&&(d="android");if(b===_agent_.system.WP||b===_agent_.system.WP_DESKTOP)d="windows_phone";b===_agent_.system.LINUX&&(d="linux");b===_agent_.system.BLACKBERRY&&(d="blackberry");return d+"_"+c}
function getBrowserVersionWithMinor(){var b=navigator.userAgent,c;return _agent_.browser.edge?(c=b.match(/edge\/([\d.]+)/i))?c[1]:String(_agent_.browser.version):_agent_.browser.opera?(c=b.match(/opr\/([\d.]+)/i)||b.match(/opera\/([\d.]+)/i))?c[1]:String(_agent_.browser.version):_agent_.browser.uc?(c=b.match(/ucbrowser\/([\d.]+)/i))?c[1]:String(_agent_.browser.version):_agent_.browser.chrome?(c=b.match(/chrome\/([\d.]+)/i))?c[1]:String(_agent_.browser.version):_agent_.browser.firefox?(c=b.match(/firefox\/([\d.]+)/i))?
c[1]:String(_agent_.browser.version):_agent_.browser.safari?(c=b.match(/version\/([\d.]+)/i))?c[1]:String(_agent_.browser.version):_agent_.browser.msie?(c=b.match(/msie ([\d.]+)/i))?c[1]:(c=b.match(/edge\/([\d.]+)/i))?c[1]:String(_agent_.browser.version):String(_agent_.browser.version||"0")}
function getBrowserAndVersion(){var b=getBrowserVersionWithMinor();return _agent_.browser.edge?"edge_"+b:_agent_.browser.opera?"opera_"+b:_agent_.browser.uc?"uc_"+b:_agent_.browser.chrome?"chrome_"+b:_agent_.browser.firefox?"firefox_"+b:_agent_.browser.safari?"safari_"+b:_agent_.browser.msie?"ie_"+b:"unknown_"+b}
function isPadDesktopMode(){if(isPhone()||isPad()||isIphoneXor11())return!1;var b=navigator.userAgent.toLowerCase();if(!(0<navigator.maxTouchPoints||"ontouchstart"in window))return!1;b=!/mobile/.test(b);var c=window.matchMedia("(pointer: coarse)").matches,d=window.matchMedia("(hover: none)").matches;return b&&c&&d}function isMouseInput(b){b=b.originalEvent||b;return b.changedTouches||b.touches&&b.touches.length||"touch"===b.pointerType||"pen"===b.pointerType?!1:!0}
window.bdor||((this||(0,eval)("(this)")).bdor=[]);window.bdor[1]="p";var global=function(){return this||(0,eval)("(this)")}(),virtual_function=function(){};function getPackageByName(b){if(void 0==b||""==b)return global;var c=global;b=b.split(".");for(var d=0;d<b.length;d++){var e=b[d];c[e]||(c[e]={IS_PACKAGE_OBJECT:!0});c=c[e]}return c}function getClassByFullName(b){if(-1==b.indexOf("."))return global[b];var c=b.split(".");b=c.pop();c=c.join(".");return getPackageByName(c)[b]}
...
(function(b,c,d,e){function f(n,w,x){return setTimeout(m(n,x),w)}function g(n,w,x){return Array.isArray(n)?(h(n,x[w],x),!0):!1}function h(n,w,x){var B;if(n)if(n.forEach)n.forEach(w,x);else if(n.length!==e)for(B=0;B<n.length;)w.call(x,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&w.call(x,n[B],B,n)}function k(n,w,x){var B="DEPRECATED METHOD: "+w+"\n"+x+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,w,x){w=w.prototype;var B=n.prototype=Object.create(w);B.constructor=n;B._super=w;x&&X(B,x)}function m(n,w){return function(){return n.apply(w,arguments)}}function q(n,w){return"function"==typeof n?n.apply(w?w[0]||e:e,w):n}function p(n,w,x){h(r(w),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,x,!1):n.attachEvent(B,x)})}
function y(n,w,x){h(r(w),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,x,!1):n.detachEvent(B,x,!1)})}function u(n,w){for(;n;){if(n==w)return!0;n=n.parentNode}return!1}function r(n){return n.trim().split(/\s+/g)}function t(n,w,x){if(n.indexOf&&!x)return n.indexOf(w);for(var B=0;B<n.length;){if(x&&n[B][x]==w||!x&&n[B]===w)return B;B++}return-1}function v(n){return Array.prototype.slice.call(n,0)}function z(n,w,x){for(var B=[],C=[],E=0;E<n.length;){var G=w?n[E][w]:n[E];
0>t(C,G)&&B.push(n[E]);C[E]=G;E++}x&&(B=w?B.sort(function(L,T){return L[w]>T[w]}):B.sort());return B}function A(n,w){if(w&&w[0]){for(var x,B=w[0].toUpperCase()+w.slice(1),C=0;C<sa.length;){x=(x=sa[C])?x+B:w;if(x in n)return x;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,w){var x=this;this.manager=n;this.callback=w;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){q(n.options.enable,[n])&&x.handler(B)};this.init()}
function M(n,w,x){var B=x.pointers.length,C=x.changedPointers.length;var E=w&1&&0===B-C;x.isFirst=!!E;x.isFinal=!!(w&12&&0===B-C);E&&(n.session={});x.eventType=w;w=n.session;B=x.pointers;C=B.length;w.firstInput||(w.firstInput=K(x));1<C&&!w.firstMultiple?w.firstMultiple=K(x):1===C&&(w.firstMultiple=!1);E=w.firstInput;var G=(C=w.firstMultiple)?C.center:E.center;var L=x.center=H(B);x.timeStamp=qa();x.deltaTime=x.timeStamp-E.timeStamp;x.angle=J(G,L);x.distance=O(G,L);E=x.center;G=w.offsetDelta||{};L=
w.prevDelta||{};var T=w.prevInput||{};if(1===x.eventType||4===T.eventType)L=w.prevDelta={x:T.deltaX||0,y:T.deltaY||0},G=w.offsetDelta={x:E.x,y:E.y};x.deltaX=L.x+(E.x-G.x);x.deltaY=L.y+(E.y-G.y);x.offsetDirection=I(x.deltaX,x.deltaY);G=x.deltaTime;E=x.deltaX/G||0;G=x.deltaY/G||0;x.overallVelocityX=E;x.overallVelocityY=G;x.overallVelocity=ba(E)>ba(G)?E:G;C?(E=C.pointers,E=O(B[0],B[1],oa)/O(E[0],E[1],oa)):E=1;x.scale=E;C?(C=C.pointers,B=J(B[1],B[0],oa)+J(C[1],C[0],oa)):B=0;x.rotation=B;x.maxPointers=
w.prevInput?x.pointers.length>w.prevInput.maxPointers?x.pointers.length:w.prevInput.maxPointers:x.pointers.length;G=w.lastInterval||x;B=x.timeStamp-G.timeStamp;8!=x.eventType&&(25<B||G.velocity===e)?(E=x.deltaX-G.deltaX,G=x.deltaY-G.deltaY,L=E/B||0,T=G/B||0,B=L,C=T,L=ba(L)>ba(T)?L:T,E=I(E,G),w.lastInterval=x):(L=G.velocity,B=G.velocityX,C=G.velocityY,E=G.direction);x.velocity=L;x.velocityX=B;x.velocityY=C;x.direction=E;w=n.element;u(x.srcEvent.target,w)&&(w=x.srcEvent.target);x.target=w;n.emit("hammer.input",
x);n.recognize(x);n.session.prevInput=x}function K(n){for(var w=[],x=0;x<n.pointers.length;)w[x]={clientX:ea(n.pointers[x].clientX),clientY:ea(n.pointers[x].clientY)},x++;return{timeStamp:qa(),pointers:w,center:H(w),deltaX:n.deltaX,deltaY:n.deltaY}}function H(n){var w=n.length;if(1===w)return{x:ea(n[0].clientX),y:ea(n[0].clientY)};for(var x=0,B=0,C=0;C<w;)x+=n[C].clientX,B+=n[C].clientY,C++;return{x:ea(x/w),y:ea(B/w)}}function I(n,w){return n===w?1:ba(n)>=ba(w)?0>n?2:4:0>w?8:16}function O(n,w,x){x||
(x=ta);var B=w[x[0]]-n[x[0]];n=w[x[1]]-n[x[1]];return Math.sqrt(B*B+n*n)}function J(n,w,x){x||(x=ta);return 180*Math.atan2(w[x[1]]-n[x[1]],w[x[0]]-n[x[0]])/Math.PI}function N(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;D.apply(this,arguments)}function fa(){this.evEl=ua;this.evWin=va;D.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function ha(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;D.apply(this,arguments)}function S(){this.evTarget=
Ca;this.targetIds={};D.apply(this,arguments)}function R(n,w){var x=v(n.touches),B=this.targetIds;if(w&3&&1===x.length)return B[x[0].identifier]=!0,[x,x];n=v(n.changedTouches);var C=[],E=this.target;var G=x.filter(function(L){return u(L.target,E)});if(1===w)for(x=0;x<G.length;)B[G[x].identifier]=!0,x++;for(x=0;x<n.length;)B[n[x].identifier]&&C.push(n[x]),w&12&&delete B[n[x].identifier],x++;if(C.length)return[z(G.concat(C),"identifier",!0),C]}function ia(){D.apply(this,arguments);var n=m(this.handler,
this);this.touch=new S(this.manager,n);this.mouse=new N(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function U(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var w={x:n.clientX,y:n.clientY};this.lastTouches.push(w);var x=this.lastTouches;setTimeout(function(){var B=x.indexOf(w);-1<B&&x.splice(B,1)},2500)}}function ca(n,w){this.manager=n;this.set(w)}function ma(n){if(-1<n.indexOf("none"))return"none";var w=-1<n.indexOf("pan-x"),x=-1<n.indexOf("pan-y");return w&&x?"none":
w||x?w?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function P(n){this.options=X({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function ja(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function na(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function Y(n,w){return(w=w.manager)?w.get(n):n}function Q(){P.apply(this,arguments)}function da(){Q.apply(this,
arguments);this.pY=this.pX=null}function ka(){Q.apply(this,arguments)}function Z(){P.apply(this,arguments);this._input=this._timer=null}function V(){Q.apply(this,arguments)}function aa(){Q.apply(this,arguments)}function la(){P.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function W(n,w){w=w||{};var x=w.recognizers;w.recognizers=x===e?W.defaults.preset:x;return new ra(n,w)}function ra(n,w){this.options=X({},W.defaults,w||{});this.options.inputTarget=this.options.inputTarget||
n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ia(this,M);this.touchAction=new ca(this,this.options.touchAction);wa(this,!0);h(this.options.recognizers,function(x){var B=this.add(new x[0](x[1]));x[2]&&B.recognizeWith(x[2]);x[3]&&B.requireFailure(x[3])},this)}function wa(n,w){var x=n.element;if(x.style){var B;h(n.options.cssProps,function(C,E){B=A(x.style,E);w?(n.oldCssProps[B]=x.style[B],x.style[B]=C):x.style[B]=n.oldCssProps[B]||""});w||(n.oldCssProps=
{})}}function Ea(n,w){var x=c.createEvent("Event");x.initEvent(n,!0,!0);x.gesture=w;w.target.dispatchEvent(x)}var sa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),ea=Math.round,ba=Math.abs,qa=Date.now;var X="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var w=Object(n),x=1;x<arguments.length;x++){var B=arguments[x];if(B!==e&&null!==B)for(var C in B)B.hasOwnProperty(C)&&(w[C]=B[C])}return w}:Object.assign;
var xa=k(function(n,w,x){for(var B=Object.keys(w),C=0;C<B.length;){if(!x||x&&n[B[C]]===e)n[B[C]]=w[B[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,w){return xa(n,w,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var ta=["x","y"],oa=["clientX","clientY"];D.prototype={handler:function(){},init:function(){this.evEl&&p(this.element,this.evEl,this.domHandler);this.evTarget&&p(this.target,
this.evTarget,this.domHandler);this.evWin&&p(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&y(this.element,this.evEl,this.domHandler);this.evTarget&&y(this.target,this.evTarget,this.domHandler);this.evWin&&y(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(N,D,{handler:function(n){var w=Ja[n.type];w&1&&0===n.button&&(this.pressed=!0);w&2&&1!==n.which&&(w=4);this.pressed&&(w&4&&(this.pressed=
!1),this.callback(this.manager,w,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},ua="pointerdown",va="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(ua="MSPointerDown",va="MSPointerMove MSPointerUp MSPointerCancel");l(fa,D,{handler:function(n){var w=this.store,x=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var C=La[n.pointerType]||
n.pointerType,E="touch"==C,G=t(w,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>G&&(w.push(n),G=w.length-1):B&12&&(x=!0);0>G||(w[G]=n,this.callback(this.manager,B,{pointers:w,changedPointers:[n],pointerType:C,srcEvent:n}),x&&w.splice(G,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(ha,D,{handler:function(n){var w=Ma[n.type];1===w&&(this.started=!0);if(this.started){var x=v(n.touches);var B=v(n.changedTouches);w&12&&(x=z(x.concat(B),"identifier",!0));x=[x,B];w&12&&0===x[0].length-
x[1].length&&(this.started=!1);this.callback(this.manager,w,{pointers:x[0],changedPointers:x[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ca="touchstart touchmove touchend touchcancel";l(S,D,{handler:function(n){var w=Na[n.type],x=R.call(this,n,w);x&&this.callback(this.manager,w,{pointers:x[0],changedPointers:x[1],pointerType:"touch",srcEvent:n})}});l(ia,D,{handler:function(n,w,x){var B="mouse"==x.pointerType;if(!(B&&x.sourceCapabilities&&x.sourceCapabilities.firesTouchEvents)){if("touch"==
x.pointerType)w&1?(this.primaryTouch=x.changedPointers[0].identifier,U.call(this,x)):w&12&&U.call(this,x);else{if(B)a:{B=x.srcEvent.clientX;for(var C=x.srcEvent.clientY,E=0;E<this.lastTouches.length;E++){var G=this.lastTouches[E],L=Math.abs(C-G.y);if(25>=Math.abs(B-G.x)&&25>=L){B=!0;break a}}B=!1}if(B)return}this.callback(n,w,x)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var ya=A(Fa.style,"touchAction"),za=ya!==e,pa=function(){if(!za)return!1;var n={},w=b.CSS&&b.CSS.supports;
"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(x){n[x]=w?b.CSS.supports("touch-action",x):!0});return n}();ca.prototype={set:function(n){"compute"==n&&(n=this.compute());za&&this.manager.element.style&&pa[n]&&(this.manager.element.style[ya]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(w){q(w.options.enable,[w])&&(n=n.concat(w.getTouchAction()))});return ma(n.join(" "))},
preventDefaults:function(n){var w=n.srcEvent,x=n.offsetDirection;if(this.manager.session.prevented)w.preventDefault();else{var B=this.actions,C=-1<B.indexOf("none")&&!pa.none,E=-1<B.indexOf("pan-y")&&!pa["pan-y"];B=-1<B.indexOf("pan-x")&&!pa["pan-x"];if(C){var G=2>n.distance,L=250>n.deltaTime;if(1===n.pointers.length&&G&&L)return}if(!B||!E)if(C||E&&x&6||B&&x&24)return this.preventSrc(w)}},preventSrc:function(n){this.manager.session.prevented=!0;n.preventDefault()}};P.prototype={defaults:{},set:function(n){X(this.options,
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var w=this.simultaneous;n=Y(n,this);w[n.id]||(w[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=Y(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var w=this.requireFail;n=Y(n,this);-1===t(w,n)&&(w.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=Y(n,this);n=t(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function w(C){x.manager.emit(C,n)}var x=this,B=this.state;8>B&&w(x.options.event+ja(B));w(x.options.event);n.additionalEvent&&w(n.additionalEvent);8<=B&&w(x.options.event+ja(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=X({},n);q(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(Q,P,{defaults:{pointers:1},attrTest:function(n){var w=this.options.pointers;return 0===w||n.pointers.length===w},
process:function(n){var w=this.state,x=n.eventType,B=w&6;n=this.attrTest(n);return B&&(x&8||!n)?w|16:B||n?x&4?w|8:w&2?w|4:2:32}});l(da,Q,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,w=[];n&6&&w.push("pan-y");n&24&&w.push("pan-x");return w},directionTest:function(n){var w=this.options,x=!0,B=n.distance,C=n.direction,E=n.deltaX,G=n.deltaY;C&w.direction||(w.direction&6?(C=0===E?1:0>E?2:4,x=E!=this.pX,B=Math.abs(n.deltaX)):(C=0===
G?1:0>G?8:16,x=G!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return x&&B>w.threshold&&C&w.direction},attrTest:function(n){return Q.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var w=na(n.direction);w&&(n.additionalEvent=this.options.event+w);this._super.emit.call(this,n)}});l(ka,Q,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(Z,P,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var w=this.options,x=n.pointers.length===w.pointers,B=n.distance<w.threshold,C=n.deltaTime>w.time;this._input=n;if(!B||!x||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),
this._timer=f(function(){this.state=8;this.tryEmit()},w.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=qa(),this.manager.emit(this.options.event,this._input)))}});l(V,Q,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>
this.options.threshold||this.state&2)}});l(aa,Q,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return da.prototype.getTouchAction.call(this)},attrTest:function(n){var w=this.options.direction;if(w&30)var x=n.overallVelocity;else w&6?x=n.overallVelocityX:w&24&&(x=n.overallVelocityY);return this._super.attrTest.call(this,n)&&w&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&ba(x)>this.options.velocity&&
n.eventType&4},emit:function(n){var w=na(n.offsetDirection);w&&this.manager.emit(this.options.event+w,n);this.manager.emit(this.options.event,n)}});l(la,P,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var w=this.options,x=n.pointers.length===w.pointers,B=n.distance<w.threshold,C=n.deltaTime<w.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&x){if(4!=
n.eventType)return this.failTimeout();x=this.pTime?n.timeStamp-this.pTime<w.interval:!0;B=!this.pCenter||O(this.pCenter,n.center)<w.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&x?this.count+1:1;this._input=n;if(0===this.count%w.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},w.interval,this),2):8}return 32},failTimeout:function(){this._timer=f(function(){this.state=32},this.options.interval,this);return 32},reset:function(){clearTimeout(this._timer)},
emit:function(){8==this.state&&(this._input.tapCount=this.count,this.manager.emit(this.options.event,this._input))}});W.VERSION="2.0.8";W.defaults={domEvents:!1,touchAction:"compute",enable:!0,inputTarget:null,inputClass:null,preset:[[V,{enable:!1}],[ka,{enable:!1},["rotate"]],[aa,{direction:6}],[da,{direction:6},["swipe"]],[la],[la,{event:"doubletap",taps:2},["tap"]],[Z]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};
ra.prototype={set:function(n){X(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var w=this.session;if(!w.stopped){this.touchAction.preventDefaults(n);var x=this.recognizers,B=w.curRecognizer;if(!B||B&&B.state&8)B=w.curRecognizer=null;for(var C=0;C<x.length;){var E=x[C];2===w.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=w.curRecognizer=E);C++}}},get:function(n){if(n instanceof P)return n;for(var w=this.recognizers,x=0;x<w.length;x++)if(w[x].options.event==n)return w[x];return null},add:function(n){if(g(n,"add",this))return this;var w=this.get(n.options.event);w&&this.remove(w);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var w=this.recognizers;n=t(w,n);-1!==n&&(w.splice(n,1),this.touchAction.update())}return this},
on:function(n,w){if(n!==e&&w!==e){var x=this.handlers;h(r(n),function(B){x[B]=x[B]||[];x[B].push(w)});return this}},off:function(n,w){if(n!==e){var x=this.handlers;h(r(n),function(B){w?x[B]&&x[B].splice(t(x[B],w),1):delete x[B]});return this}},emit:function(n,w){this.options.domEvents&&Ea(n,w);var x=this.handlers[n]&&this.handlers[n].slice();if(x&&x.length)for(w.type=n,w.preventDefault=function(){w.srcEvent.preventDefault()},n=0;n<x.length;)x[n](w),n++},destroy:function(){this.element&&wa(this,!1);
this.handlers={};this.session={};this.input.destroy();this.element=null}};X(W,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,DIRECTION_VERTICAL:24,DIRECTION_ALL:30,Manager:ra,Input:D,TouchAction:ca,TouchInput:S,MouseInput:N,PointerEventInput:fa,TouchMouseInput:ia,SingleTouchInput:ha,
Recognizer:P,AttrRecognizer:Q,Tap:la,Pan:da,Swipe:aa,Pinch:ka,Rotate:V,Press:Z,on:p,off:y,each:h,merge:Ga,extend:xa,assign:X,inherit:l,bindFn:m,prefixed:A});("undefined"!==typeof b?b:"undefined"!==typeof self?self:{}).Hammer=W;"function"===typeof define&&define.amd?define(function(){return W}):"undefined"!=typeof module&&module.exports?module.exports=W:b[d]=W})(window,document,"Hammer");
...
this.onPan=function(f){if(!this.parameters.resize&&!this.parameters.eventCancel&&!this.parameters.zoomming&&f&&f.pointers&&1==f.pointers.length&&(this.swipeInterval&&this.swipeInterval.stop(),this.animateInterval&&this.animateInterval.stop(),this.parameters.zoomFlag&&(this.panForMove(this,f.deltaX,f.deltaY,!0),this.options&&this.options.onPan)))this.options.onPan()};this.onDoubleTap=function(f){if(!(BookEvent.trigger("beforeDoubleTap",[f])||BookInfo.getBook().status_resize||BookInfo.getBook().flipping||
(BookInfo.getBook().endFlip(),global.windowTapInterval&&window.clearTimeout(global.windowTapInterval),this.parameters.resize||this.parameters.eventCancel||this.parameters.zoomming)))if(this.status_zoom=!0,!this.parameters.zoomFlag)this.zoomIn(this),this.parameters.zoomOut=!1,this.animateToScale(this,this.middleScale,f);else if(this.parameters.zoomFlag){var g=this.parameters.naturalWidth/this.parameters.width;this.parameters.zoomOut=!0;this.animateToScale(this,g,f)}};this.zoomIn=function(f){f.parameters.left=
parseInt($(f).css("left"));f.parameters.top=parseInt($(f).css("top"));f.parameters.naturalLeft=f.parameters.left;f.parameters.naturalTop=f.parameters.top;f.parameters.width=$(f).width();f.parameters.height=$(f).height();f.parameters.naturalWidth=$(f).width();f.parameters.naturalHeight=$(f).height();f.parameters.zoomFlag=!0;f.parameters.zoomOut=!1;f.options&&f.options.zoomIn&&f.options.zoomIn()};this.zoomOut=function(f){f.swipeInterval&&f.swipeInterval.stop();f.animateInterval&&f.animateInterval.stop();
f.parameters.zoomFlag=!1;f.parameters.zoomOut=!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,q=0,p=0;f.animateInterval=function(y,u){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*
(g-1),20);q=$.easing.swing(null,m,f.parameters.left,f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);p=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:q+"px",top:p+"px"});for(var r=0;r<f.side.pageArray.length;r++)if(f.side.pageArray[r])f.side.pageArray[r].onResize(k/2,l);m++;if(20<=m||y>=u){f.animateInterval.stop();
f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100;f.parameters.top=f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100;f.parameters.width*=g;f.parameters.height*=g;f.css({width:f.parameters.width+"px",height:f.parameters.height+"px",left:f.parameters.left+"px",top:f.parameters.top+"px"});for(r=0;r<f.side.pageArray.length;r++)if(f.side.pageArray[r])f.side.pageArray[r].onResize(f.parameters.width/2,f.parameters.height);f.parameters.zoomming=
!1;1>=f.parameters.width*f.parameters.scale/f.parameters.naturalWidth&&f.zoomOut(f)}}.animation(this,320)}};this.panForMove=function(f,g,h,k){f.css({left:f.parameters.left+g+"px",top:f.parameters.top+h+"px"})};var c=!1,d=0,e=0;bookConfig.SupportOperatePageZoom&&this.dblclick(function(f){f.pointers=[{pageX:f.pageX,pageY:f.pageY}];this.onDoubleTap(f)}.bind(this));this.bind(_event._down,function(f){c=!0;d=f.pageX;e=f.pageY}.bind(this));this.bind(_event._move,function(f){f.pointers=[{pageX:f.pageX,pageY:f.pageY}];
c&&(f.deltaX=f.pageX-d,f.deltaY=f.pageY-e,this.onPan(f))}.bind(this));this.bind(_event._end,function(f){c=!1;this.parameters.left+=f.pageX-d;this.parameters.top+=f.pageY-e}.bind(this))};
...
this.onSwipe=function(d){if(!this.parameters.resize&&!this.parameters.eventCancel&&!this.parameters.zoomming)if(this.parameters.zoomFlag){var e=this.parameters.tran,f=this.tranLimit(this,this.parameters.scale,this.parameters.tran);if(f.x==parseInt(e.x)&&f.y==parseInt(e.y)){this.animateInterval&&this.animateInterval.stop();this.swipeInterval&&this.swipeInterval.stop();var g=0,h=0;d=this.getVelocity(d);g=d.velocityX;h=d.velocityY;this.swipeInterval=function(k,l){var m=this.parameters.tran,q=this.tranLimit(this,
this.parameters.scale,this.parameters.tran);q.x!=parseInt(m.x)||q.y!=parseInt(m.y)?(this.swipeInterval.stop(),this.restrictInBoundary(this)):(m=(l-k)/l,m=this.panForMove(this,g*m*16.7,h*m*16.7,!0),this.setZoomParameters(this,m),k>=l&&(this.swipeInterval.stop(),this.restrictInBoundary(this)))}.animation(this,320)}}else d=this.getDirection(d),this.options&&this.options.swipeend&&this.options.swipeend(d)};this.getDirection=function(d){var e,f=bookConfig.upsideOnMobile();d.direction&Hammer.DIRECTION_RIGHT&&
...
0!=d.velocityX&&g&&(e=d.velocityY);0!=d.velocityY&&g&&(f=-d.velocityX);return{velocityX:e,velocityY:f}};this.getDelta=function(d){var e=0,f=0,g=bookConfig.upsideOnMobile();0==d.deltaX||g||(e=d.deltaX);0==d.deltaY||g||(f=d.deltaY);0!=d.deltaX&&g&&(e=d.deltaY);0!=d.deltaY&&g&&(f=-d.deltaX);return{deltaX:e,deltaY:f}};this.onDoubleTap=function(d){if(!(BookEvent.trigger("beforeDoubleTap",[d])||BookInfo.getBook().status_resize||BookInfo.getBook().flipping||(BookInfo.getBook().endFlip(),global.windowTapInterval&&
...
!1;this.parameters.zoomFlag||(this.parameters.zoomOut=!1,this.zoomIn(this));BookEvent.trigger("zoomIn",["pinch",BookInfo.getCurrentPages().join("-")]);this.scale=this.parameters.toScale;this.parameters.origin=this.mathOrigin(this,d);this.originObj(this,this.parameters.origin);this.pinchMoveIn(this,parseFloat(this.scale)*parseFloat(d.scale),d,this.parameters.origin)}.bind(this);"pinchstart"==d.type&&(this.parameters.onPinch=!0,e(d));"pinchend"==d.type&&(this.parameters.scale=this.parameters.toScale,
this.parameters.onPinch=!1,this.exceedScale(this,d),this.pinchStart=!1);"pinchmove"==d.type&&(this.pinchStart&&e(d),this.pinchMoveIn(this,parseFloat(this.scale)*parseFloat(d.scale),d,this.parameters.origin));"pinchcancel"==d.type&&(this.parameters.scale=this.parameters.toScale,this.parameters.onPinch=!1,this.exceedScale(this,d),this.pinchStart=!1)}};this.exceedScale=function(d,e){var f=d.parameters.width*d.parameters.toScale/d.parameters.naturalWidth,g=d.parameters.width*d.parameters.toScale,h=d.parameters.height*
d.parameters.toScale,k=d.parameters.naturalWidth*d.maxScale/d.parameters.width,l=d.parameters.naturalWidth/d.parameters.width,m=d.parameters.toScale;f>d.maxScale&&(m=k);if(1>f||g<windowWidth&&h<windowHeight)d.parameters.zoomOut=!0,m=l;d.animateToScale(d,m,e)};this.zoomIn=function(d){var e=this.getBookOffset($(d));d.parameters.tran=getTransform(d[0]);d.parameters.left=e.left-d.parameters.tran.x;d.parameters.top=e.top-d.parameters.tran.y;d.parameters.width=$(d).width();d.parameters.height=$(d).height();
d.parameters.naturalWidth=$(d).width();d.parameters.naturalHeight=$(d).height();d.setZoomSize();d.parameters.zoomFlag=!0;d.parameters.zoomOut=!1;d.options&&d.options.zoomIn&&d.options.zoomIn(d.parameters)};this.beforeZoomOut=function(d){d.options&&d.options.beforeZoomOut&&d.options.beforeZoomOut()};this.zoomOut=function(d){d.swipeInterval&&d.swipeInterval.stop();d.animateInterval&&d.animateInterval.stop();d.parameters.zoomFlag=!1;d.parameters.zoomOut=!0;d.parameters.toScale=1;d.parameters.scale=1;
d.options&&d.options.zoomOut&&d.options.zoomOut()};this.tranLimit=function(d,e,f){if(f){if(d.parameters.zoomOut){f={x:0,y:0};f.x=d.parameters.width*(e-1)*d.parameters.origin.x/100;f.y=d.parameters.height*(e-1)*d.parameters.origin.y/100;if((bookType==BookType.normal_book||bookType==BookType.catalog_book)&&bookConfig.retainBookCenter&&d.isBook){var g=BookInfo.getCurrentPages();1==g.length&&"issuu"!=bookConfig.FlipStyle&&(!BookInfo.isLeftPage(g[0],!0)&&bookConfig.FlipDirection&&(f.y-=d.parameters.height*
e/4),BookInfo.isLeftPage(g[0],!0)&&bookConfig.FlipDirection&&(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var m=d.parameters.top-d.parameters.origin.y*(e-1)*k/
100;var q=e*h,p=e*k,y=0,u=0,r=0,t=0;toolBar&&(y=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,u=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,r=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,t=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(q>windowWidth){var v=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-t;l=-l-h*e*d.parameters.zoomArea.left/100+r}else v=-l-h*e*d.parameters.zoomArea.left/100+r,l=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-
t;p>windowHeight?(h=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u,d=-m-k*e*d.parameters.zoomArea.top/100+y):(h=-m-k*e*d.parameters.zoomArea.top/100+y,d=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,v,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||!e.pointers||0>=e.pointers.length||!f)return{x:0,y:0};var g=this.getPageXY(e);e=g.pageX;g=g.pageY;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left;d=d.parameters.top;l=(f.x*h/100+l).toFixed(2);f=(f.y*k/100+d).toFixed(2);e-=parseFloat(l);f=g-parseFloat(f);return{x:parseFloat(e.toFixed(2)),y:parseFloat(f.toFixed(2))}};this.mathOrigin=function(d,e){if(!e||!e.pointers||0>=e.pointers.length)return{x:50,y:50};var f=
this.getPageXY(e);e=f.pageX;f=f.pageY;var g=d.parameters.width;var h=d.parameters.height;var k=this.getBookOffset(d);e=(e-parseInt(k.left))/(g*d.parameters.scale);d=(f-parseInt(k.top))/(h*d.parameters.scale);return{x:(100*e).toFixed(2),y:(100*d).toFixed(2)}};this.getPageXY=function(d){var e=bookConfig.upsideOnMobile();if(1==d.pointers.length){var f=d.pointers[0].pageX;var g=d.pointers[0].pageY}1<d.pointers.length&&(f=(d.pointers[0].pageX+d.pointers[1].pageX)/2,g=(d.pointers[0].pageY+d.pointers[1].pageY)/
2);return e?{pageX:g,pageY:windowHeight-f}:{pageX:f,pageY:g}};this.getBookOffset=function(d){if(d)return d=d.offset(),bookConfig.upsideOnMobile()?{left:d.top,top:d.left}:{left:d.left,top:d.top}};this.restrictInBoundary=function(d,e){if(!d.parameters.eventCancel&&!d.parameters.zoomming){var f=d.parameters.tran,g=this.tranLimit(d,d.parameters.scale,f);if(g.x!=parseInt(f.x)||g.y!=parseInt(f.y)){d.animateInterval&&d.animateInterval.stop();var h=0,k=0;g.x!=f.x&&(h=g.x-f.x);g.y!=f.y&&(k=g.y-f.y);d.animateInterval=
function(l,m){var q=$.easing.easeOutBack(null,l,0,h,m),p=$.easing.easeOutBack(null,l,0,k,m);0<l&&(q-=$.easing.easeOutBack(null,l-1,0,h,m),p-=$.easing.easeOutBack(null,l-1,0,k,m));l>=m&&(p=d.parameters.tran,q=g.x-p.x,p=g.y-p.y);q=d.panForMove(d,q,p);d.setZoomParameters(d,q);l>=m&&(d.animateInterval.stop(),BookInfo.getBook().bookAttachments&&BookInfo.getBook().bookAttachments.Items.find("ZoomMap").each(function(y){y.refreshArea()}),e&&"function"==typeof e&&e())}.animation(this,320)}}};this.transformSetting=
function(d,e){d.setZoomParameters(d,e);e=transformCSS(e);d.css(e)};this.panForMove=function(d,e,f,g){var h=d.parameters?d.parameters.tran:{x:0,y:0};g=d.parameters?d.parameters.scale:1;h||(h={x:0,y:0});g||0==g||(g=1);e=parseInt(h.x+e);var k=parseInt(h.y+f);f={x:e,y:k};BookInfo.getBook().disableDriection&&(f=bookConfig.FlipDirection||bookConfig.upsideOnMobile()?{x:e,y:h.y}:{x:h.x,y:k});h=transformCSS({tran:f,scale:g});d.css(h);return{tran:f,scale:g}};this.originObj=function(d,e){d.css({"-webkit-transform-origin":e.x+
"% "+e.y+"%","-moz-transform-origin":e.x+"% "+e.y+"%","-ms-transform-origin":e.x+"% "+e.y+"%","-o-transform-origin":e.x+"% "+e.y+"%"})};this.setZoomParameters=function(d,e){function f(k){return void 0!==k&&null!==k}function g(k){return f(e[k])&&!isNaN(e[k])?e[k]:d.parameters[k]}function h(k){return f(e[k])?e[k]:d.parameters[k]}d&&d.parameters&&e&&(d.parameters={width:g("width"),height:g("height"),naturalWidth:g("naturalWidth"),naturalHeight:g("naturalHeight"),left:g("left"),top:g("top"),scale:g("scale"),
rotate:g("rotate"),toScale:g("toScale"),tran:h("tran"),origin:h("origin"),zoomFlag:h("zoomFlag"),zoomming:h("zoomming"),zoomOut:h("zoomOut"),resize:h("resize"),eventCancel:h("eventCancel"),zoomArea:h("zoomArea"),zoomDelay:h("zoomDelay"),onPan:h("onPan"),onSwipe:h("onSwipe"),onDoubleTap:h("onDoubleTap"),onPinch:h("onPinch")})};this.animateToTransform=function(d,e,f){if(!this.parameters.eventCancel&&!this.parameters.zoomming){this.options&&this.options.zoomStart&&this.options.zoomStart();var g=this.getBookOffset($(this));
this.parameters.tran=getTransform(this[0]);if(parseInt(e.x)!=parseInt(this.parameters.tran.x)||parseInt(e.y)!=parseInt(this.parameters.tran.y)||d.toFixed(2)!=this.parameters.scale.toFixed(2)){this.parameters.zoomming=!0;this.parameters.left=g.left-this.parameters.tran.x;this.parameters.top=g.top-this.parameters.tran.y;this.parameters.width=$(this).width();this.parameters.height=$(this).height();this.parameters.naturalWidth=$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();
var h={};h.origin=this.parameters.origin;h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;e=transformCSS(h);this.originObj(this,h.origin);animateOnce(this,e,300,function(){getTransform(this[0]);this.transformSetting(this,h);this.parameters.scale=d;this.parameters.toScale=d;this.parameters.zoomming=!1;if(this.options.onZoomed)this.options.onZoomed(h)}.bind(this),"%stransform","ease-out")}}};this.animateToTransform=function(d,e,f){if(!this.parameters.eventCancel&&!this.parameters.zoomming){this.options&&
this.options.zoomStart&&this.options.zoomStart();var g=this.getBookOffset($(this));this.parameters.tran=getTransform(this[0]);if(parseInt(e.x)!=parseInt(this.parameters.tran.x)||parseInt(e.y)!=parseInt(this.parameters.tran.y)||d.toFixed(2)!=this.parameters.scale.toFixed(2)){this.parameters.zoomming=!0;this.parameters.left=g.left-this.parameters.tran.x;this.parameters.top=g.top-this.parameters.tran.y;this.parameters.width=$(this).width();this.parameters.height=$(this).height();this.parameters.naturalWidth=
$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(q,p){m(q,p,"Sine")}).animation(this,300)}.bind(this),m=function(q,p,y){if(q<p){y=k(null,q,this.parameters.tran.x,e.x-this.parameters.tran.x,p);var u=k(null,q,this.parameters.tran.y,e.y-this.parameters.tran.y,p);q=k(null,q,this.parameters.scale,d-this.parameters.scale,p);p={};p.scale=
q;p.tran={x:y,y:u};y=transformCSS(p);this.css(y)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(q){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=
this.tranLimit(d,e,h.tran);this.zoomTran=h;this.animation(d,e,h,g)}};this.animation=function(d,e,f,g){var h=transformCSS(f);d.originObj(d,f.origin);animateOnce(d,h,void 0==g?600:g,function(){getTransform(d[0]);d.transformSetting(d,f);d.parameters.scale=e;d.parameters.toScale=e;d.parameters.zoomming=!1;var k=(d.parameters.width*d.parameters.toScale).toFixed(2),l=(d.parameters.height*d.parameters.toScale).toFixed(2),m=d.parameters.naturalWidth,q=d.parameters.naturalHeight;if(Number.isBetween(k,m-1,
m+1)||Number.isBetween(l,q-1,q+1)){d.timeout&&(d.timeout=void 0,window.clearTimeout(d.timeout));d.parameters.zoomDelay=!1;if(d.options.onZoomed)d.options.onZoomed(d.zoomTran);d.zoomOut(d)}else if(d.options.onZoomed)d.options.onZoomed(d.zoomTran)}.bind(d),"%stransform","cubic-bezier(0.2150, 0.610, 0.3550, 1)")};this.delayExecuteOnZoomed=function(d){d.timeout=window.setTimeout(function(){if(d.parameters.zoomFlag&&!d.parameters.onPinch&&!d.parameters.zoomming)d.options.onZoomed(d.zoomTran);d.parameters.zoomDelay=
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),q=getHost();if(m&&q!==m){if(g=f.src.replace(m,q),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(t){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var p=h.getImageData(0,0,k,l),y=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&p){var u=Color(b).split();k=0;for(var r=p.data.length;k<r;k+=4)0<y.data[k+3]&&(p.data[k]!=u.r&&(y.data[k]=p.data[k]/255*u.r),p.data[k+1]!=u.g&&(y.data[k+1]=
p.data[k+1]/255*u.g),p.data[k+2]!=u.b&&(y.data[k+2]=p.data[k+2]/255*u.b));h.putImageData(y,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(t){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(v){}})}}}}};
...
jQuery.fn.appearance=function(b,c,d){var e=this;d=d||{};this.background=$("<div class='appear_win10'></div>");this.addClass("main_dom");this.background.append(this);d.defaultHide&&this.background.css("opacity",0).hide();this.show=function(){var f=this;this.animating=!0;this.background.show();this.background.animate({opacity:1},function(){f.animating=!1;f.background.show();b&&b()})}.bind(this);this.hide=function(){var f=this;this.animating=!0;this.background.animate({opacity:0},function(){f.animating=
!1;f.background.hide();c&&c()})}.bind(this);this.getDom=function(){return this.background}.bind(this);this.background.on("click",function(f){f.target==f.currentTarget&&(e.animating||e.hide())});return this.background};
$.fn.speed=function(b){function c(r){r=void 0==r.originalEvent.touches?[r]:r.originalEvent.touches;if(1<r.length)return p=!0;f=h=r[0].pageX;g=k=r[0].pageY;l=new Date;-1!=q&&window.clearInterval(q);q=window.setInterval(function(){f=h;g=k;l=new Date},300)}function d(r){if(-1==q||1==p)return!0;r=void 0==r.originalEvent.touches?[r]:r.originalEvent.touches;h=r[0].pageX;k=r[0].pageY}function e(r){if(-1==q)return!0;r=void 0!=r.originalEvent.touches==0?[r]:r.originalEvent.touches;if(1==p)return p=1<r.length,
!0;m=new Date;r=(m-l)/20;var t=h-f,v=k-g;0==r?u=y=0:(y=t/r,u=v/r);void 0!=b&&b(y,u);window.clearInterval(q);q=-1}var f,g,h,k,l,m,q=-1,p=!1,y=0,u=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(r){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(r){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",q=-1,p,y,u,r=k.length-l;++q<r;)p=k.charCodeAt(q)<<
16,y=k.charCodeAt(++q)<<8,u=k.charCodeAt(++q),p=p+y+u,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p&63);2==l?(p=k.charCodeAt(q)<<8,y=k.charCodeAt(++q),p+=y,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p<<2&63)+"="):1==l&&(p=k.charCodeAt(q),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,q,p,y="",u=-1;++u<l;)p="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(u)),
q=m%4?64*q+p:p,m++%4&&(y+=String.fromCharCode(255&q>>(-2*m&6)));return y},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(function(b){function c(u,r){var t=(u&65535)+(r&65535);return(u>>16)+(r>>16)+(t>>16)<<16|t&65535}function d(u,r,t,v,z,A){u=c(c(r,u),c(v,A));return c(u<<z|u>>>32-z,t)}function e(u,r,t,v,z,A,F){return d(r&t|~r&v,u,r,z,A,F)}function f(u,r,t,v,z,A,F){return d(r&v|t&~v,u,r,z,A,F)}function g(u,r,t,v,z,A,F){return d(t^(r|~v),u,r,z,A,F)}function h(u,r){u[r>>5]|=128<<r%32;u[(r+64>>>9<<4)+14]=r;var t=1732584193,v=-271733879,z=-1732584194,A=271733878;for(r=0;r<u.length;r+=16){var F=t;var D=v;var M=z;var K=A;
t=e(t,v,z,A,u[r],7,-680876936);A=e(A,t,v,z,u[r+1],12,-389564586);z=e(z,A,t,v,u[r+2],17,606105819);v=e(v,z,A,t,u[r+3],22,-1044525330);t=e(t,v,z,A,u[r+4],7,-176418897);A=e(A,t,v,z,u[r+5],12,1200080426);z=e(z,A,t,v,u[r+6],17,-1473231341);v=e(v,z,A,t,u[r+7],22,-45705983);t=e(t,v,z,A,u[r+8],7,1770035416);A=e(A,t,v,z,u[r+9],12,-1958414417);z=e(z,A,t,v,u[r+10],17,-42063);v=e(v,z,A,t,u[r+11],22,-1990404162);t=e(t,v,z,A,u[r+12],7,1804603682);A=e(A,t,v,z,u[r+13],12,-40341101);z=e(z,A,t,v,u[r+14],17,-1502002290);
v=e(v,z,A,t,u[r+15],22,1236535329);t=f(t,v,z,A,u[r+1],5,-165796510);A=f(A,t,v,z,u[r+6],9,-1069501632);z=f(z,A,t,v,u[r+11],14,643717713);v=f(v,z,A,t,u[r],20,-373897302);t=f(t,v,z,A,u[r+5],5,-701558691);A=f(A,t,v,z,u[r+10],9,38016083);z=f(z,A,t,v,u[r+15],14,-660478335);v=f(v,z,A,t,u[r+4],20,-405537848);t=f(t,v,z,A,u[r+9],5,568446438);A=f(A,t,v,z,u[r+14],9,-1019803690);z=f(z,A,t,v,u[r+3],14,-187363961);v=f(v,z,A,t,u[r+8],20,1163531501);t=f(t,v,z,A,u[r+13],5,-1444681467);A=f(A,t,v,z,u[r+2],9,-51403784);
z=f(z,A,t,v,u[r+7],14,1735328473);v=f(v,z,A,t,u[r+12],20,-1926607734);t=d(v^z^A,t,v,u[r+5],4,-378558);A=d(t^v^z,A,t,u[r+8],11,-2022574463);z=d(A^t^v,z,A,u[r+11],16,1839030562);v=d(z^A^t,v,z,u[r+14],23,-35309556);t=d(v^z^A,t,v,u[r+1],4,-1530992060);A=d(t^v^z,A,t,u[r+4],11,1272893353);z=d(A^t^v,z,A,u[r+7],16,-155497632);v=d(z^A^t,v,z,u[r+10],23,-1094730640);t=d(v^z^A,t,v,u[r+13],4,681279174);A=d(t^v^z,A,t,u[r],11,-358537222);z=d(A^t^v,z,A,u[r+3],16,-722521979);v=d(z^A^t,v,z,u[r+6],23,76029189);t=d(v^
z^A,t,v,u[r+9],4,-640364487);A=d(t^v^z,A,t,u[r+12],11,-421815835);z=d(A^t^v,z,A,u[r+15],16,530742520);v=d(z^A^t,v,z,u[r+2],23,-995338651);t=g(t,v,z,A,u[r],6,-198630844);A=g(A,t,v,z,u[r+7],10,1126891415);z=g(z,A,t,v,u[r+14],15,-1416354905);v=g(v,z,A,t,u[r+5],21,-57434055);t=g(t,v,z,A,u[r+12],6,1700485571);A=g(A,t,v,z,u[r+3],10,-1894986606);z=g(z,A,t,v,u[r+10],15,-1051523);v=g(v,z,A,t,u[r+1],21,-2054922799);t=g(t,v,z,A,u[r+8],6,1873313359);A=g(A,t,v,z,u[r+15],10,-30611744);z=g(z,A,t,v,u[r+6],15,-1560198380);
v=g(v,z,A,t,u[r+13],21,1309151649);t=g(t,v,z,A,u[r+4],6,-145523070);A=g(A,t,v,z,u[r+11],10,-1120210379);z=g(z,A,t,v,u[r+2],15,718787259);v=g(v,z,A,t,u[r+9],21,-343485551);t=c(t,F);v=c(v,D);z=c(z,M);A=c(A,K)}return[t,v,z,A]}function k(u){var r,t="",v=32*u.length;for(r=0;r<v;r+=8)t+=String.fromCharCode(u[r>>5]>>>r%32&255);return t}function l(u){var r,t=[];t[(u.length>>2)-1]=void 0;for(r=0;r<t.length;r+=1)t[r]=0;var v=8*u.length;for(r=0;r<v;r+=8)t[r>>5]|=(u.charCodeAt(r/8)&255)<<r%32;return t}function m(u){return k(h(l(u),
8*u.length))}function q(u,r){var t=l(u),v=[],z=[];v[15]=z[15]=void 0;16<t.length&&(t=h(t,8*u.length));for(u=0;16>u;u+=1)v[u]=t[u]^909522486,z[u]=t[u]^1549556828;r=h(v.concat(l(r)),512+8*r.length);return k(h(z.concat(r),640))}function p(u){var r="",t;for(t=0;t<u.length;t+=1){var v=u.charCodeAt(t);r+="0123456789abcdef".charAt(v>>>4&15)+"0123456789abcdef".charAt(v&15)}return r}function y(u,r,t){r?t?u=q(unescape(encodeURIComponent(r)),unescape(encodeURIComponent(u))):(u=q(unescape(encodeURIComponent(r)),
unescape(encodeURIComponent(u))),u=p(u)):u=t?m(unescape(encodeURIComponent(u))):p(m(unescape(encodeURIComponent(u))));return u}"function"===typeof define&&define.amd?define(function(){return y}):"object"===typeof module&&module.exports?module.exports=y:b.md5=y})(this);String.prototype.MD5=function(b){return md5(this)};
...
$("<img alt='' src='"+b+"'/>"):new Image},parseBool=function(b,c){if(!0===b||!1===b)return b;if(void 0==b||null==b)return!1;c=!!c;if("number"==typeof b)return 0!=b;if("string"!=typeof b||""==b)return!1;var d=["true","yes","show","enable"],e=["false","no","hide","disable"];b=b.toLowerCase();return 0>d.indexOf(b)&&0>e.indexOf(b)?c:0<=d.indexOf(b)},getLanguage=function(b,c){if(global.selectedLanguage&&selectedLanguage[b])return selectedLanguage[b];if(global.aliasLanguage&&aliasLanguage[b]){b=aliasLanguage[b];
for(var d=0;d<b.length;d++){var e=b[d];if(global.selectedLanguage&&selectedLanguage[e])return selectedLanguage[e]}}return c},selectedLanguage,selectLanguage=function(b){b||(b="");global.language||(global.language=[]);selectedLanguage=[];if(0==language.length)BookEvent.trigger("selectedLanguage",[]);else{var c="";if(b=b.toLowerCase()){var d=[];try{d=b.split(";")}catch(e){d=[]}0<d.length&&(c=d[0])}if(c)for(b=0;b<language.length;b++){if(language[b].language.toLowerCase()==c){selectedLanguage=language[b];
break}}else selectedLanguage=language[0];BookEvent.trigger("selectedLanguage",[]);global.selectedLanguage&&global.selectedLanguage.language&&(c={Arabic:"ar","Chinese (Traditional)":"zh-TW",Chinese:"zh-CN",Dutch:"nl",English:"en",French:"fr",German:"de",Greek:"el",Hebrew:"he",Indonesian:"id",Italian:"it",Japanese:"ja",Korean:"ko",Macedonian:"mk",Persian:"fa",Portuguese:"pt",Romanian:"ro",Russian:"ru",Spanish:"es",Basque:"eu",Bengali:"bn",Czech:"cs",Polish:"pl",Swedish:"sv",Turkish:"tr",Ukrainian:"uk"}[global.selectedLanguage.language])&&
document.querySelector("html").setAttribute("lang",c)}},handleData=function(b,c){if(100>b.length)return b;if(!c||!c.trim())return 100<b.length?b.substring(0,100)+"..":b;var d=HTMLString.containsChinese(c),e=b.length,f=-1;if(d){if(d=HTMLString.removeSpacesAndNewlines(b.toLowerCase()),c=HTMLString.removeSpacesAndNewlines(c.toLowerCase()),c=d.indexOf(c),-1!==c){d=[];for(var g=0;g<b.length;g++)/[\s\r\n]/.test(b[g])||d.push(g);c<d.length&&(f=d[c])}}else f=b.toLowerCase().indexOf(c.toLowerCase());if(-1===
f)return 100<b.length?b.substring(0,100)+"..":b;50<=f?(c=Math.max(50<=e-f?f-50:e-100,0),c=".."+b.substring(c,f)):c=b.substring(0,f);b=50<e-f?b.substring(f,50<=f?f+50:100)+"..":b.substring(f,e);return c+b},onWindowTap=function(b){b=BookInfo.getBook&&BookInfo.getBook();b&&(b.status_zoom||b.isZoomming||b.status_resize||b.flipping)||(Log.print("onWindowTapEnter"),global.windowTapInterval&&window.clearTimeout(global.windowTapInterval),global.windowTapInterval=window.setTimeout(function(){if("Modern"!==
_get(htmlConfig,"phoneTemplate.name"))if(global.moreBar&&moreBar.visible)moreBar.hide();else{if(isPhone()||isPad()){if(bookConfig.toolbarAlwaysShow)return;global.phoneSearchBar&&global.phoneSearchBar.showOrHide();global.toolBar&&global.toolBar.showOrHide()}global.windowTapInterval&&window.clearTimeout(global.windowTapInterval)}},401))},stopEvent=function(b){try{var c=b||window.event;c.preventDefault?(c.preventDefault(),c.stopPropagation()):(c.returnValue=!1,c.cancelBubble=!0)}catch(d){}return!1},
getPagesByRange=function(b){function c(k){for(var l=0;l<d.length;l++)if(d[l]==k)return!0;return!1}var d=[];if(!b||"string"!==typeof b||""==b.trim())return d;b=b.split(",");for(var e=0;e<b.length;e++){var f=b[e];if(!isNaN(f))f=getRealPageNumber(f),!c(f)&&f<=bookConfig.totalPageCount&&d.push(f);else if(-1<f.indexOf("-")){var g=f.split("-");if(!(2>g.length)){f=getRealPageNumber(g[0]);var h=getRealPageNumber(g[1]);g=Math.max(f,h);for(f=Math.min(f,h);f<=g;f++)f>bookConfig.totalPageCount||c(f)||d.push(f)}}}return d},
isSlideBook=function(){return"slide"==bookConfig.FlipStyle.toLowerCase()||isBelowIE9()?!0:!1};
...
global.annotationPannel.changeLanguage();global.jsLoadingBar&&global.jsLoadingBar.changeLanguage(b);global.reportPanel&&global.reportPanel.changeLanguage(b);global.chatbotPanel&&global.chatbotPanel.changeLanguage(b);global.modernSearch&&global.modernSearch.changeLanguage();global.modernBookmarkPanel&&global.modernBookmarkPanel.changeLanguage();global.modernThumbnailsPanel&&global.modernThumbnailsPanel.changeLanguage();global.modernSelectTextPanel&&global.modernSelectTextPanel.changeLanguage();global.modernSettingBody&&
global.modernSettingBody.changeLanguage();global.modernTelephonePanel&&global.modernTelephonePanel.changeLanguage();global.modernSecondaryPanel&&global.modernSecondaryPanel.changeLanguage();BookEvent.trigger("changeLanguage",[])},baiduAnalytics=function(){bookConfig.baiduAnalyticsID&&window.setTimeout(function(){var b=document.createElement("script");b.src="https://hm.baidu.com/hm.js?"+bookConfig.baiduAnalyticsID;var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(b,c)},3E3)},
controlAudioVolume=function(){if(!isNaN(bookConfig.bgSoundVol)){var b=parseFloat(bookConfig.bgSoundVol/100);global.bgSound&&global.bgSound.setVolume(b);flipAudio&&(flipAudio[0].volume=b)}},TurnonAutoFlip=function(){bookConfig.autoFlipOnStart&&window.setTimeout(function(){auto_player&&auto_player.start();toolBar&&toolBar.changeAutoPlayIcon&&toolBar.changeAutoPlayIcon()},1E3)},playFlipSound=function(){if(global.flipSoundIsPlaying)if(!isPhone()&&!isPad()&&!isIE()){var b="flipsound";if(bookType==BookType.slide_book||
bookType==BookType.singleSlide_book)b="slidesound";var c=soundBaseURL+b+".mp3";b=soundBaseURL+b+".ogg";bookConfig.flipSoundURL&&(b=c=bookConfig.flipSoundURL);0<$("#flippingSound").length&&$("#flippingSound").remove();c=$("<audio id='flippingSound' preload style='display:none;'>\n        \"<source src='"+b+"?2024070101' type='audio/ogg'>\n        \"<source src='"+c+"?2024070101' type='audio/mpeg'>\n        </audio>");$("body").append(c);b=parseFloat(bookConfig.bgSoundVol/100);c[0].volume=b;c.bind("ended",
...
b+"?2024081201' type='audio/ogg'>\n      <source src='"+c+"?2024081201' type='audio/mpeg'>\n      </audio>");$("body").append(flipAudio)}},initSettingBody=function(){(isPhone()||isPad())&&"neat"===_get(htmlConfig,"phoneTemplate.name")&&"Chinese"==UserGroups?toolBar.$morePanel&&toolBar.$morePanel.appendMusicButton():global.settingBody?global.settingBody.reset&&global.settingBody.reset():isPhone()||isPad()?global.settingBody=new PhoneSettingForm({parent:tmpContainer,formType:"setting",rightToLeft:rightToLeft}):
global.settingBody=new PcSoundSettingForm({parent:tmpContainer,formType:"brief"==global.templeteName?"setting":"settingpc",rightToLeft:rightToLeft})};function copyFromObj(b){if(b){b.focus();b.select();try{document.execCommand("Copy")}catch(c){b=b.val(),copyToClipboard(b)}}}
...
function getArticleTitle(b){for(var c=b.articleTextList,d="",e=-1,f=0;f<c.length;f++)if("headline"==c[f].fontType){e=f;break}if(0<=e)for(;e<c.length;e++)if("headline"==c[e].fontType)d+=c[e].text;else break;d||(d=b.title);return d}function getArticleTitleList(b){for(var c=b.articleTextList,d=[],e=0;e<c.length;e++)if("headline"==c[e].fontType)d.push(c[e].text);else if(0<d.length)break;c=0<d.length&&d.every(function(f){return!f});return(0===d.length||c)&&b.title?[b.title]:d}
function copyTextToClipboard(b){navigator.clipboard&&navigator.clipboard.writeText?navigator.clipboard.writeText(b).then(function(){}).catch(function(c){fallbackCopyTextToClipboard(b)}):fallbackCopyTextToClipboard(b)}function fallbackCopyTextToClipboard(b){var c=$("<textarea>");$("body").append(c);c.val(b).select();try{document.execCommand("copy")?console.log("success!"):console.error("fail!")}catch(d){console.error("failed to copy: ",d)}c.remove()}
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this;k=d(h);var m=void 0!==k&&null!==k?k:"__default__";e[m]&&clearTimeout(e[m]);return new Promise(function(q,p){f[m]||(f[m]=[]);f[m].push({resolve:q,reject:p});e[m]=setTimeout(function(){var y,u,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){switch(t.nextAddress){case 1:return y=f[m],t.setCatchFinallyBlocks(2,3),t.yield(b.apply(l,
h),5);case 5:u=t.yieldResult,y&&y.forEach(function(v){return v.resolve(u)});case 3:t.enterFinallyBlock();delete e[m];delete f[m];t.leaveFinallyBlock(0);break;case 2:r=t.enterCatchBlock(),y&&y.forEach(function(v){return v.reject(r)}),t.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d");l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var q=m.getImageData(0,0,l.width,l.height),p=q.data,y=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<p.length;r+=4){var t=p[r+3];0===t?(p[r]=u.r,p[r+1]=u.g,p[r+2]=u.b,p[r+3]=void 0!==u.a?u.a:0):0<t&&255>t?y&&(p[r]=Math.round((y.r*t+u.r*(255-t))/255),p[r+1]=Math.round((y.g*t+u.g*(255-t))/255),p[r+2]=Math.round((y.b*t+u.b*(255-t))/255),p[r+3]=255):y&&(p[r]=y.r,
p[r+1]=y.g,p[r+2]=y.b,p[r+3]=void 0!==y.a?y.a:255)}m.putImageData(q,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(p,y){var u=c();try{var r=y&&"object"===typeof y?Object.assign({},y):y;if(r&&"object"===typeof r){r.page=Number(p+1);var t=u[p];t&&t.positions&&r.positions?r.positions=t.positions.concat(r.positions):t&&t.positions&&(r.positions=t.positions);null!=l?r.realPage=Number(l):t&&t.realPage&&(r.realPage=t.realPage);t&&Object.keys(t).forEach(function(v){"page"===v||"realPage"===v||"positions"===
v||v in r||(r[v]=t[v])})}u[p]=r;return!0}catch(v){return console.error("writeToTarget error",v),!1}}function e(p,y,u){if(!p||0===p.length)return null;for(var r=p[0].left,t=p[0].top,v=p[0].right,z=p[0].bottom,A="",F=0;F<p.length;F++){var D=p[F];r=Math.min(r,D.left);t=Math.min(t,D.top);v=Math.max(v,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=r/y;t/=u;v/=y;u=z/u;u=[F,u,v,u,v,t,F,t];z=[];for(F=0;F<p.length;F++)z.push(p[F].width/y);if(!A||0===A.trim().length)return null;p=u.concat(z);return{w:A,p:p}}
function f(p){b._pageReaderExtracted||(b._pageReaderExtracted={});p=Array.isArray(p)?p:[p];for(var y=0,u=0;u<p.length;u++){var r=p[u];if(r&&!(1>r)&&!b._pageReaderExtracted[r])if(b._pageReaderExtracted[r]=!0,window._getPage&&"function"===typeof window._getPage)try{var t=window._getPage(r-1);if(t){var v=null;if(t.items&&Array.isArray(t.items)){v=t.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<v.length;D++){var M=v[D];if(M&&"text"===M.type&&
M.positionText&&M.style){var K=M,H=r,I=z,O=A,J=c();b.pageTextPositions||(b.pageTextPositions=[]);var N=K;if(N&&N.positionText&&N.style){K=[];var fa=parseFloat(N.style.left)||0,ha=parseFloat(N.style.top)||0,S=N.positionText;for(N=0;N<S.length;N++){var R=S[N];if(R&&R.rowText&&0!==R.rowText.length){for(var ia=R.rowText,U=[],ca=null,ma=0;ma<ia.length;ma++){var P=ia[ma];if(P&&P.text){var ja=fa+(P.left||0),na=ha+(P.top||0),Y=P.width||0,Q=P.height||0,da=ja+Y,ka=!1;null!==ca&&ja-ca>.5*Y&&(ka=!0);if(ka&&0<
U.length){var Z=e(U,I,O);Z&&K.push(Z);U=[]}U.push({text:P.text,left:ja,top:na,width:Y,height:Q,right:da,bottom:na+Q});ca=da}}0<U.length&&(Z=e(U,I,O))&&K.push(Z)}}var V=K}else V=[];if(0!==V.length){I=H-1;var aa=J[I];aa?(aa.positions&&Array.isArray(aa.positions)?J[I].positions=aa.positions.concat(V):J[I].positions=V,J[I].page=H):J[I]={page:H,positions:V}}F++}}y+=F;0<F?console.log("PageTextExtractor: \u6210\u529f\u63d0\u53d6\u5e76\u6dfb\u52a0 "+F+" \u4e2a\u6587\u672c\u914d\u7f6e\u5230 positionForPages (\u9875\u9762 "+
(r-1)+")"):console.log("PageTextExtractor: \u9875\u9762 "+(r-1)+" \u4e2d\u6ca1\u6709\u627e\u5230\u6587\u672c\u5143\u7d20")}else console.warn("PageTextExtractor: \u9875\u9762\u6570\u636e\u683c\u5f0f\u4e0d\u6b63\u786e\uff0c\u671f\u671b {items: [...]}")}else console.warn("PageTextExtractor: \u65e0\u6cd5\u83b7\u53d6\u9875\u9762 "+(r-1)+" \u7684\u6570\u636e")}catch(la){b._pageReaderExtracted[r]=!1,console.error("PageTextExtractor: \u63d0\u53d6\u9875\u9762 "+(r-1)+" \u7684\u6587\u672c\u914d\u7f6e\u65f6\u51fa\u9519",
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return y}function g(p){var y,u,r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(!p||1>p)return t.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});y=b.getSearchRealPageIndex(p);if(0>=y||-1===y||b._positionScriptLoaded[y])return t.return(!1);if(u=b._positionScriptLoadPromises[y])return t.return(u);
r=function(){var v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),v=String.format(bookConfig.searchPositionJS,y),1<y&&(v=v.replace("[1]","["+y+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,v.match(z)||v.match(A)?D.yield(getArticleImage(fixURLValue(v)),5):D.return(!1);case 5:return(v=D.yieldResult)?D.yield(h(p,v,y),6):D.return(!1);case 6:return b._positionScriptLoaded[y]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[y];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[y]=r;return t.return(r)})}function h(p,y,u){var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){r=function(){var v,z,A,F,D,M,K;return $jscomp.asyncExecutePromiseGeneratorProgram(function(H){switch(H.nextAddress){case 1:k=p;l=u;if(v="undefined"!==
typeof location&&"file:"===location.protocol){H.jumpTo(2);break}H.setCatchFinallyBlocks(3);return H.yield(fetch(y),5);case 5:z=H.yieldResult;if(!z.ok){console.warn("fetch returned non-ok",z.status,y);H.jumpTo(6);break}return H.yield(z.text(),7);case 7:return A=H.yieldResult,F=A.match(/positionForPages\[(\d+)\]/),D=A,F&&(D=D.replace(new RegExp("positionForPages\\["+F[1]+"\\]","g"),"positionForPages["+(p-1)+"]")),D=D.replace(/("page"\s*:\s*)"?\d+"?/g,"$1"+p),(new Function(D))(),l=k=null,H.return();
case 6:H.leaveTryBlock(2);break;case 3:M=H.enterCatchBlock(),console.warn("fetch failed, fallback to script tag (likely file://). Error:",M&&M.message);case 2:return K="undefined"!==typeof window?window:"undefined"!==typeof b?b:null,K?H.yield(new Promise(function(I,O){var J=K.document.createElement("script");J.dataset.positionSource=y;J.onload=function(){setTimeout(function(){l=k=null;I()},0)};J.onerror=function(N){l=k=null;console.log("Script load failed:",y,N);O(Error("Script load failed: "+y))};
J.src=y;K.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),H.return())}})};m=m.then(function(){return r()}).catch(function(v){console.log("queue error:",v&&v.message)});return t.return(m)})}"undefined"!==typeof b&&null==b.pageTextPositions&&(b.pageTextPositions=[]);var k=null,l=null,m=Promise.resolve(),q=new Proxy({},{get:function(p,y){var u=c();return"string"===typeof y&&/^\d+$/.test(y)?u[Number(y)]:"length"===y?u.length:"function"===typeof Array.prototype[y]?
Array.prototype[y].bind(u):p[y]},set:function(p,y,u){return"string"===typeof y&&/^\d+$/.test(y)?(p=Number(y),null!=k?d(k-1,u):d(p,u),!0):!1},has:function(p,y){var u=c();return"string"===typeof y&&/^\d+$/.test(y)?Number(y)in u:y in p},ownKeys:function(){var p=c();return Object.keys(p).concat(Object.getOwnPropertyNames(Object.prototype))},getOwnPropertyDescriptor:function(p,y){var u=c();return"string"===typeof y&&/^\d+$/.test(y)?{configurable:!0,enumerable:!0,value:u[Number(y)],writable:!0}:Object.getOwnPropertyDescriptor(p,
y)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(p){var y,u,r,t,v,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||
(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),y=Array.isArray(p)?p:[p],u=[],r=!1,t=0;case 2:if(!(t<y.length)){D.jumpTo(4);break}v=y[t];if(!v||1>v){D.jumpTo(3);break}z={pageIndex:v,hasText:!1,positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(v),7);case 7:b._pageReaderExtracted[v]||f(v);(A=c()[v-1])&&A.page===v&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,
r=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+v+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:u.push(z);case 3:t++;D.jumpTo(2);break;case 4:return D.return({hasText:r,pageResults:u})}})};b.hasPageText=function(p){b.pageTextPositions||(b.pageTextPositions=[]);var y=!Array.isArray(p),u=[],r=!1;p=$jscomp.makeIterator(y?[p]:p);for(var t=p.next();!t.done;t=p.next())if(t=t.value,!t||1>t)y||u.push({pageIndex:t,hasText:!1,
positionCount:0});else{var v={pageIndex:t,hasText:!1,positionCount:0},z=t-1;(z=c()[z])&&z.page===t&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(v.hasText=!0,v.positionCount=z.positions.length,r=!0);if(y)return v.hasText;u.push(v)}return{hasText:r,pageResults:u}};b.loadPagePositionScript=g;b.loadAndFixPositionScript=h;b.clearPageTextPositions=function(){b.pageTextPositions&&(b.pageTextPositions.length=0);b._positionScriptLoaded&&(b._positionScriptLoaded={});b._positionScriptLoadPromises&&
(b._positionScriptLoadPromises={});b._pageReaderExtracted&&(b._pageReaderExtracted={})}})("undefined"!==typeof window?window:"undefined"!==typeof global?global:this);
...
("undefined"!==typeof c?c:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""},m,q,p,y,u;if((null==(m=window.tmpBookConfig)?0:null==(q=m.power_info)?0:q.power)||(null==(p=window.bookConfig)?0:null==(y=p.power_info)?0:y.power)||(null==(u=window.userInfo)?0:u.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(k());window.eventEmitter.on("loadUserInfo",function(r){return l(k())})}
checkReportConfig=function(){changeBookConfigValue("EnableReportButton",getConfigValue("EnableReportButton",!1))};
var tmpBookConfig={},checkBookConfig=function(){var b,c,d,e,f,g,h,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){switch(l.nextAddress){case 1:l.setCatchFinallyBlocks(2);if(!window.ensureUserInfoReady){l.jumpTo(4);break}return l.yield(window.ensureUserInfoReady(2E3),4);case 4:l.leaveTryBlock(3);break;case 2:l.enterCatchBlock();case 3:b=htmlConfig.bookConfig;c=allocateUTF8(b);window.key_index=Module._DeConfig_Parse(c);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.power_info=
getConfigValue("power_info","");tmpBookConfig.power_info&&"string"===typeof tmpBookConfig.power_info&&(tmpBookConfig.power_info=JSON.parse(tmpBookConfig.power_info));tmpBookConfig.isAnnotationCustomIconEnabled=getConfigValue("isAnnotationCustomIconEnabled",!1);tmpBookConfig.annotationStickerButtonIcon=getConfigValue("annotationStickerButtonIcon","");tmpBookConfig.annotationAddTextButtonIcon=getConfigValue("annotationAddTextButtonIcon","");tmpBookConfig.annotationSelectTextButtonIcon=getConfigValue("annotationSelectTextButtonIcon",
"");tmpBookConfig.annotationBrushButtonIcon=getConfigValue("annotationBrushButtonIcon","");tmpBookConfig.annotationHighlighterButtonIcon=getConfigValue("annotationHighlighterButtonIcon","");tmpBookConfig.annotationRectangleButtonIcon=getConfigValue("annotationRectangleButtonIcon","");tmpBookConfig.annotationEllipseButtonIcon=getConfigValue("annotationEllipseButtonIcon","");tmpBookConfig.annotationEraserButtonIcon=getConfigValue("annotationEraserButtonIcon","");tmpBookConfig.annotationClearButtonIcon=
getConfigValue("annotationClearButtonIcon","");tmpBookConfig.annotationUndoButtonIcon=getConfigValue("annotationUndoButtonIcon","");tmpBookConfig.annotationRedoButtonIcon=getConfigValue("annotationRedoButtonIcon","");tmpBookConfig.annotationSaveButtonIcon=getConfigValue("annotationSaveButtonIcon","");tmpBookConfig.annotationExitButtonIcon=getConfigValue("annotationExitButtonIcon","");tmpBookConfig.isShowBottomFullscreenPrompts=getConfigValue("isShowBottomFullscreenPrompts",!0);tmpBookConfig.isMobileFirstLastShortcutVisible=
getConfigValue("isMobileFirstLastShortcutVisible",void 0);void 0!==tmpBookConfig.isMobileFirstLastShortcutVisible&&(tmpBookConfig.isMobileFirstLastShortcutVisible=parseBool(tmpBookConfig.isMobileFirstLastShortcutVisible));tmpBookConfig.isMobilePageBackButtonVisible=getConfigValue("isMobilePageBackButtonVisible",!1);tmpBookConfig.enableDomainAccess=getConfigValue("enableDomainAccess",!0);tmpBookConfig.domainAccess=getConfigValue("domainAccess","").toLowerCase();tmpBookConfig.isSearchFormNailUpEnabled=
getConfigValue("isSearchFormNailUpEnabled","Chinese"==UserGroups?!1:!0);tmpBookConfig.showWatermark=getConfigValue("showWatermark",!1);tmpBookConfig.printWatermark=getConfigValue("printWatermark",!0);tmpBookConfig.watermarkRotation=getConfigValue("watermarkRotation",0);tmpBookConfig.watermarkSpacing=getConfigValue("watermarkSpacing",20);tmpBookConfig.watermarkOpacity=getConfigValue("watermarkOpacity",.4);tmpBookConfig.watermarkPosition=getConfigValue("watermarkPosition","Center").toLowerCase();tmpBookConfig.watermarkWidth=
getConfigValue("watermarkWidth",100);tmpBookConfig.watermarkHeight=getConfigValue("watermarkHeight",0);tmpBookConfig.watermarkEdgeMargin=getConfigValue("watermarkEdgeMargin",12);tmpBookConfig.flipShortcutButtonColor=getConfigValue("flipShortcutButtonColor","");tmpBookConfig.flipShortcutButtonHoverColor=getConfigValue("flipShortcutButtonHoverColor","");tmpBookConfig.flipShortcutButtonBackgroundColor=getConfigValue("flipShortcutButtonBackgroundColor","");tmpBookConfig.flipShortcutButtonHoverBackgroundColor=
getConfigValue("flipShortcutButtonHoverBackgroundColor","");tmpBookConfig.printOptions=getConfigValue("printOptions","all,current,range").toLowerCase();tmpBookConfig.isBookDomainAccessEnabled=getConfigValue("isBookDomainAccessEnabled",!0);tmpBookConfig.isZoomControlBarVisible=getConfigValue("isZoomControlBarVisible",!0);tmpBookConfig.autoFlipPageOnTimelineEnd=getConfigValue("autoFlipPageOnTimelineEnd",!1);tmpBookConfig.homeButtonOpenWindowType=getConfigValue("homeButtonOpenWindowType","Chinese"==
UserGroups?"_self":"_blank").toLowerCase();tmpBookConfig.homeButtonOpenWindowType.startsWith("_")||(tmpBookConfig.homeButtonOpenWindowType="_"+tmpBookConfig.homeButtonOpenWindowType);tmpBookConfig.isFirstLastShortcutVisible=getConfigValue("isFirstLastShortcutVisible",void 0);void 0!==tmpBookConfig.isFirstLastShortcutVisible&&(tmpBookConfig.isFirstLastShortcutVisible=parseBool(tmpBookConfig.isFirstLastShortcutVisible));tmpBookConfig.miniFullscreenDisplayType=getConfigValue("miniFullscreenDisplayType",
"always").toLowerCase();tmpBookConfig.isFakeStopBook=getConfigValue("isFakeStopBook",0);tmpBookConfig.isTabelOfContentSearchBarVisible=getConfigValue("isTabelOfContentSearchBarVisible",!0);tmpBookConfig.mouseDragFlip=getConfigValue("mouseDragFlip",!0);tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",48);tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon","");tmpBookConfig.isAccessibilityButtonVisible=
getConfigValue("isAccessibilityButtonVisible",!1);tmpBookConfig.ClientBookId=getConfigValue("ClientBookId","");tmpBookConfig.CreatedTime=getConfigValue("CreatedTime","");window.editConfig&&window.editConfig.CreatedTime&&(tmpBookConfig.CreatedTime=window.editConfig.CreatedTime);tmpBookConfig.CreatedVersion=getConfigValue("CreatedVersion","");tmpBookConfig.productName=getConfigValue("productName","");tmpBookConfig.productVersion=getConfigValue("productVersion","");tmpBookConfig.PDFBASE_VERSION_MAC=
...
"#E3E3E3");tmpBookConfig.bgMRotation=getConfigValue("bgMRotation",90);tmpBookConfig.backGroundImgURL=getConfigValue("backGroundImgURL","");tmpBookConfig.backgroundOpacity=getConfigValue("backgroundOpacity",100);tmpBookConfig.LeftShadowWidth=getConfigValue("LeftShadowWidth",100);tmpBookConfig.LeftShadowAlpha=getConfigValue("LeftShadowAlpha",1);tmpBookConfig.RightShadowWidth=getConfigValue("RightShadowWidth",40);tmpBookConfig.RightShadowAlpha=getConfigValue("RightShadowAlpha",1);_agent_.system.name==
...
tmpBookConfig.isTheBookOpen=getConfigValue("isTheBookOpen",!1);tmpBookConfig.FlipDirection=getConfigValue("FlipDirection",0);tmpBookConfig.FlipDirectiononMobile=getConfigValue("FlipDirectiononMobile",void 0);void 0!==tmpBookConfig.FlipDirectiononMobile&&(e=Number(tmpBookConfig.FlipDirectiononMobile),tmpBookConfig.FlipDirectiononMobile=0===e||1===e?e:void 0);(isPhone()||isPad())&&void 0!==tmpBookConfig.FlipDirectiononMobile&&(tmpBookConfig.FlipDirection=tmpBookConfig.FlipDirectiononMobile);tmpBookConfig.continuousPageArrangement=
getConfigValue("continuousPageArrangement",!0);tmpBookConfig.startingFromTheSide=getConfigValue("startingFromTheSide",!1);tmpBookConfig.automaticAdsorption=getConfigValue("automaticAdsorption",!0);tmpBookConfig.phoneFlipShortcutSwitchButtonIcon=getConfigValue("phoneFlipShortcutSwitchButtonIcon","");tmpBookConfig.HomeButtonIcon=getConfigValue("HomeButtonIcon","");tmpBookConfig.AnnotationButtonIcon=getConfigValue("AnnotationButtonIcon","");tmpBookConfig.VideoButtonIcon=getConfigValue("VideoButtonIcon",
...
"None");tmpBookConfig.bgSoundVol=getConfigValue("bgSoundVol",50);tmpBookConfig.bgSoundVol=Number.between(tmpBookConfig.bgSoundVol,0,100);tmpBookConfig.enablePageBack=getConfigValue("enablePageBack",!1);if(isPhone()||isPad())tmpBookConfig.enablePageBack=tmpBookConfig.isMobilePageBackButtonVisible;tmpBookConfig.userListPath=getConfigValue("userListPath","files/extfiles/users.js");tmpBookConfig.excludeFrontPages=getConfigValue("excludeFrontPages","");tmpBookConfig.isFlipPdf=getConfigValue("isFlipPdf",
!1);tmpBookConfig.SingleModeBanFlipToLastPage=getConfigValue("SingleModeBanFlipToLastPage",!1);tmpBookConfig.isSingleBookFullWindowOnMobile=getConfigValue("isSingleBookFullWindowOnMobile",!1);tmpBookConfig.showGotoButtonsAtFirst=getConfigValue("showGotoButtonsAtFirst",!1);0==tmpBookConfig.isFlipPdf&&void 0!=global.isFlipPdf&&(tmpBookConfig.isFlipPdf=isFlipPdf);tmpBookConfig.FlipSound=getConfigValue("FlipSound",!0);global.flipSoundIsPlaying=tmpBookConfig.FlipSound;tmpBookConfig.CurlingPageCorner=getConfigValue("CurlingPageCorner",
!0);tmpBookConfig.BanFlipFromDirection=getConfigValue("BanFlipFromDirection",!1);tmpBookConfig.iconFontColor=getConfigValue("iconFontColor","#ffffff");tmpBookConfig.updateURLForPage=getConfigValue("updateURLForPage",!0);tmpBookConfig.borderColor=getConfigValue("borderColor","#572f0d");tmpBookConfig.outerCoverBorder=getConfigValue("outerCoverBorder",!1);tmpBookConfig.hardCoverBorderWidth=getConfigValue("hardCoverBorderWidth",0);tmpBookConfig.cornerRound=getConfigValue("cornerRound",0);tmpBookConfig.hardCoverBorderWidth=
tmpBookConfig.HardPageEnable?Number.between(0,16,tmpBookConfig.hardCoverBorderWidth):0;tmpBookConfig.cornerRound=tmpBookConfig.HardPageEnable?Number.between(0,tmpBookConfig.hardCoverBorderWidth,tmpBookConfig.cornerRound):0;tmpBookConfig.coverTexture=getConfigValue("coverTexture","none");tmpBookConfig.passwardPrompt=getConfigValue("passwardPrompt","");tmpBookConfig.SlideshowAutoPlay=getConfigValue("SlideshowAutoPlay",!1);tmpBookConfig.SlideshowPlayInterval=getConfigValue("SlideshowPlayInterval",5);
tmpBookConfig.productName=getConfigValue("productName","Flip HTML5");tmpBookConfig.homePage=getConfigValue("homePage","http://www.fliphtml5.com");global.productName=tmpBookConfig.productName||"Flip HTML5";global.homePage=tmpBookConfig.homePage||"http://www.fliphtml5.com";tmpBookConfig.backgroundPosition=getConfigValue("backgroundPosition","Stretch");tmpBookConfig.restorePageVisible=getConfigValue("restorePageVisible",!1);tmpBookConfig.restorePageDuration=getConfigValue("restorePageDuration",86400);
tmpBookConfig.toobarClear=getConfigValue("toobarClear",!1);tmpBookConfig.bottomToolBarAlpha=getConfigValue("bottomToolBarAlpha",1);tmpBookConfig.topToolBarAlpha=getConfigValue("topToolBarAlpha",1);tmpBookConfig.ToolBarAlpha=getConfigValue("ToolBarAlpha",1);tmpBookConfig.phoneSearchBarAlpha=getConfigValue("phoneSearchBarAlpha",.8);!isPhone()&&!isPad()||["slide","docview","card","inverteffect"].includes(tmpBookConfig.FlipStyle.toLowerCase())||(tmpBookConfig.FlipStyle="flip");isBelowIE9()&&(tmpBookConfig.FlipStyle=
"slide");if(isPhone()||isPad()||"slide"==tmpBookConfig.FlipStyle.toLowerCase()&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase())tmpBookConfig.flipshortcutbutton=!1;if("slide"==tmpBookConfig.FlipStyle&&"lite"==tmpBookConfig.ToolbarViewMode.toLowerCase()||isPhone()||isPad())tmpBookConfig.flipshortcutbutton=!1;void 0===tmpBookConfig.isFirstLastShortcutVisible&&(tmpBookConfig.isFirstLastShortcutVisible=!!tmpBookConfig.flipshortcutbutton);if(global.videoList&&1<=global.videoList.length)for(f=0;f<videoList.length;f++)videoList[f].id||
(videoList[f].id=""),videoList[f].description||(videoList[f].description=""),videoList[f].thumbnail||(videoList[f].thumbnail=""),videoList[f].title||(videoList[f].title=""),videoList[f].type||(videoList[f].type="");try{window.localStorage||(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=
!1))}catch(m){tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.restorePageVisible=!1,global.pageEditor&&global.pageEditor.setting&&parseBool(global.pageEditor.setting.shoppingCartHTML)&&(global.pageEditor.setting.shoppingCartHTML=!1)}0<=global.templeteName.indexOf("article")&&(isPhone()||isPad())&&(tmpBookConfig.BookMarkButtonVisible=!1);tmpBookConfig.OpenWindow=(getConfigValue("OpenWindow","_blank")+"").toLowerCase();tmpBookConfig.appLogoOpenWindow=(getConfigValue("appLogoOpenWindow",
"_blank")+"").toLowerCase();tmpBookConfig.OpenWindow.startsWith("_")||(tmpBookConfig.OpenWindow="_"+tmpBookConfig.OpenWindow);tmpBookConfig.appLogoOpenWindow.startsWith("_")||(tmpBookConfig.appLogoOpenWindow="_"+tmpBookConfig.appLogoOpenWindow);tmpBookConfig.appLargeLogoIcon=getConfigValue("appLargeLogoIcon","");tmpBookConfig.appLogoLinkURL=getConfigValue("appLogoLinkURL","");tmpBookConfig.appLogoLinkURL&&(tmpBookConfig.appLogoLinkURL=getRealURL(tmpBookConfig.appLogoLinkURL));tmpBookConfig.appLargeLogoURL=
getConfigValue("appLargeLogoURL","");tmpBookConfig.appLargeLogoURL&&(tmpBookConfig.appLargeLogoURL=getRealURL(tmpBookConfig.appLargeLogoURL));tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.logoFixWidth=getConfigValue("logoFixWidth",0);tmpBookConfig.logoFixHeight=getConfigValue("logoFixHeight",0);tmpBookConfig.PhoneButtonVisible=getConfigValue("PhoneButtonVisible",!1);window.phoneNumber&&0!=phoneNumber.length||(tmpBookConfig.PhoneButtonVisible=!1);tmpBookConfig.PhoneButtonIcon=
getConfigValue("PhoneButtonIcon","");tmpBookConfig.phoneNumber=getConfigValue("phoneNumber","");tmpBookConfig.aboutContactInfoTxt=getConfigValue("aboutContactInfoTxt","");tmpBookConfig.isEncryptionBook=getConfigValue("isEncryptionBook",!1);tmpBookConfig.useTheAliCloudChart=getConfigValue("useTheAliCloudChart",!1);tmpBookConfig.securityType=getConfigValue("securityType",0);tmpBookConfig.singlePasswordKey=getConfigValue("singlePasswordKey","");tmpBookConfig.singlePasswordMD5=getConfigValue("singlePasswordMD5",
"");1<=passwardType()&&(tmpBookConfig.useTheAliCloudChart=!1);tmpBookConfig.isEncryptionBook&&(tmpBookConfig.useTheAliCloudChart=!1);tmpBookConfig.useTheFliphtml5Service=getConfigValue("useTheFliphtml5Service",!1);if("online.fliphtml5.com"==document.domain||0<=tmpBookConfig.bookResourceBaseURL.indexOf("online.fliphtml5.com"))tmpBookConfig.useTheAliCloudChart=!1,tmpBookConfig.useTheFliphtml5Service=!0;tmpBookConfig.isEncryptionBook&&(tmpBookConfig.useTheFliphtml5Service=!1);tmpBookConfig.OnlyOpenInWechat=
getConfigValue("OnlyOpenInWechat",!1);tmpBookConfig.NoWechatSharing=getConfigValue("NoWechatSharing",!1);tmpBookConfig.WeChatShareButtonIcon=getConfigValue("WeChatShareButtonIcon","");tmpBookConfig.isShowAssistantPerson=getConfigValue("isShowAssistantPerson",!0);tmpBookConfig.OnlyOpenInIframe=getConfigValue("OnlyOpenInIframe",!1);tmpBookConfig.OnlyOpenInIframeInfo=getConfigValue("OnlyOpenInIframeInfo","Only open in iframe.");tmpBookConfig.NoWechatSharing&&jQuery(document).ready(function(){window.setTimeout(function(){function m(){WeixinJSBridge.call("hideOptionMenu")}
global.wx&&wx.hideOptionMenu();"undefined"==typeof WeixinJSBridge?document.addEventListener?document.addEventListener("WeixinJSBridgeReady",m,!1):document.attachEvent&&(document.attachEvent("WeixinJSBridgeReady",m),document.attachEvent("onWeixinJSBridgeReady",m)):m()},10)});tmpBookConfig.textClarityEnhancement=getConfigValue("textClarityEnhancement",0);tmpBookConfig.textSharpening=getConfigValue("textSharpening",!0);if(_agent_.browser.firefox||_agent_.browser.opera||_agent_.browser.safari)tmpBookConfig.textSharpening=
...
getConfigValue("isMouseEnterToDisplayArticleTitle",!1);tmpBookConfig.delayToFlipFirst=getConfigValue("delayToFlipFirst",!1);tmpBookConfig.timeToFlipFirst=getConfigValue("timeToFlipFirst",10);tmpBookConfig.printBackgroundPosition=getConfigValue("printBackgroundPosition","fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(f=0;f<window.ignoreModuleArray.bookConfig.length;f++)g=window.ignoreModuleArray.bookConfig[f],void 0!=tmpBookConfig[g]&&(tmpBookConfig[g]=!1)}catch(m){}checkFlipStyleConfig();
return"issuu"==tmpBookConfig.FlipStyle?l.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),7):l.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:checkPageEditorConfig(),recordError(),h=Module._getVerifyString(),k=UTF8ToString(h),Module._free(h),eval(k),l.jumpToEnd()}})};
...
function setBookVerticalMargin(b){b=void 0===b?{}:b;try{var c=function(){try{if(!window.localStorage)return!1;var t=window.location.href.replace(window.location.hash,"").replace(window.location.search,"")+"BookMark";if(!window.localStorage[t])return!1;var v=window.localStorage.getItem(t),z=Instance.parse(v,[]);return Array.isArray(z)&&0<z.length}catch(A){return!1}},d=global.staticAd&&global.staticAd.haveAd&&"Chinese"!=UserGroups&&global.staticAd.adPosition?!0:!1,e=global.staticAd.height||90,f=tmpBookConfig.ORIGIN_TOP_MARGIN,
g,h=null!=(g=b.bookmarkHeight)?g:70,k,l,m,q=!(null==(k=global.bmtConfig)?0:k.onSideEdge)&&0<((null==(l=global.bmtConfig)?void 0:null==(m=l.tabs)?void 0:m.length)||0),p,y=!(null==(p=global.bmtConfig)?0:p.onSideEdge)&&c();(q||y)&&f<h&&(f=h);if(d&&2==global.staticAd.adPosition)if(f<e+20)f+=e+20;else{var u=BookInfo.top()-templateArea.getTopHeight();f=Math.max(f,u)}tmpBookConfig.topMargin=f;var r=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;d&&1==global.staticAd.adPosition&&r<e+20&&(r+=e+20);tmpBookConfig.bottomMargin=
r;b.disableResize||"function"!=typeof global.onStageResize||onStageResize()}catch(t){console.log("setBookVerticalMargin error",t)}}
...
!b)return b;var c=function(e){return"string"!=typeof e||0<=e.indexOf(tmpBookConfig.CreatedTime)?e:e=0<=e.indexOf("?")?e+"&"+tmpBookConfig.CreatedTime:e+"?"+tmpBookConfig.CreatedTime};if("string"!=typeof b)for(var d=0;d<b.length;d++)b[d]=c(b[d]),b[d]=changeBookResourceBaseURL(b[d]);else b=c(b),b=changeBookResourceBaseURL(b);return b},decodeAboutInfo=function(){if(tmpBookConfig.aboutContactInfoTxt){try{var b=$(tmpBookConfig.aboutContactInfoTxt)}catch(q){return}var c,d,e,f,g;b.find("title").text();var h=
b.find("desc").text();var k=b.find("logo").text();b=b.find("keys").children();for(var l=0;l<b.length;l++){var m=$(b[l]);"Phone"==m.attr("type")&&(c=m.text());"Link"==m.attr("type")&&(d=m.text());"Email"==m.attr("type")&&(e=m.text());"Address"==m.attr("type")&&(f=m.text());"Author"==m.attr("type")&&(g=m.text())}b=function(q){return String.parseUtf8(base64.decode(q))};f&&!tmpBookConfig.AboutAddress&&(tmpBookConfig.AboutAddress=b(f));e&&!tmpBookConfig.AboutEmail&&(tmpBookConfig.AboutEmail=b(e));c&&!tmpBookConfig.AboutMobile&&
...
function checkFliphtml5PagesConfig(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:b=window.htmlConfig.fliphtml5_pages;if("string"!==typeof b){window.fliphtml5_pages=b;k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(new Promise(function(l,m){setTimeout(function(){try{var q=allocateUTF8(b),p=Module._DeString(q),y=UTF8ToString(p);Module._FreeMemory(p);if(y&&"undefined"!==y){p=y;var u=p.lastIndexOf("]");0<u&&(p=p.substring(0,
u+1));try{window.fliphtml5_pages=JSON.parse(p)}catch(r){console.log("JSON parse error:",r);try{window.fliphtml5_pages=eval(p)}catch(t){console.log("Failed to parse decrypted fliphtml5_pages:",t),window.fliphtml5_pages=[]}}}else console.log("pages_value is empty or undefined"),window.fliphtml5_pages=[];Module._free(q);l()}catch(r){console.error("Failed to decrypt fliphtml5_pages:",r),window.fliphtml5_pages=[],m(r)}},0)}),5);case 5:k.leaveTryBlock(2);break;case 3:c=k.enterCatchBlock(),console.error("Failed to decrypt fliphtml5_pages:",
...
return f.yield(loadComponentsJavascript(e),5);case 5:return f.return();case 3:c++,f.jumpTo(2)}})},checkExpandComponentConfig=function(){var b,c,d,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:b=["table of contents"==tmpBookConfig.leftRightPnlShowOption,"table of contents"==tmpBookConfig.mobileLeftRightPnlShowOption],c=0;case 2:if(!(c<b.length)){g.jumpTo(0);break}d=b[c];if(!d){g.jumpTo(3);break}e=tmpBookConfig.UIBaseURL+"javascript/component.min.js";
return g.yield(loadComponentsJavascript(e),5);case 5:return f=tmpBookConfig.UIBaseURL+"javascript/colorPanel.min.js",g.yield(loadComponentsJavascript(f),6);case 6:return global.colorPanel||"undefined"===typeof JSColorPanel||(global.colorPanel=new JSColorPanel(tmpContainer)),g.return();case 3:c++,g.jumpTo(2)}})};
function animateOnce(b,c,d,e,f,g){if(b&&c)if(void 0==d||0===d||isIE9())b.css(c),e&&e instanceof Function&&e();else{var h=!1;setAnimation(b,d,f,g);b.one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",function(){1!=h&&(h=!0,setAnimation(b,0),e&&e instanceof Function&&e())});b.css(c)}}
...
(function(){function b(l){l+="=";for(var m=decodeURIComponent(document.cookie).split(";"),q=0;q<m.length;q++){var p=m[q].trim();if(0===p.indexOf(l))return JSON.parse(p.substring(l.length))}return null}function c(l,m){try{if("Chinese"!=UserGroups&&-1>=window.location.hostname.indexOf("fliphtml5.com")){console.log("not chinese and not fliphtml5.com","setCookie");return}}catch(p){}var q=new Date;q.setTime(q.getTime()+31536E8);document.cookie=l+"="+m+";expires="+q.toUTCString()+(";domain="+("Chinese"==
UserGroups?".yunzhan365.com":".fliphtml5.com")+";path=/")}function d(){for(var l={},m=window.location.search.substring(1).split("&"),q=0;q<m.length;q++){var p=m[q].split("="),y=decodeURIComponent(p[0]);p=p[1]?decodeURIComponent(p[1]):null;l[y]=p}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var m=16*Math.random()|0;return("x"===l?m:m&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026041701",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
this.initLogo(),bookConfig.ToolBarVisible&&this.initFullscreenButton(),this.initZoomButton(),this.initFlipShotButton(),this.initSlider(),this.initPageNumber())},initFullscreenButton:function(){var b=this;this.button=$("<div><img alt='' title='"+getLanguage("viewFullScreen","\u93cc\u30e7\u6e45\u934f\u3125\u7746")+"' style='pointer-events: none;' src='"+uiBaseURL+"NeatFullscreen.svg'/></div>");this.button.css({position:"absolute",bottom:"0px",left:"auto",top:"auto",cursor:"pointer","z-index":"100",
width:"42px",height:"42px",right:"9px"});this.button.find("img").css({position:"absolute",left:"12px",top:"12px",width:"18px",height:"18px"});this.button.on(_event._down,function(c){return c.stopPropagation()});this.button.on("click",function(){b.isNeat()&&(isPhone()||isPad()?(window.parent.postMessage({command:"full"},"*"),b.full=!0):readAsFullscreen())});tmpContainer.append(this.button)},initZoomButton:function(){this.zoomButton=new NeatZoomButton;this.zoomButton.addTo(tmpContainer)},initLogo:function(){if(this.isShowLogo&&
bookConfig.appLogoIcon&&""!=bookConfig.appLogoIcon){this.logo=$("<img alt='' id='neatLogo' src='"+bookConfig.appLogoIcon+"'/>");this.logo.css({position:"absolute",left:bookConfig.logoPadding+"px",top:bookConfig.logoTop+"px",height:bookConfig.logoHeight+"px",cursor:"pointer","z-index":"3","-webkit-filter":"drop-shadow(0 0 2px #000)",filter:"drop-shadow(0 0 2px #000)"});if(bookConfig.appLogoLinkURL)this.logo.on("click",function(){BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"logoImage",
"logo"]);var b=getAppLogoLinkURL();window.open(b,bookConfig.appLogoOpenWindow);return!1});tmpContainer.append(this.logo)}},hideLogo:function(){this.logo&&(this.logo.hide(),this.isShowLogo=!1)},exitFullscreen:function(){this.full=!1},initFlipShotButton:function(){this.pagePrevButton=$("<div class='btn' style='display:none;'><div class='svg-box'></div><img alt='' class='unSelect' src='"+uiBaseURL+"previousPage.svg' style='width:40px;height:40px;margin:0px;pointer-events: none;'/></div>");this.pageNextButton=
$("<div class='btn' style='display:none;'><div class='svg-box'></div><img alt='' class='unSelect' src='"+uiBaseURL+"nextPage.svg' style='width:40px;height:40px;margin:0px;pointer-events: none;'/></div>");this.pagePrevButton.css({position:"absolute",width:"40px",height:"40px",top:"50%",left:"0","z-index":"11",transform:"translate(0%,-50%)",cursor:"pointer"});this.pageNextButton.css({position:"absolute",width:"40px",height:"40px",top:"50%",right:"0","z-index":"11",transform:"translate(0%,-50%)",cursor:"pointer"});
this.pagePrevButton.on(_event._end,function(){rightToLeft?nextPageFun("phone goto button"):previousPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"prev",getLanguage("btnPrePage","Previous")]);return!1});this.pageNextButton.on(_event._end,function(){rightToLeft?previousPageFun("phone goto button"):nextPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"next",getLanguage("btnNextPage","Next")]);return!1});tmpContainer.append(this.pagePrevButton);
tmpContainer.append(this.pageNextButton)},initPageNumber:function(){this.inputButton=$("<div class='inputButton' \n\t\t\tstyle='display:inline-block;text-shadow:0 0 2px #000;max-width:110px;line-height:42px;color:#fff;text-align:center;'>\n\t\t\t<input value='/' \n\t\t\tstyle='line-height:42px;height:42px;color:#fff;text-align:center;width:100%;background:none;border:none;padding:0;margin:0;text-shadow:0 0 2px #000;font-size:16px;' class='currentPageIndexTextField' type='text'/>\n\t\t\t</div>");this.menu.append(this.inputButton)},
initSlider:function(){var b=isPhone()||isPad()?180:220;this.slider=new Slider({parent:this.menu,width:windowWidth-b,height:6,pointerWidth:10,totalPercent:bookConfig.totalPageCount})},refreshSlider:function(){try{var b=BookInfo.getCurrentPageIndex();this.slider.refreshSlider(b);this.inputButton.find("input").val(getShownPageNumberInfo(b))}catch(c){}},initEvent:function(){},hide:function(){try{this.visible&&(this.visible=!1,this.logo&&this.logo.hide(),this.button&&this.button.hide(),this.zoomButton&&
this.zoomButton.$button.hide(),this.pagePrevButton&&this.pagePrevButton.hide(),this.pageNextButton&&this.pageNextButton.hide(),this.menu&&this.menu.hide())}catch(b){}},show:function(){try{this.visible||(this.visible=!0,this.logo&&this.logo.show(),this.button&&this.button.show(),this.zoomButton&&this.zoomButton.$button.show(),this.pagePrevButton&&this.pagePrevButton.show(),this.pageNextButton&&this.pageNextButton.show(),this.menu&&this.menu.show())}catch(b){}},destroy:function(){try{this.logo.remove(),
...
b;this.isReady=!1;this.backgroundColor||(this.backgroundColor="#1F2232")},chooseBookStyle:function(){if("article4"==global.templeteName)this.isReady=!0;else{var b=this.getBookTye();"normal_book"==b?this.init():this.initBookStyle(b)}},initBookStyle:function(b){switch(b){case "documentView_book":this.setBookTye(BookType.singleDocumentView_book);initBookFrame();break;case "slide_book":bookConfig.FlipDirection?windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?
this.setBookTye(BookType.slide_book):this.setBookTye(BookType.singleSlide_book):windowWidth>windowHeight&&"auto"==bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?this.setBookTye(BookType.slide_book):this.setBookTye(BookType.singleSlide_book);initBookFrame();break;case "flip_book":bookType=bookConfig.FlipDirection?windowWidth<windowHeight&&"auto"==bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?BookType.normal_book:BookType.single_book:windowWidth>windowHeight&&"auto"==
bookConfig.showDoublePage||"double"==bookConfig.showDoublePage?BookType.normal_book:BookType.single_book;initBookFrame();break;case "catalog_book":bookType=BookType.catalog_book;initBookFrame();break;case "card_book":bookType=BookType.card_book;this.setBookTye(bookType);initBookFrame();break;case "invert_book":bookType=BookType.invert_book,this.setBookTye(bookType),initBookFrame()}},getBookTye:function(){var b="normal_book";if("slide"==bookConfig.FlipStyle.toLowerCase()||isBelowIE9())b="slide_book";
"flip"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="flip_book");"issuu"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="flip_book");""!=bookConfig.FlipStyle||isBelowIE9()||(b="flip_book");"catalog"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="catalog_book");"docview"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="documentView_book");"card"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||(b="card_book");"inverteffect"!=bookConfig.FlipStyle.toLowerCase()||isBelowIE9()||
(b="invert_book");return b},setBookTye:function(b){window.bookType=b},init:function(){this.container=$("<div class='book_style_choose_container'></div>");this.bookStyleBox=$("<div class='book_style_box'></div>");this.container.css({"background-color":this.backgroundColor});this.parent.append(this.container);this.container.append(this.bookStyleBox);this.initBookStyleBox()},initBookStyleBox:function(){this.title=$("<p class='title'></p>");this.description=$("<p class='description'></p>");this.bookModelBox=
$("<div class='book_style_model_box'></div>");this.flipModel=$("<div class='flipModel book_style_model_item'></div>");this.slideModel=$("<div class='slideModel book_style_model_item'></div>");var b=$("<img alt='' class='book_style_model_img'  src='"+uiBaseURL+"pc.png'/>"),c=$("<img alt='' class='book_style_model_img' src='"+uiBaseURL+"tablet.png'/>"),d=$("<span class='book_style_model_title' >For PC</span>"),e=$("<span class='book_style_model_title'>For Tablet</span>"),f=$("<span class='book_style_model_description' >"+
getLanguage("lblSimulatePageFlip","Chinese"==UserGroups?"\u6d60\u8de8\u6e61\u7f08\u5a5a\u3009":"Simulate page-flipping on a computer")+"</span>"),g=$("<span class='book_style_model_description' >"+getLanguage("lblSimulatePageSlide","Chinese"==UserGroups?"\u7f01\u5fd3\u5400\u5a4a\u6226\u3009":"Tailor to the sliding habits on a tablet")+"</span>");this.flipModel.append(b);this.slideModel.append(c);this.flipModel.append(d);this.slideModel.append(e);this.flipModel.append(f);this.slideModel.append(g);
this.bookStyleBox.append(this.title);this.bookStyleBox.append(this.description);this.bookModelBox.append(this.flipModel);this.bookModelBox.append(this.slideModel);this.bookStyleBox.append(this.bookModelBox);this.title.html(window.document.title);this.description.html(getLanguage("lblSelectMode","Chinese"==UserGroups?"\u7487\u70fd\u20ac\u590b\u5ae8\u93c4\u5267\u305a\u93c2\u7470\u7d21":"Select View Mode Please.")+"(10)");this.initEvent()},initEvent:function(){this.flipModel.bind(_event._end,function(){window.clearInterval(this.inteval);
...
this.destroy(),this.initBookStyle("flip_book"))}.bind(this),1E3)},onResize:function(){},destroy:function(){this.container&&(this.container.hide(),this.container.remove(),this.slideModel=this.flipModel=this.bookStyleBox=this.container=void 0)}});bdor[22]="l";bdor[5]="a";bdor.y="y";
...
uiBaseURL+b+".png"}}}),FormManager={stack:[],zIndexBase:2E3,lastActiveElement:null,register:function(b){this.unregister(b);this.stack.push(b);this.updateZIndex();this.lastActiveElement=global.activeButton;window.dispatchEvent&&window.dispatchEvent(new CustomEvent("form:show",{detail:b}))},unregister:function(b){var c=this.stack.indexOf(b);-1<c&&this.stack.splice(c,1);this.updateZIndex();isPhone()||isPad()||!this.lastActiveElement||"function"!==typeof this.lastActiveElement.focus||(this.lastActiveElement.focus(),
this.lastActiveElement=null);window.dispatchEvent&&window.dispatchEvent(new CustomEvent("form:hide",{detail:b}))},getTop:function(){return this.stack.length?this.stack[this.stack.length-1]:null},updateZIndex:function(){for(var b=0;b<this.stack.length;b++){var c=this.stack[b];if(c.stage){var d=c.stage.parent();d.hasClass("appear_win10")?d.css("z-index",this.zIndexBase+b):c.stage.css("z-index",this.zIndexBase+b)}else"function"===typeof c.setStyle&&c.setStyle({zIndex:this.zIndexBase+b})}},closeTop:function(){var b=
this.getTop();b&&"function"===typeof b.hide&&!1!==b.escClosable&&b.hide()}},FormFrame=Class({parent:void 0,rightToLeft:!1,visible:!1,formType:"",mainColor:"",fontColor:"",mainColorObj:null,fontColorObj:null,elements:null,closeUrl:"",disableDrag:!1,skipFormManagerRegister:!1,create:function(b){this.options=b;this.parent=this.options.parent;this.formType=this.options.formType;this.rightToLeft=this.options.rightToLeft;this.isPhone=this.options.isPhone;this.initColorConfig();wrapFormManagerRegister(this)},
onCreate:function(){},resetFormColor:function(){this.initColorConfig();this.resetIconSrc();this.resetColorChanged();this.visible&&this.changeIconColor();this.initColorCss&&this.initColorCss();this.resetFormItems&&this.resetFormItems()},initColorConfig:function(){this.formOpacity=bookConfig.formBackgroundOpacity?bookConfig.formBackgroundOpacity:bookConfig.ToolBarAlpha;this.mainColor=Color(bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor).toString();this.fontColor=
Color(bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor).toString();this.mainColorObj=Color(this.mainColor);this.fontColorObj=Color(this.fontColor)},resetColorChanged:function(){this.close&&(this.close.find("img")[0]?this.close.find("img")[0].colorChanged=!1:this.close[0].colorChanged=!1);this.favicon&&(this.favicon[0].colorChanged=!1)},resetIconSrc:function(){FormInfo.getFormFavicon(this.formType)&&this.favicon&&this.favicon.attr("src",FormInfo.getFormFavicon(this.formType));
this.close.find("img")[0]?this.close.find("img").attr("src",this.closeUrl):this.close.attr("src",this.closeUrl)},changeIconColor:function(){this.close&&this.close.changeButtonColor(this.fontColor);this.favicon&&this.favicon.changeButtonColor(this.fontColor)},setStyle:function(b){this.stage.css(b)},getShowStatu:function(){return this.visible},showOrHide:function(){this.visible?this.hide():this.show()},show:function(b){void 0===b&&(b=!0);this.visible=!0;this.stage.show();this.onShow(b);this.setA11yAndFocus(b)},
...
this.title&&this.title.find("span").html(FormInfo.getFormTitle(this.formType))},setA11y:function(){this.stage&&this.stage.find(".btn, .button").each(function(){$(this).attr("tabindex",0);$(this).attr("role","button");$(this).off("keydown.a11y").on("keydown.a11y",function(b){"Enter"!==b.key&&" "!==b.key||$(this).trigger("click")})})},setA11yAndFocus:function(b){void 0===b&&(b=!0);this.setA11y();b&&(this.stage.attr("tabindex",-1),$(tmpContainer).attr("tabindex",-1),this.stage.focus())}}),FadeOutFadeForm=
Class({create:function(b){this._super(b);this.closeUrl=window.form_icons&&form_icons.close?"data:image/png;base64,"+form_icons.close:uiBaseURL+"close.png";this.stage=$("<div class='"+FormInfo.getFormCssClassName(this.formType,this.isPhone)+"'></div>");this.title=$("<p class='form_title'></p>");FormInfo.getFormTitle(this.formType)&&this.title.append($("<span>"+FormInfo.getFormTitle(this.formType)+"</span>"));FormInfo.getFormFavicon(this.formType)&&(this.favicon=$("\n        <img alt=\"\" aria-hidden=\"true\" width='auto' height='auto' class='favicon' src='"+
FormInfo.getFormFavicon(this.formType)+"'/>\n      "));this.close=$('\n      <button class="close aria-label-button" aria-label="Close '+FormInfo.getFormTitle(this.formType)+'">\n        <img src="'+this.closeUrl+'" alt="" aria-hidden="true">\n      </button>\n    ');this.rightToLeft&&this.stage.addClass("rightToLeft");this.initHtml();this.initEvent();this.onCreate()},onCreate:function(){var b=this;this.stage.appearance("",function(){b.visible=!1});this.parent.append(this.stage.getDom());this.title&&
this.title.css({cursor:"default"});this.hide()},initEvent:function(){var b=this;this.disableDrag||this.stage.drag();this.stage.on(_event._down,function(c){c.stopPropagation()});this.close.on("click",function(){return b.hide()});this.close.on("mouseenter",function(){return b.close.css({background:"rgba(255,255,255,0.25)"})});this.close.on("mouseleave",function(){return b.close.css({background:""})})},initHtml:virtual_function,onHide:function(){}}).extend(FormFrame),ShowMessage=Class({create:function(b){this._super(b)},
...
this.content.append(this.btnConfirm);this.stage.append(this.content)},initEvent:function(){var b=this;this._super();this.btnCancle.on(_event._click,function(c){c.stopPropagation();b.hide()});this.btnConfirm.on(_event._click,function(c){c.stopPropagation();b.options.callback&&b.options.callback();b.hide()})},destroy:function(){this.stage.getDom().remove()},hide:function(){this._super();window.localStorage.setItem(realLocation+"?historySubmmit",(new Date).getTime())}}).extend(FadeOutFadeForm),showMessage=
function(b,c,d){(new ShowMessage({parent:bookContainer,formType:"message",rightToLeft:rightToLeft,message:b,callback:c})).show(d)};
function getArticleEditor(){function b(t){if(window.isExecuteGetInverseEditor)var v=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(v),t()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),t(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,t)},t,"")}function c(t,v,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",t);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?v&&v(D):"bookinfo"===F&&v?v():z&&z(v))};D.error=function(){z&&z(v)}}function d(t,v){r&&(clearTimeout(r),r=null);if(window.Module.isReady){var z=allocateUTF8(t.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);v();window.runArticleEditor&&delete window.runArticleEditor}else r=setTimeout(function(){d(t,v)},100)}function e(t){(window.articleListConfig=
t)?g(t):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&q(function(t){window.articleConfig=t.response})}function g(t){for(var v=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var D=A&&A.length&&A[F]?A[F].index:F,M=[],K=0;K<t.length;K++)(t[K].articles?t[K].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
H.articleTextList.length){var I=l(H.articleTextList,D);console.log(I,D);H=k(H);for(var O=0;O<I.length;O++){var J=h(H,I[O]);M.push(J)}}}else{I="";if(""===H.activePage||void 0===H.activePage||H.activePage&&(-2===parseFloat(H.activePage)||parseFloat(H.activePage)===D))a:{I=D;O={};H.collapseArea&&(O=JSON.parse(H.collapseArea));if(O[I])I={rect:O[I]};else{if(!H.articleTextList||!H.articleTextList.length){I="";break a}I=m(H.articleTextList,I)}I="[object Object]"===Object.prototype.toString.call(I)?{tannoName:"link1",
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),J=h(H,I),M.push(J))}});v.push(M)}console.log("currentPageEditor",JSON.parse(JSON.stringify(v)));window.inverseEditor=v}function h(t,v){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var z=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:t,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:z.overColor,downColor:z.downColor,outColor:z.outColor,overAlpha:z.overAlpha,downAlpha:z.downAlpha,outAlpha:z.outAlpha,
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:v,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(t){t=JSON.parse(JSON.stringify(t));t.articleTextList.map(function(v){"text"===v.type&&
(v.text=v.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return v});return{articleId:t.articleId,newTime:t.newTime,title:t.title,subTitle:t.subTitle,author:t.author,categoryId:t.categoryId,articleTextList:t.articleTextList}}function l(t,v){var z=[];t.forEach(function(A){-1!==v&&(A.pageIndex===v||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===v}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,v),A.length&&(z=[].concat($jscomp.arrayFromIterable(z),$jscomp.arrayFromIterable(A)))):
z.push(A.rect))});return z}function m(t,v){var z="";t.forEach(function(A){if(-1!==v&&(A.pageIndex===v||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(D){return D.pageIndex===v}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,v):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,v)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function q(t){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,t,p):p(t)}function p(t){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,t,y):y(t)}function y(t){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var v=bookConfig.periodsConfigPath;v=v.replace("%periodicalId%",window.book_visit.periodicalId);c(v,t,u)}else u(t)}
function u(t){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,t):t&&t()}var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){return t.return(new Promise(function(v,z){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?v():window.runArticleEditor||window.inverseEditor?v():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(z=bookConfig.bookBaseURL)?(z.endsWith("/")||(z+="/"),c(z+"bookinfo.js",function(A){A&&A.response&&
(eval(A.response),window.book_visit=book_visit);b(function(){window.runArticleEditor=1;v()})},"","text","bookinfo")):b(function(){window.runArticleEditor=1;v()}):(window.runArticleEditor=1,v(),window.runArticleEditor&&delete window.runArticleEditor))}))})}
...
getWidth:function(){return this.width},getHeight:function(){return this.height},initEvent:function(){this.thickness.on("mouseup touchstart",function(b){b.stopPropagation()}.bind(this));this.thickness.on("click",function(b){0!=this.pageCount&&(b=this.getPageIndexByPosition(b),!b||0>=b||gotoPageFun(b,!1,"thickness"))}.bind(this));isPhone()||isPad()||(this.thickness.on("mousemove",function(b){if(0!=this.pageCount){var c=this.getPageIndexByPosition(b);if(!c||0>=c)this.hint&&this.hint.hide();else{c=" "+
getShownPageNumber(c)+" ";var d=b.pageX;b=b.pageY-30;this.hint||(this.hint=new divHint(c,d,b));this.hint.setText(c);this.hint.show(d,b);this.hint.moveto(d,b)}}}.bind(this)),this.thickness.on("mouseleave",function(){null!=this.hint&&this.hint.hide()}.bind(this)))},doSetMovingScale:function(b,c,d,e,f,g,h){if(!isPhone()&&!isPad()||bookConfig.HardPageEnable||BookInfo.isDoublePage())if(!this.totalWidth||0>=this.totalWidth)this.setScale(1,g,h);else if(f=f?0:Math.min(4/this.totalWidth,1),1==f)this.setScale(1,
...
"px"})},getData:function(){return this.data},setData:function(b){this.data=b;this.update()},update:function(){var b=(bookConfig.tabAlpha?bookConfig.tabAlpha:100)/100;this.$body.css("background-color",Color(this.data.color).rgba(b));this.data.fontColor&&this.$body.css("color",Color(this.data.fontColor).toString());this.$body.html(this.data.caption)},moveTo:function(b){var c=this;this.$parent!=b&&(this.remove(),this.$parent=b,this.$parent.append(this.$body),this.$body.on("click",function(d){return c.onBookmarkClick(d)}),
this.$body.on("mouseenter",function(d){return c.onBookmarkMouseEnter(d)}),this.$body.on("mouseleave",function(d){return c.onBookmarkMouseLeave(d)}),this.$body.on("pointerdown pointermove pointerup pointerenter",function(d){return d.stopPropagation()}),this.$body.on("mousedown mousemove mouseup mouseenter",function(d){return d.stopPropagation()}))},remove:function(){null!=this.$parent&&(this.$body.remove(),this.$body.off(),this.$parent=null)},onBookmarkClick:function(b){gotoPageFun(this.data.pageIndex,
!1,"bookmark tab");BookEvent.trigger("customEvent",["click_bookmark_on_book_to_"+this.data.pageIndex,{click_bookmark_on_book_to:this.data.pageIndex}])},onBookmarkMouseEnter:function(b){this.zIndex=this.$body.css("z-index");this.$body.stop(!0,!0).animate({top:"0px"},300);this.$body.css({"align-items":"center","z-index":999})},onBookmarkMouseLeave:function(b){this.$body.stop(!0,!0).animate({top:"30px"},300);this.$body.css({"align-items":"flex-start","z-index":this.zIndex})},setPosition:function(b){this.$body.css({left:"",
right:"","z-index":""});this.$body.css(b)},getWidth:function(){return this.$body.width()}});
...
Number.between(Math.floor((e-4-f)/(h-1)),10,65);var m=f=0,q=0;for(h=0;h<this.bookmarkList.count();h++)if(k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k),l.$parent==b){var p={};g>=e?(0<q&&(m=l.getWidth()>2*q/3?m+(q/2+10):m+(q-l.getWidth()/2+10)),p[c]=m,q=l.getWidth()):(p[c]=f,f+=l.getWidth()+22);p["z-index"]=d*k.pageIndex;l.setPosition(p)}},show:function(){this.visible=!0;this.refresh()},hide:function(){this.hideLeftBar();this.hideRightBar();this.visible=!1},showLeftBar:function(){0<
...
e=e.concat(f)}return e},postYunzhanUrls:function(b,c,d){var e=this,f=d;"string"==typeof d&&(f=[d]);if(f&&0!=f.length){var g=[];for(d=0;d<f.length;d++){var h=toAbsURL(f[d])+(window.isSupportWebp?"":"?x-oss-process=image/format,jpg");g.push(h)}d=BookRestrict.getRestrictToken();$.ajax({type:"get",url:restrictUrl,dataType:"json",data:{urls:JSON.stringify(g),token:d},success:function(k){if("OK"==k.code){for(var l=!0,m=0;m<f.length;m++){var q=g[m];accessControlImagesPool[f[m]]=k.data[q];k.data[q]||(l=!1)}e.completedTask(b,
...
var globalImages=[],canvasData=[],canvasLoad=function(b,c,d,e,f,g){var h=$("<canvas class='test'></canvas>"),k=function(){return $jscomp.asyncExecutePromiseGeneratorProgram(function(l){e&&e(c,c,h,b);l.jumpToEnd()})};(function(){var l=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){$.ajax({url:c,type:"GET",dataType:"json",success:function(q){canvasData[b]="string"==typeof q?JSON.parse(q):q;globalImages[b]=[];(function(){if(0==canvasData[b].resources.length)k();else for(var p=0,
y=0;y<canvasData[b].resources.length;y++)if(1!=canvasData[b].resources[y].type)p++,p>=canvasData[b].resources.length&&k();else{var u=new Image;u.src=getResource(b,y);u.alt="";globalImages[b][y]=u;u.onload=function(){p++;p>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(y){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(u){bookConfig.largePageWidth/bookConfig.largePageHeight>u[0].naturalWidth/u[0].naturalHeight?u.css({width:"auto",height:"100%"}):u.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)q=c[m],q=q.removeStartFrom("?"),p=$("<img alt='' style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),p.attr("src",q),k.append(p),p[0].onload=function(u){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},p[0].onerror=function(u){h++;h==c.length&&
e&&e(c,c,k,b)};y.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){h=function(p,y){return!p||passwardType()&&bookConfig.excludeFrontPages&&y>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),q.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img alt='' src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},q.return();loadJavascript(c,function(p){var y=dataBase64Str(b,d,p);$("<img alt='' src='"+y+"'/>")[0].onload=function(){e&&e(y,c,this,b)}},
function(){});return q.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(!window.printLoadStack)return q.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(p){var y=p.toDataURL("image/png"),u=$("<img alt='' src='"+y+"'/>");u[0].onload=function(){e&&e(y,y,u,b)}}.bind(h));window.printLoadStack.push(m);return q.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
BookInfo.getBook().status_zoom&&(c=c.removeStartFrom("?"));h=$("<img alt='' src='"+c+"'/>");h[0].onload=function(){var l=$("<object data='"+c+"' type='image/svg+xml'></object>")[0];e&&e(c,c,l,b)};k.jumpToEnd()})},imgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(c=c.removeStartFrom("?"));h=$("<img alt='' src='"+c+"'/>");h[0].onload=function(){e&&e(c,c,this,b)};k.jumpToEnd()})},pageResourceLoad=
function(b,c,d,e,f){var g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return b&&c?k.yield(getPageDir(b,c,originTotalPageCount),2):k.return();g=k.yieldResult;g=normalizeUrl(g);h="img";"normal"==c&&bookConfig.usePdfJs&&(h="canvas");"object"==typeof g?h="object":"string"==typeof g&&(g.match(/^none/)&&(h="none"),-1<g.indexOf(".js")&&(h="js"),-1<g.indexOf(".zip")&&(h="zip"),-1<g.indexOf(".svg")&&(h="svg"));switch(h){case "canvas":canvasLoad(b,g,c,d,e,f);break;case "object":objectLoad(b,
g,c,d,e,f);break;case "none":noneLoad(b,g,c,d,e,f);break;case "js":jsLoad(b,g,c,d,e,f);break;case "zip":zipLoad(b,g,c,d,e,f);break;case "svg":svgLoad(b,g,c,d,e,f);break;case "img":imgLoad(b,g,c,d,e,f)}k.jumpToEnd()})},getFileFormat=function(b,c){var d="";return!passwardType()||!bookConfig.excludeFrontPages||b<=parseInt(bookConfig.excludeFrontPages)?("normal"==c&&(global.fliphtml5_pages&&0<fliphtml5_pages.length&&(b=fliphtml5_pages[b-1])&&b.suffix&&(d=b.suffix),d||(d=bookConfig.normalSuffix?bookConfig.normalSuffix:
...
JsLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,p.yield(getPageDir(b,c,originTotalPageCount),2);k=p.yieldResult;h.imageURL=k;if(!h.fillImageOrNot(k,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),
function(){this.create(b,c,d)}.bind(h),function(){}),p.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img alt='' src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),p.return();q=h;loadJavascript(k,function(y){var u=dataBase64Str(b,c,y);q.$image=$("<img alt='' src='"+
u+"'/>");q.$image[0].onload=function(){d&&d(u,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(q)},function(){});p.jumpToEnd()})},fillImageOrNot:function(b,c){return!b||"string"!=typeof b||passwardType()&&bookConfig.excludeFrontPages&&c>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:!0},zoomIn:function(){(isPhone()||isPad())&&bookConfig.highDefinitionConversion&&this.highDefinition()},
...
k=this.loadAllImage;(function(){var l=this,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return q.yield(getPageDir(b,c,originTotalPageCount),2);m=q.yieldResult;$.ajax({url:m,type:"get",async:!1,success:function(p){canvasData[b]=configForPages.pages[b-1].data;globalImages[b]=[];k(b,h)}.bind(l),error:function(){}});q.jumpToEnd()})})()},loadAllImage:function(b,c){for(var d=0,e=0;e<canvasData[b].resources.length;e++)if(1!=canvasData[b].resources[e].type)d++,d>=canvasData[b].resources.length&&
c();else{var f=new Image;f.src=getResource(b,e);globalImages[b][e]=f;f.alt="";f.onload=function(){d++;d>=canvasData[b].resources.length&&c()}}},zoomIn:function(){},zoomOut:function(){},onResize:function(){},renderCnvas:function(b,c,d,e,f,g,h){if(bookConfig.usePdfJs&&d){this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0);this.render&&(this.render.taskPool.stop(),this.render=void 0);var k=canvasData[e],l=k.page,m=f,q=g,p=f/g,y=l.width/l.height;.01<=p-y&&!PageInfo.pageIsStrech(this.pageIndex)&&
(m=l.width*g/l.height);-.01>=p-y&&!PageInfo.pageIsStrech(this.pageIndex)&&(q=f*l.height/l.width);if(!window.devicePixelRatio||isPC())window.devicePixelRatio=1;f=m*devicePixelRatio/l.width;d.attr("width",m*devicePixelRatio);d.attr("height",q*devicePixelRatio);d.css("height",q+"px");d.css("width",m+"px");d.css({position:"absolute",top:0,bottom:0,left:0,right:0,margin:"auto"});g=d[0].getContext("2d");g.save();g.imageSmoothingEnabled=!0;l.background&&(g.fillStyle=int2color(l.background),g.fillRect(0,
0,m,q));this.render=new RenderPage(d[0],k,e,f);this.renderInterval=window.setInterval(function(){BookInfo.getBook().flipping||BookInfo.getBook().flipBook.parameters.zoomming?this.render.taskPool.pause():this.render.taskPool.start();this.render.taskPool.end()&&(h&&h(b,c,d),window.clearInterval(this.renderInterval))}.bind(this),200)}}}),SvgLoad=Class({index:0,pageWidth:0,pageHeight:0,create:function(b,c,d,e,f){var g=this,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return g.index=
b,g.type=c,g.pageWidth=e,g.pageHeight=f,k.yield(getPageDir(b,c,originTotalPageCount),2);h=k.yieldResult;g.sideImage=$("<img alt='' src='"+h+"'/>");g.sideImage[0].onload=function(){this.$svgDiv=$("<div style='position:absolute;width:100%;height:100%;left:0;top:0;'></div>");this.$svgDiv.append(this.sideImage);this.$svg=$("<canvas></canvas>");this.$svgDiv.append(this.$svg);this.width=this.sideImage[0].naturalWidth;this.height=this.sideImage[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight);
this.$svg.attr("width",this.width+"px");this.$svg.attr("height",this.height+"px");var l=this.$svg[0].getContext("2d");l.beginPath();l.drawImage(this.sideImage[0],0,0);l.closePath();BookInfo.getBook().status_zoom?this.zoomIn():this.zoomOut();this.reDraw();d&&d(h,h,this.$svgDiv,b)}.bind(g);k.jumpToEnd()})},beginToFlip:function(){},afterFlip:function(){},reDraw:function(){if(!isPC()){var b=this.$svg[0].getContext("2d"),c=function(){b.beginPath();b.clearRect(0,0,this.width,this.height);b.drawImage(this.sideImage[0],
0,0,this.width,this.height);b.closePath();console.log("reDraw:"+this.index)}.bind(this);this.interval=window.setTimeout(function(){c();this.interval=window.setTimeout(function(){c();this.interval=window.setTimeout(function(){c()}.bind(this),2E3)}.bind(this),1E3)}.bind(this),500)}},zoomIn:function(){this.sideImage&&this.sideImage.show();this.$svg&&this.$svg.hide()},zoomOut:function(){this.sideImage&&this.sideImage.hide();this.$svg&&this.$svg.show()},onResize:function(b,c){this.pageWidth=b;this.pageHeight=
c;b/=c;c=this.width/this.height;this.sideImage&&this.sideImage.css({width:"100%",height:"100%",position:"absolute",top:0,left:0});this.$svg&&this.$svg.css({width:"100%",height:"100%",position:"absolute",top:0,left:0});var d=fitPageWidthHeight(this.pageWidth,this.pageHeight,this.width,this.height);.01<=b-c&&!PageInfo.pageIsStrech(this.index)&&(this.$svg&&this.$svg.css({width:"auto",left:Math.round((this.pageWidth-d.x)/2)+"px"}),this.sideImage&&this.sideImage.css({width:"auto",left:Math.round((this.pageWidth-
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),q=b.getContext("2d"),p=q.getImageData(0,0,f,g),y=q.createImageData(c,d);p=p.data;for(var u=y.data,r=0;r<d;r++)for(var t=0;t<c;t++){for(var v=4*(t+r*c),z,A=0,F=0,D=0,M=0,K=0,H=0,I=(r+.5)*k,O=Math.ceil((r+1)*k),J=Math.floor(r*k);J<O;J++){var N=Math.abs(I-(J+.5))/m,fa=(t+.5)*h;N*=N;for(var ha=Math.ceil((t+1)*h),S=Math.floor(t*h);S<ha;S++)if(z=Math.abs(fa-(S+.5))/l,
z=Math.sqrt(N+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var R=4*(S+J*f);H+=z*p[R+3];F+=z;255>p[R+3]&&(z=z*p[R+3]/250);D+=z*p[R];M+=z*p[R+1];K+=z*p[R+2];A+=z}}u[v]=D/A;u[v+1]=M/A;u[v+2]=K/A;u[v+3]=H/F}!0===e?(b.width=c,b.height=d):q.clearRect(0,0,f,g);q.putImageData(y,0,0)}
var ImageLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",canvasDom:null,create:function(b,c,d,e,f,g,h){var k=this,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return k.index=b,k.type=c,k.pageWidth=e,k.pageHeight=f,k.isMirrorSide=g,k.parent=h,k.callback=d,q.yield(getPageDir(b,c,originTotalPageCount),2);l=q.yieldResult;k.imageURL=l;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(l=
...
"object"==typeof g&&(g=g[0]);getBlob(g).then(function(k){this.loadingTask=pdfjsLib.getDocument({url:k.url,cMapUrl:window.cMapUrl,cMapPacked:!0,password:k.password});this.loadingTask.promise.then(function(l){l.getPage(1).then(function(m){this.loaded=!0;this.page=m;this.renderCanvas(this.pageWidth,this.pageHeight).then(function(q){this.rendered=!0;this.callback&&this.callback(q);d(q)}.bind(this))}.bind(this))}.bind(this))}.bind(f));h.jumpToEnd()})}.bind(this))},renderCanvas:function(b,c){this.rendered=
!1;return new Promise(function(d,e){this.renderWidth=b;this.renderHeight=c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d"),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var m=l.width,q=l.height;isPC()||(m>q?3E3<m*h&&(h=3E3/m):3E3<q*h&&(h=3E3/q));f.width=m*h;f.height=q*h;1==h?(f.style.width=f.width+"px",f.style.height=f.height+"px"):
(f.style.width=m+"px",f.style.height=q+"px");g={canvasContext:g,transform:1!==h?[h,0,0,h,0,0]:null,viewport:l};try{this.renderTask=k.render(g),this.renderTask.promise.then(function(){this.rendered=!0;d(f)}.bind(this))}catch(p){e(p)}}.bind(this))},remove:function(){},destroy:function(){this.loadingTask&&(this.loadingTask.destroy(),this.loadingTask=null);this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);this.loaded=this.rendered=!1},isRepeat:function(){return this.loaded?this.pageWidth==
...
e.onload=function(){g=this.result+g;var l=new FileReader;l.onload=function(){g+=this.result;var m=f.slice(0,4E3),q=new FileReader;q.onload=function(){var p=new Uint8Array(this.result);for(i=0;i<this.result.byteLength;++i)p[i]=255-p[i];p=new Blob([new Blob([p.buffer]),f.slice(4E3,f.size)],{type:"application/pdf"});p=window.URL.createObjectURL(p);c({url:p,password:g})};q.readAsArrayBuffer(m)};l.readAsText(k)};e.readAsText(h)}};d.send()}.bind(this))}
...
var PdfLoad=Class({index:0,pageWidth:0,pageHeight:0,create:function(b,c,d,e,f,g,h){var k=this,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return k.index=b,k.type=c,k.pageWidth=e,k.pageHeight=f,k.renderWidth=e,k.renderHeight=f,k.callback=d,k.parent=h,l=k,q.yield(getPageDir(b,c,originTotalPageCount),2);if(3!=q.nextAddress)return l.imageURL=q.yieldResult,m=k,q.yield(getPageDir(b,"thumb",originTotalPageCount),3);m.thumbUrl=q.yieldResult;k.$content=$("<div style='position:absolute;left:0;top:0;width:100%;height:100%;'></div>");
k.pdfLoadingTask=new PdfLoadingTask(k.index,k.type,e,f,k.loaded.bind(k));window.pdfLoadStack||(window.pdfLoadStack=new PdfLoadArray(3));window.pdfLoadStack&&pdfLoadStack.push(k.pdfLoadingTask);q.jumpToEnd()})},loaded:function(b){this.pdfLoaded=!0;this.changeImageSrc(b)},enterSide:function(){this.enter=!0},leaveSide:function(){this.enter=!1;this.pdfLoadingTask&&this.pdfLoadingTask.leaveSide()},zoomIn:function(){isPhone()||isPad()},zoomOut:function(){isPhone()||isPad()},resizeSvg:function(b,c){this.renderWidth=
...
c.width)/2)+"px";f.top=Math.round((e-c.height)/2)+"px";c.$canvas.css(f);c.$content.empty().append(c.$canvas);g=d-c.width;h=e-c.height;(0!==g||0!==h)&&4>=g&&4>=h&&(c.$thumb||(c.$thumb=$('<img alt="" src="'+c.thumbUrl+'" style="z-index:-1;width:100%;height:100%;position:absolute;top:0;left:0;"/>')),c.$content.append(c.$thumb));c.callback&&c.callback(c.imageURL,c.imageURL,c.$content,c.index);k.jumpToEnd()})},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&pdfLoadStack.pop(this.pdfLoadingTask),
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(y){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;q=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(q=q.removeStartFrom("?"));m.imageURL=
q;m.imageObject=new ImageObject;m.imageObject.alt(m.index);m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=
function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);bookConfig.textSharpening&&(p="-webkit-optimize-contrast",_agent_.browser.firefox&&(p="-moz-crisp-edges"),_agent_.browser.opera&&(p="-o-crisp-edges"),m.$image.css({"image-rendering":p,"-ms-interpolation-mode":"nearest-neighbor"}));y.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&
...
y:0}},b);this.$image.css(d)},destroy:function(){this.$image=this.$image[0].onload=null},resizeSvg:function(b,c){if(isPhone()||isPad())b=fitPageWidthHeight(b,c,this.width,this.height),this.scale(b.x,b.y)}}),ImageArrayLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,q,p,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=
f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],u.yield(getPageDir(b,c,originTotalPageCount),2);k=u.yieldResult;h.imagesURL=k;l=0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);q=function(r){l++;this.$images.removeElement(r);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(p=0;p<k.length;p++)y=-1<k[p].indexOf(".svg")?new ImageArrayLoadSvg(b,k[p],c,m,q,e,f,g,p):new ImageArrayLoadImage(b,k[p],c,m,q,e,f,
g,p),h.$images.push(y.$image),h.loadArray.push(y);u.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&this.loadArray[c].zoomIn(b)},zoomOut:function(b,c){for(var d=0;d<this.loadArray.length;d++)this.loadArray[d].zoomOut&&this.loadArray[d].zoomOut(b,c)},onResize:function(b,c){this.pageWidth=b;this.pageHeight=c;for(var d=0;d<this.loadArray.length;d++)if(this.loadArray[d].onResize)this.loadArray[d].onResize(b,c)},destroy:function(){for(var b=0;b<this.loadArray.length;b++)this.loadArray[b].destroy&&
this.loadArray[b].destroy()},resizeSvg:function(b,c){for(var d=0;d<this.loadArray.length;d++)this.loadArray[d].resizeSvg&&this.loadArray[d].resizeSvg(b,c)}}),ImageStageLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:!1,create:function(b,c,d,e,f){this.index=b;this.type=c;this.pageWidth=e;this.pageHeight=f;this.callback=d;this.$image=$("<img alt=''/>");bookConfig.EnableRecognizeQRcodePressOnMobile&&this.$image.css({"-webkit-touch-callout":"default"});
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,q,p){p=void 0===p?!1:p;var y=h[m],u=Math.abs(l-k);if(!(0>=u)){q=q?y.width:y.height;l=0;if(u>=q)for(l=Math.floor((u+c.spacing)/(q+c.spacing));0<l&&!(l*q+(l-1)*c.spacing<=u);)l--;if(!(0>=l)){u=1<l?(u-l*q)/(l-1):0;for(var r=0;r<l;r++){var t=p?k-r*(q+u):k+r*(q+u),v=void 0,z=void 0;switch(m){case "top":v=t+(y.width-c.width)/2;z=(y.height-c.height)/2+f;break;case "right":v=b.canvas.width-(c.width+y.width)/2-f;z=t+(y.height-c.height)/
2;break;case "bottom":v=t+(y.width-c.width)/2;z=b.canvas.height-(c.height+y.height)/2-f;break;case "left":v=(y.width-c.width)/2+f,z=t+(y.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,v,z,g[m],c,p)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
f,g){this.$container=b;this.pageIndex=d;this.width=e;this.height=f;this.$parent=c;this.bookType=g;this.highlightSearch()},highlightSearch:function(){var b=this,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return global.slideHightLightList[b.pageIndex]&&b.searchTxtFromSlider(),c=global.getSearchRealPageIndex(b.pageIndex),-1==c?d.return():d.yield(global.loadPagePositionScript(b.pageIndex),2);highlightSearchFun(b.$container,c);d.jumpToEnd()})},clearHighlight:function(){this.$container.css({"background-image":""});
...
g;global.annotationCookie||this.bookType!=BookInfo.getBookType()||(global.annotationCookie=new AnnotationCookie);this.pageAnnotation=new Annotation(this.$container,d,e,f);this.enterSide()},enterSide:function(){isBelowIE9()&&$(this.$container).css({"background-image":"url('aaaa.a')"});this.pageAnnotation&&this.bookType==BookInfo.getBookType()&&this.pageAnnotation.restoreAnnotations(this.width,this.height,this.pageIndex-1,this.$container);this.pageAnnotation.reset();global.annotationPannel&&global.annotationPannel.visible&&
global.annotationPannel.checkTextConfigAndUpdateButton&&global.annotationPannel.checkTextConfigAndUpdateButton();global.annotationPannel&&global.annotationPannel.visible&&this.pageAnnotation&&this.pageAnnotation.initInteractiveMode()},leaveSide:function(){},onResize:function(b,c){if(b!=this.width||c!=this.height)this.width=b,this.height=c,this.pageAnnotation.onResize(b,c)}}).extend(PageAttachment),PageSelect=Class({create:function(b,c,d,e,f,g){this.$container=b;this.pageIndex=d;this.width=e;this.height=
f;this.$parent=c;this.bookType=g;this.initEvent()},initEvent:function(){var b=new Hammer.Manager(this.$container[0]);b.add(new Hammer.Pan({threshold:0}));b.add(new Hammer.Tap);b.on("panstart panmove panend",this.selectText.bind(this));b.on("tap",this.onTap.bind(this))},onTap:function(){this.$container&&this.$container.empty();this.hint&&this.hint.hide();global.modernTextCopyButton&&global.modernTextCopyButton.hide()},destroySelect:function(){this.$container&&this.$container.remove();this.hint&&this.hint.destroy();
this.$container=this.hint=void 0;global.modernTextCopyButton&&global.modernTextCopyButton.hide()},selectText:function(b){if(!BookInfo.getBook().flipping&&global.pageTextPositions){var c=this.pageIndex-1;if(global.pageTextPositions[c]&&global.pageTextPositions[c].page==this.pageIndex)var d=global.pageTextPositions[c].positions;this.$container.empty();if(d){this.searchTextHighlight||(this.searchTextHighlight=new SearchTextHighlight(this.width,this.height,rightToLeft),this.searchTextHighlight.loadFromPage(d),
this.highlightDOM=new SearchHighlightDOM(this.$container));d="Modern"===_get(htmlConfig,"phoneTemplate.name");c=null;if(d){var e=bookConfig.themeColor;e&&(c=Color(e).rgba(.4))}e=this.getArea(b);e=this.searchTextHighlight.selectText(e);this.highlightText="";var f=null;if(e){for(var g=e.getRects(),h=0;h<g.length;){for(var k=[],l=0;4>l;l++)k[l]=g[h+l];0===h&&(f={x:k[0].x,y:k[0].y,width:k[1].x-k[0].x,height:k[3].y-k[0].y});this.highlightDOM.addHighlight(k,c);h+=4}this.highlightText=e.getText()}d&&!this.highlightText&&
global.modernTextCopyButton&&global.modernTextCopyButton.hide();"panend"==b.type&&(isPhone()||isPad()?this.highlightText&&(d&&f?(global.modernTextCopyButton||"undefined"===typeof ModernTextCopyButton||(global.modernTextCopyButton=new ModernTextCopyButton),global.modernTextCopyButton&&global.modernTextCopyButton.show({container:this.$container,highlightRect:f,text:this.highlightText})):d||(global.phoneCopyForm||(phoneCopyForm=new CopyForm({parent:tmpContainer,formType:"copy",rightToLeft:rightToLeft})),
...
PageAttachmentsParser.prototype.createAnimationDom=function(){this.$animation||(this.$animation=$("<div id='animation"+this.bookType+"-"+this.pageIndex+"' style='width:100%;height:100%;position:absolute;bottom:0;right:0;left:0;top:0;z-index:4;'></div>"),"Chinese"==UserGroups&&(isPhone()||isPad())&&bookConfig.EnableRecognizeQRcodePressOnMobile&&this.$animation.css({pointerEvents:"none"}),this.$animation.css({width:this.width+"px",height:this.height+"px"}),this.parent.append(this.$animation))};
...
show:virtual_function,hide:virtual_function,onResize:virtual_function,destroy:virtual_function}),NoteAdd=Class({create:function(b){var c=this;this.noteAdd=$("<div class='anno-noteAdd'></div>");this.noteAdd.on("mousedown mouseup pointerdown",function(d){return d.stopPropagation()});this.noteAdd.on(_event._down,function(){return c.noteAdd.css({opacity:"0.7"})});this.noteAdd.on(_event._up,function(d){return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){d.stopPropagation();c.noteAdd.css({opacity:""});
return bookConfig.AnnotationButtonVisible?e.yield(global.showAnnotationPanel(!1,function(){global.annotationPannel.addNote()}),0):e.jumpTo(0)})});b.append(this.noteAdd)},show:function(){this.noteAdd.css({display:"block"})},hide:function(){this.noteAdd.css({display:"none"})},getPageWidth:function(){try{var b=BookInfo.getBook().currentPageIndex,c="";if(BookInfo.getBook().pageArray.length&&BookInfo.getBook().pageArray[b])return"slide"==bookConfig.FlipStyle.toLocaleLowerCase()&&BookInfo.isDoublePage(BookInfo.getBookType())?
(BookInfo.getBook().pageArray[b].leftPage?c=BookInfo.getBook().pageArray[b].leftPage:BookInfo.getBook().pageArray[b].rightPage&&(c=BookInfo.getBook().pageArray[b].rightPage),rightToLeft&&BookInfo.getBook().pageArray[b].rightPage&&(c=BookInfo.getBook().pageArray[b].rightPage)):c=BookInfo.getBook().pageArray[b].page,{width:c.pageWidth,height:c.pageHeight}}catch(d){return{width:0,height:0}}},isFirstOrLastPage:function(){return this.isFirstPage()||this.isLastPage()?!0:!1},isCurrentDoublePage:function(){return 1<
BookInfo.getPagesByIndex(BookInfo.getCurrentPageIndex()).length},isLastPage:function(){var b=BookInfo.getBook().currentPageIndex,c=bookConfig.totalPageCount;"slide"==bookConfig.FlipStyle.toLocaleLowerCase()&&(c=BookInfo.getBook().pageLength());return b==c},isFirstPage:function(){return 1===BookInfo.getBook().currentPageIndex},onResize:function(b,c){var d=this.getPageWidth();if(d&&(b=d.width,c=d.height,bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad())){d=windowHeight-c-templateArea.getTopHeight()-
templateArea.getBottomHeight();var e=BookInfo.isDoublePage(BookInfo.getBookType())?windowWidth-2*b-templateArea.getRightWidth()-templateArea.getLeftWidth():windowWidth-b-templateArea.getRightWidth()-templateArea.getLeftWidth();if("slide"==bookConfig.FlipStyle.toLocaleLowerCase()&&BookInfo.isDoublePage(BookInfo.getBookType())&&this.isFirstOrLastPage()&&!this.isCurrentDoublePage()){var f=BookInfo.getBook().width,g=BookInfo.getBook().height;b=(f-b)/2;c=(g-c)/2;rightToLeft?24<b+e?this.noteAdd.css({display:"block",
top:"0",right:"auto",left:b-24+"px"}):24<c+d?this.noteAdd.css({display:"block",top:c-24+"px",right:"auto",left:"0"}):this.noteAdd.css({display:"none"}):24<b+e?this.noteAdd.css({display:"block",top:"0",right:b-24+"px",left:"auto"}):24<c+d?this.noteAdd.css({display:"block",top:c-24+"px",right:"0",left:"auto"}):this.noteAdd.css({display:"none"})}else 24>e/2&&24>d/2?this.noteAdd.css({display:"none"}):24<=e/2?rightToLeft?(this.noteAdd.css({display:"block",top:"0",right:"auto",left:"-22px"}),this.isLastPage()&&
1<bookConfig.totalPageCount&&(this.isCurrentDoublePage()?this.noteAdd.css({left:"auto",right:"-22px"}):this.noteAdd.css({right:"-22px",left:"auto"}))):(this.noteAdd.css({display:"block",top:"0",left:"auto",right:"-22px"}),this.isLastPage()&&1<bookConfig.totalPageCount&&(this.isCurrentDoublePage()?this.noteAdd.css({right:"-22px",left:"auto"}):this.noteAdd.css({left:"-22px",right:"auto"}))):rightToLeft?(this.noteAdd.css({display:"block",top:"-22px",right:"auto",left:"0"}),this.isLastPage()&&this.noteAdd.css({left:"auto",
right:"0"})):(this.noteAdd.css({display:"block",top:"-22px",left:"auto",right:"0"}),this.isLastPage()&&this.noteAdd.css({right:"auto",left:"0"}))}}}),ZoomHint=Class({create:function(b){var c=this;this.mouseInBook=new Point(-1,-1);this.oldMouseInBook=new Point(-1,-1);this.zoomHint=null;this.trackMousePoint=function(d){d=isTouch?d.originalEvent.touches:[d];var e=d[0].pageY;c.mouseInBook.x=d[0].pageX;c.mouseInBook.y=e};bookContainer.bind(_event._move,this.trackMousePoint);this.zoomHintTimer=window.setInterval(function(){if(bookType!=
BookType.normal_book)c.clearZoomHintTimer();else if(null==c.zoomHint)if(-1==c.oldMouseInBook.x)c.oldMouseInBook.x=c.mouseInBook.x,c.oldMouseInBook.y=c.mouseInBook.y;else if(c.oldMouseInBook.x==c.mouseInBook.x&&c.oldMouseInBook.y==c.mouseInBook.y){var d=c.globalToBook(!0,c.mouseInBook.x,c.mouseInBook.y);if(!(0>d.x||d.x>c.width||0>d.y||d.y>c.height)){d=c.mouseInBook.x+15;var e=c.mouseInBook.y;c.zoomHint=new divHint(getLanguage("lblDoubleClickToZoomIn","Double click to zoom in."),d,e,b);c.zoomHint.show();
c.hideCount=0}}else c.oldMouseInBook.x=c.mouseInBook.x,c.oldMouseInBook.y=c.mouseInBook.y;else 2==++c.hideCount&&(bookContainer.unbind(_event._move,c.trackMousePoint),c.zoomHint.destroy(),c.zoomHint=null,window.clearInterval(c.zoomHintTimer))},1500)},globalToBook:function(b,c,d){switch(bookType){case BookType.single_book:var e=Point(c-singlePageBook.getLeft(),d-singlePageBook.getTop());break;case BookType.normal_book:e=Point(c-((b?0:flipBook.getPageWidth())+flipBook.getLeft()),d-flipBook.getTop());
break;case BookType.catalog_book:e=catalogBook.getTran(),b=c-((b?0:catalogBook.getPageWidth())+catalogBook.getCssLeft())-e.x,d=d-catalogBook.getCssTop()-e.y,e=Point(b,d)}return e},clearZoomHintTimer:function(){try{window.clearInterval(this.zoomHintTimer)}catch(b){}null!=this.zoomHint&&(bookContainer.unbind(_event._move,this.trackMousePoint),this.zoomHint.destroy(),this.zoomHint=null)}}),TipsBox=Class({create:function(b,c){this.visible=!1;this.option=b;this.duration=b.duration?b.duration:1500;this.background=
$("<div class='tipsBox tipsBoxShadow tipsBoxRadius'></div>");$(c).append(this.background)},setTimer:function(){this.timer=window.setInterval(function(){this.hideTipsBox();window.clearInterval(this.timer)}.bind(this),this.duration)},resetTimer:function(){window.clearInterval(this.timer);this.setTimer()},setPosition:function(b,c,d){void 0==d&&(d=["left","top"]);$(this.background).css(d[0],b+"px");$(this.background).css(d[1],c+"px")},onResize:function(b,c){},getWidth:function(){return $(this.background).width()},
getHeight:function(){return $(this.background).height()},setCaption:function(b){this.background.html(b)},showTipsBox:function(){this.visible?this.resetTimer():(this.setTimer(),this.visible=!0,$(this.background).show(),$(this.background).animate({opacity:this.option.opacity?this.option.opacity:.5},300))},hideTipsBox:function(){this.visible&&(this.visible=!1,$(this.background).animate({opacity:0},300,function(){$(this.background).hide()}.bind(this)))}}),BookMiniFullscreen=Class({create:function(){},
init:function(){if(!isIE()){if(isPhone()||isPad()){if(!bookConfig.isShowMobileBottomFullscreenPrompts)return}else if(MiniStyle.isMini()||!bookConfig.isShowBottomFullscreenPrompts)return;fullScreenApi.supportsFullScreen&&fullScreenApi.isFullScreen()||this.miniFullScreen||(this.miniFullScreen=$("<div class='miniFullscreen' id='miniFullscreen'></div>"),this.miniFullScreen.html(getLanguage("lblFullscreen","Click to view in fullscreen.")),this.onResize(),bookContainer.append(this.miniFullScreen),this.miniFullscreenEnter=
!1,bookConfig.alwaysShowBottomFullscreenPrompt||(this.miniFullscreenTimeout&&window.clearTimeout(this.miniFullscreenTimeout),this.miniFullscreenTimeout=window.setTimeout(function(){this.removeMiniFullScreen()}.bind(this),1E3*bookConfig.bottomFullscreenPromptDisplayDuration)),this.initMiniFullScreenEvent())}},initMiniFullScreenEvent:function(){this.miniFullScreen.on(_event._end,function(){bookType==BookType.catalog_book&&global.catalogBook&&catalogBook.guidBar&&catalogBook.guidBar.fullscreenBtn?catalogBook.guidBar.fullscreenBtn.trigger(_event._end):
readAsFullscreen();this.miniFullScreen.remove();this.miniFullScreen=void 0;BookEvent.trigger("customEvent",["click_fullscreen_prompt"])}.bind(this));this.miniFullScreen.on(_event._enter,function(){this.miniFullscreenEnter=!0}.bind(this));this.miniFullScreen.on(_event._leave,function(){this.miniFullscreenEnter=!1;bookConfig.alwaysShowBottomFullscreenPrompt||(this.miniFullscreenTimeout&&window.clearTimeout(this.miniFullscreenTimeout),this.miniFullscreenTimeout=window.setTimeout(function(){this.removeMiniFullScreen()}.bind(this),
1E3*bookConfig.bottomFullscreenPromptDisplayDuration))}.bind(this))},removeMiniFullScreen:function(){if(this.miniFullScreen&&!this.miniFullscreenEnter){var b={alpha:.7};$(b).animate({alpha:0},{duration:300,easing:"easeOutSine",step:function(){this.miniFullScreen&&this.miniFullScreen.css({opacity:b.alpha})}.bind(this),complete:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen&&(this.miniFullScreen=void 0)}.bind(this)})}},onResize:function(){if(this.miniFullScreen)if(!MiniStyle.isMini()||
isPhone()||isPad()){var b=BookInfo.top();this.miniFullScreen.css({top:b+BookInfo.height()-80+"px"})}else this.miniFullScreen.remove(),this.miniFullScreen=void 0},show:function(){this.miniFullScreen&&this.miniFullScreen.show()},hide:function(){this.miniFullScreen&&this.miniFullScreen.hide()},remove:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen=void 0},setStyle:function(b){b&&this.miniFullScreen&&this.miniFullScreen.css(b)}}),BookPageNumberForFlip=Class({create:function(){},
init:function(){if(bookConfig.updatePageNumberForFlip){var b=-1==BookInfo.getCurrentPageIndex()?1:BookInfo.getCurrentPageIndex();this.miniFullScreen?this.miniFullScreen.html(getShownPageNumberInfo(b)):(this.miniFullScreen=$("<div class='miniFullscreen' id='pageNumberForFlip'></div>"),this.miniFullScreen.html(getShownPageNumberInfo(b)),this.onResize(),bookContainer.append(this.miniFullScreen),this.miniFullscreenEnter=!1,this.miniFullscreenTimeout&&window.clearTimeout(this.miniFullscreenTimeout),this.miniFullscreenTimeout=
window.setTimeout(function(){this.removeMiniFullScreen()}.bind(this),3E3),this.initMiniFullScreenEvent())}},initMiniFullScreenEvent:function(){},removeMiniFullScreen:function(){if(this.miniFullScreen&&!this.miniFullscreenEnter){var b={alpha:.5};$(b).animate({alpha:0},{duration:300,easing:"easeOutSine",step:function(){this.miniFullScreen&&this.miniFullScreen.css({opacity:b.alpha})}.bind(this),complete:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen&&(this.miniFullScreen=
void 0)}.bind(this)})}},onResize:function(){if(this.miniFullScreen)if(MiniStyle.isMini())this.miniFullScreen.remove(),this.miniFullScreen=void 0;else{var b=BookInfo.top();this.miniFullScreen.css({top:b+BookInfo.height()-40+"px"})}},show:function(){this.miniFullScreen&&this.miniFullScreen.show()},hide:function(){this.miniFullScreen&&this.miniFullScreen.hide()},remove:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen=void 0},setStyle:function(b){b&&this.miniFullScreen&&
this.miniFullScreen.css(b)}}),BookAttachmentsFactory=Class({create:function(b,c,d,e){this.isDoublePage=e;this.container=b;this.book=d;this.pageIndex=c},createAttachment:function(b,c){switch(b){case "thickness":var d=c?new ThicknessManager(this.container,this.book):new SingleBookThicknessManager(this.container,this.book);d.refreshThickness();break;case "bookshadow":d=new BookShadow(this.container);break;case "zoomhint":d=new ZoomHint(this.parent);break;case "minifullscreen":d=new BookMiniFullscreen;
0<=BookInfo.getCurrentPages().indexOf(1)&&d.init();break;case "bookpagenumber":d=new BookPageNumberForFlip;break;case "staticad":d=new StaticAd(this.container);break;case "zoommap":d=new ZoomMap(this.book);d.fillContent(this.pageIndex);break;case "bookmarktab":d=new BookmarkTab(this.container,!this.isDoublePage);break;case "noteadd":d=new NoteAdd(this.container)}return d}}),BookAttachmentsBuilder=Class({Package:"BookAttachment",create:function(b,c,d,e){this.parent=b;this.pageIndex=c;this.book=d;this.isDoublePage=
e;this.Items=this.createAttachmentsForBook()},createAttachmentsForBook:function(){var b=new ObjectPool;this.factory=new BookAttachmentsFactory(this.parent,this.pageIndex,this.book,this.isDoublePage);return b},thickness:function(b){this.bookThickness=this.factory.createAttachment("thickness",b);this.Items.add(this.bookThickness)},bookshadow:function(){this.bookShadow=this.factory.createAttachment("bookshadow");this.Items.add(this.bookShadow)},grayshadow:function(){_agent_.browser.msie||_agent_.browser.safari||
!bookConfig.ShowTopLeftShadow||this.book.bookType!=BookType.normal_book||(this.grayshadow=this.factory.createAttachment("grayshadow"),this.Items.add(this.grayshadow))},miniFullscreen:function(){this.miniFullscreen=this.factory.createAttachment("minifullscreen");this.Items.add(this.miniFullscreen)},bookpagenumber:function(){this.bookPageNumber=this.factory.createAttachment("bookpagenumber");this.bookPageNumber.init();this.Items.add(this.bookPageNumber)},staticad:function(){void 0!=global.staticAd&&
1==staticAd.haveAd&&(this.staticAd=this.factory.createAttachment("staticad"),this.Items.add(this.staticAd))},zoommap:function(){isPad()||isPhone()||!bookConfig.ZoomMapVisible||(this.zoomMap=this.factory.createAttachment("zoommap"),this.Items.add(this.zoomMap))},bookmarktab:function(){(function(){isPhone()||isPad()||(this.bookMarkTab=this.factory.createAttachment("bookmarktab"),this.Items.add(this.bookMarkTab))}).delay(this,1)},noteadd:function(){!bookConfig.AnnotationButtonVisible||isPhone()||isPad()||
(this.noteAdd=this.factory.createAttachment("noteadd"),this.Items.add(this.noteAdd));if(bookConfig.AnnotationButtonVisible){var b=bookConfig.searchHightlightColor||"#0099ff",c=parseInt(b.slice(1,3),16),d=parseInt(b.slice(3,5),16),e=parseInt(b.slice(5,7),16),f=document.documentElement;f.style.setProperty("--accent-primary",b);f.style.setProperty("--accent-primary-rgb",c+" "+d+" "+e)}},zoomhint:function(){isTouchDevice()},hide:function(){this.Items.find("StaticAd").each(function(b){b.hide()});this.Items.find("ZoomMap").each(function(b){b.hide()});
...
FlipBookIntervalManager=Class({create:function(b){this.book=b;this.flippingTime=1E3*bookConfig.flippingTime},flipIntervalTmp:function(b,c,d,e){if(b){this.book.flipping=!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var q=0;k=function(){m(q,
25,"Sine");q++}.interval(this,l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,y){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,t=$.easing["easeInOut"+y],v=$.easing["easeOut"+y];y=v(null,q,g,b.toPoint.x-g,p);v=v(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(y=t(null,q,g,b.toPoint.x-g,p),v=bookConfig.FlipDirection?f*Math.sqrt(r*r-y*y):r-f*Math.sqrt(u*u-y*y));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:y,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,
...
var ZoomControlBar=Class({create:function(b){this.moveByMousePosition=!1;this.moveByPositionUrl=this.getImageUrl("moveByPos");this.moveByDragUrl=this.getImageUrl("moveByDrag");this.initButtons();this.initBar(b);this.initEvent();this.setA11y()},initButtons:function(){this.btnZoomUp=$("<button class='button' aria-label='"+getLanguage("btnZoomIn","zoom in")+"'>\n        <img alt='' src='"+this.getImageUrl("ZU")+"'/>\n      </button>");this.btnZoomDown=$("<button class='button' aria-label='"+getLanguage("btnZoomOut",
"zoom out")+"'>\n        <img alt='' src='"+this.getImageUrl("ZD")+"'/>\n      </button>");this.btnZoomOut=$("<button class='button' aria-label='"+getLanguage("btnZoomOut","zoom out")+"'>\n        <img alt='' src='"+this.getImageUrl("ZO")+"'/>\n      </button>");this.btnPre=$("<button class='button' aria-label='"+getLanguage("btnPrePage","pre")+"'>\n        <img alt='' src='"+this.getImageUrl("PR")+"'/>\n      </button>");this.btnNext=$("<button class='button' aria-label='"+getLanguage("btnNextPage",
"next")+"'>\n        <img alt='' src='"+this.getImageUrl("NE")+"'/>\n      </button>");this.btnMoveMode=$("<button class='button' aria-label='"+getLanguage("btnPositionToMove","Move by mouse position")+"'>\n        <img alt='' src='"+this.moveByPositionUrl+"'/>\n      </button>");this.btnClose=$("<button class='button' aria-label='"+getLanguage("btnClose","Close")+"'>\n        <img alt='' src='"+this.getImageUrl("zoom_close")+"'/>\n      </button>")},initBar:function(b){this.height=40;this.bar=$("<div class='zoomControlBar'></div>");
...
this.prevImageUrl=uiBaseURL+"slide_rightButton.png",this.firstImageUrl=uiBaseURL+"catalog_lastButton.png");this.prevDiv.append("<img alt='' src='"+this.prevImageUrl+"'/>");this.firstDiv.append("<img alt='' src='"+this.firstImageUrl+"'/>")},onResize:function(b,c){var d=Math.min(50,.7*c/8),e=Math.min(.7*c,310);this.width=d;this.height=e;this.flipShotObj.css({width:d,height:e});this.setPosition(b,c)},setPosition:function(b,c){this.flipShotObj.css({left:this.isLeft?1-this.width:"100%",top:(c-this.height)/
2})},setScale:function(b){this.width*=b;this.height*=b;this.flipShotObj.css({width:this.width,height:this.height})},setVisible:function(b){this.flipShotObj.css({display:b?"block":"none"});this.visible=b},getContainer:function(){return this.flipShotObj},initEvents:function(){this.isLeft?(this.prevDiv.bind(_event._end,function(b){rightToLeft?nextPageFun("flip shot bar"):previousPageFun("flip shot bar")}),this.firstDiv.bind(_event._end,function(b){rightToLeft?lastPageFun("flip shot bar"):firstPageFun("flip shot bar")})):
(this.prevDiv.bind(_event._end,function(b){rightToLeft?previousPageFun("flip shot bar"):nextPageFun("flip shot bar")}),this.firstDiv.bind(_event._end,function(b){rightToLeft?firstPageFun("flip shot bar"):lastPageFun("flip shot bar")}));this.prevDiv.on("mousedown mouseup touchstart",function(b){b.stopPropagation()});this.firstDiv.on("mousedown mouseup touchstart",function(b){b.stopPropagation()})},setVisibleByIndex:function(b){this.isLeft?(1<b&&(rightToLeft||this.setVisible(!0)),b<originTotalPageCount-
1&&rightToLeft&&this.setVisible(!0),3>=b&&(bookConfig.RightToLeft||1>=b&&this.setVisible(!1)),b>=originTotalPageCount-2&&bookConfig.RightToLeft&&b>=originTotalPageCount-1&&this.setVisible(!1)):(1<b&&rightToLeft&&this.setVisible(!0),b<originTotalPageCount-1&&(rightToLeft||this.setVisible(!0)),3>=b&&bookConfig.RightToLeft&&1>=b&&this.setVisible(!1),b>=originTotalPageCount-2&&(bookConfig.RightToLeft||b>=originTotalPageCount-1&&this.setVisible(!1)))},refresh:function(){}}),setCurrentIndexTextField=function(b){b=
getShownPageNumberInfo(b);$("#guidPageIndex").html("<b>"+b+"</b>");$("#currentPageIndexTextField")&&$("#currentPageIndexTextField")[0]&&!$("#currentPageIndexTextField")[0].onFocus&&$("#currentPageIndexTextField").val(b);if(isMacOSChrome()){var c,d;null==(c=global)||null==(d=c.toolBar)||d.resetPageNumberSize(b.length)}c=$(".currentPageIndexTextField");for(d=0;d<c.length;d++)c[d]&&!c[d].onFocus&&$(c[d]).val(b)},getShownPageNumberInfo=function(b){BookInfo.isDoublePage();b=BookInfo.getCurrentPages();
for(var c=originTotalPageCount,d="",e=0;e<b.length;e++){var f=getShownPageNumber(b[e]);0!=e&&d!=f&&(d+="-");d!=f&&(d+=f)}0==b.length&&(d=getShownPageNumber(1));bookConfig.totalPagesCaption&&(c=bookConfig.totalPagesCaption);return rightToLeft?c+"/"+d:d+"/"+c},getShownPageArray=function(){var b=bookConfig.pageNumberCaption+"",c=originTotalPageCount;";"==b.substr(b.length-1,1)&&(b=b.substr(0,b.length-1));b=b.split(";");for(var d=[],e=0;e<b.length;e++)if(""!=b[e]&&void 0!=b[e]){var f=b[e].split(":");
if(f[0])if(f[1]||(f[1]=""),-1<f[1].indexOf("+")){var g=f[0];g.indexOf("-");g=g.split("-");var h=g[0];g=g[1];h=parseInt(h);var k=g?parseInt(g):c;f=getPageNumberFormat(f[1]);for(var l=h;l<=k;l++){var m=(l-h)*f.addition+f.startPage;g="";0==f.type&&(g=m+"");1==f.type&&(g=parseRoman(m));2==f.type&&(g=parseRoman(m).toLowerCase());d[l]=String.format(f.page,g)}}else if(!isNaN(f[0]))h=parseInt(f[0]),d[h]=void 0==f[1]?"":f[1];else if(-1<f[0].indexOf("-"))for(g=f[0],g.indexOf("-"),g=g.split("-"),h=g[0],g=g[1],
h=parseInt(h),k=g?parseInt(g):c,l=h;l<=k;l++)d[l]=void 0==f[1]?"":f[1]}return d};
...
c,d);return}if(bookConfig.isShowFirstOrLastPagePrompt){b=1>b?getLanguage("lblFirst","This is the first page"):getLanguage("lblLast","This is the last page");global._tipsBox||(_tipsBox=new TipsBox(b,bookContainer));_tipsBox.setCaption(b);_tipsBox.showTipsBox();return}}e=b;BookInfo.isDoublePage()&&(e=BookInfo.getMaxPageIndex(e));e=Math.max(1,e);if(passwardType()&&bookConfig.excludeFrontPages&&e>=parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()&&(global.passwardPannel||(global.passwardPannel=
new PasswardPannel),global.passwardPannel.show(),e>parseInt(bookConfig.excludeFrontPages)))return;switch(bookType){case BookType.normal_book:flipBook.gotoPage(b,c);break;case BookType.single_book:singlePageBook.gotoPage(b,c);break;case BookType.slide_book:slideBook.gotoPage(b,c);break;case BookType.singleSlide_book:singleSlideBook.gotoPage(b,c);break;case BookType.catalog_book:catalogBook.gotoPage(b,c);break;case BookType.singleCatalog_book:singleCatalogBook.gotoPage(b,c);break;case BookType.documentView_book:singleDocumentViewBook.gotoPage(b,
c);break;case BookType.singleDocumentView_book:singleDocumentViewBook.gotoPage(b,c);break;case BookType.card_book:cardBook.gotoPage(b,c);break;case BookType.invert_book:invertBook.gotoPage(b,c)}global.bookmark&&global.bookmark.elements.refreshElements();bookConfig.SelectTextButtonVisible&&((c=_get(htmlConfig,"phoneTemplate.name",""))&&"Modern"===c||BookInfo.getBook().unSelect());bookConfig.MagnifierButtonVisible&&BookInfo.getBook().unMagnifierZoom();global.annotationPannel&&global.annotationPannel.clearBtnDownCase();
bookConfig.addCurrentPage&&global.sharePanel&&global.sharePanel.elements&&global.sharePanel.elements.fillArea(!0,"link");global.downLoadBody&&downLoadBody.gotoPage(b);if(bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad()&&BookInfo.getBook().bookAttachments.noteAdd)BookInfo.getBook().bookAttachments.noteAdd.onResize();setCurrentIndexTextField(BookInfo.getCurrentPageIndex(),BookInfo.isDoublePage());"popstate"!==d&&setLocationHash(BookInfo.getCurrentPageIndex());global.phoneGotoPagePanel&&global.phoneGotoPagePanel.visible&&
global.phoneGotoPagePanel.refreshSlider();global.NeatStyle&&NeatStyle.refreshSlider();global.assistant&&global.assistant.refresh();global.pcArticlePages&&(global.pcArticlePages.clearHighLight(),global.pcArticlePages.setHighLight(b));global.phoneArticlePages&&(global.phoneArticlePages.clearHighLight(),global.phoneArticlePages.setHighLight(b));global.flipPageAudio&&global.flipPageAudio.playByIndex(b);global.phoneGotoPagePanel&&global.phoneGotoPagePanel.showFirstOrLast();global.flipShotButton&&global.flipShotButton.showFirstOrLast();
global.toolbar&&global.toolBar&&global.toolBar.showFirstOrLast&&global.toolBar.showFirstOrLast();bookConfig.delayToFlipFirst&&1!==b&&(delayToFlipFirstTimer&&clearTimeout(delayToFlipFirstTimer),delayToFlipFirstTimer=setTimeout(function(){firstPageFun("auto flip")},1E3*bookConfig.timeToFlipFirst));global.modernPageBookmarkIndicator&&global.modernPageBookmarkIndicator.refresh()}},gotoPageVisit=function(b,c){var d=window.lastVisitTime?(new Date).getTime()-window.lastVisitTime:0;window.lastVisitTime=(new Date).getTime();
if(!(0>=b||b>bookConfig.totalPageCount)){var e={"phone thumbnail":"thumbnail",thumbnail:"thumbnail","table of content":"toc"};if(e[c]){var f={};BookEvent.trigger("customEvent",["click_"+e[c]+"_page_"+b,(f["click_"+e[c]+"_to_page"]=b,f)])}BookEvent.trigger("flipPage",[c,BookInfo.getCurrentPages().join("-"),BookInfo.getCurrentPagesByIndex(b).join("-"),d])}},BookInfo=Class({statics:{getCurrentPages:function(){var b=[];if(this.isDoublePage()){var c=this.getCurrentPageIndex();b=this.getPagesByIndex(c)}else c=
this.getCurrentPageIndex(),b.push(c);return b},getCurrentPagesByIndex:function(b){var c=[];this.isDoublePage()?c=this.getPagesByIndex(b):c.push(b);return c},getPageCount:function(){return bookConfig.totalPageCount},isRightToLeft:function(){return rightToLeft},getBookType:function(){return bookType},getBook:function(){switch(this.getBookType()){case BookType.normal_book:var b=global.flipBook;break;case BookType.single_book:b=global.singlePageBook;break;case BookType.slide_book:b=global.slideBook;break;
case BookType.singleSlide_book:b=global.singleSlideBook;break;case BookType.catalog_book:b=global.catalogBook;break;case BookType.singleCatalog_book:b=global.singleCatalogBook;break;case BookType.documentView_book:b=global.singleDocumentViewBook;break;case BookType.singleDocumentView_book:b=global.singleDocumentViewBook;break;case BookType.card_book:b=global.cardBook;break;case BookType.invert_book:b=global.invertBook}return b},getBooks:function(){var b=[];global.flipBook&&b.push(global.flipBook);
global.singlePageBook&&b.push(global.singlePageBook);global.slideBook&&b.push(global.slideBook);global.singleSlideBook&&b.push(global.singleSlideBook);global.catalogBook&&b.push(global.catalogBook);global.singleCatalogBook&&b.push(global.singleCatalogBook);global.cardBook&&b.push(global.cardBook);global.invertBook&&b.push(global.invertBook);return b},getCurrentPageIndex:function(){var b=this.getBook();return b&&b.getCurrentPageIndex?b.getCurrentPageIndex():bookConfig.OriginPageIndex},isDoublePage:function(b){var c=
this.getBookType();void 0!=b&&(c=b);switch(c){case BookType.single_book:return!1;case BookType.singleSlide_book:return!1;case BookType.singleCatalog_book:return!1;case BookType.documentView_book:return!1;case BookType.singleDocumentView_book:return!1;case BookType.card_book:return!1;case BookType.invert_book:return!1}return!0},left:function(){var b=this.getBook();return b&&b.getLeft?b.getLeft():0},top:function(){var b=this.getBook();return b&&b.getTop?b.getTop():0},width:function(){var b=this.getBook();
...
getThumbnailPages:function(){for(var b=[],c=Math.ceil(bookConfig.totalPageCount/2),d=0;d<=c;d++){var e=this.getPagesByIndex(2*d+1);0<e.length&&b.push(e)}return b},getPagesByIndex:function(b){function c(f){1<=f&&f<=bookConfig.totalPageCount&&d.push(f)}var d=[];if(bookConfig.isTheBookOpen){b=2*Math.ceil(b/2);var e=b-1}else e=2*Math.floor(b/2),b=e+1;rightToLeft?(c(b),c(e)):(c(e),c(b));return d},isLeftPage:function(b,c){c=void 0==c?this.isDoublePage():c;if(!c&&!rightToLeft)return!1;if(!c&&rightToLeft||
(0==b%2&&!rightToLeft||0!=b%2&&rightToLeft)&&!bookConfig.isTheBookOpen)return!0;if((0==b%2&&!rightToLeft||0!=b%2&&rightToLeft)&&bookConfig.isTheBookOpen||(0==b%2&&rightToLeft||0!=b%2&&!rightToLeft)&&!bookConfig.isTheBookOpen)return!1;if((0==b%2&&rightToLeft||0!=b%2&&!rightToLeft)&&bookConfig.isTheBookOpen)return!0},isInnerPage:function(b,c){if(1!=b&&c==BookType.single_book||!this.isCoverPage(b)&&c!=BookType.single_book)return!0},isCoverPage:function(b,c){return 0<=[1,totalPageCount].indexOf(b)&&!bookConfig.isTheBookOpen||
b==totalPageCount&&bookConfig.isTheBookOpen?!0:!1},getHardCoverPages:function(b){if(b&&rightToLeft&&!bookConfig.isTheBookOpen)return[totalPageCount-1,2];if(b&&!rightToLeft&&!bookConfig.isTheBookOpen)return[2,totalPageCount-1];if(b&&rightToLeft&&bookConfig.isTheBookOpen)return[0==bookConfig.totalPageCount%2?bookConfig.totalPageCount:bookConfig.totalPageCount-1,1];if(b&&!rightToLeft&&bookConfig.isTheBookOpen)return[1,0==bookConfig.totalPageCount%2?bookConfig.totalPageCount:bookConfig.totalPageCount-
1];if(!b)return[bookConfig.totalPageCount]},getSensitiveIndex:function(b){if(b&&!bookConfig.isTheBookOpen)return b=totalPageCount-2,{min:3,max:b};if(b&&bookConfig.isTheBookOpen)return b=totalPageCount-2,{min:4,max:b};b=bookConfig.totalPageCount;return{min:2,max:b}},getMinPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2)-1:2*Math.floor(b/2)},getMaxPageIndex:function(b){return b=bookConfig.isTheBookOpen?2*Math.ceil(b/2):2*Math.floor(b/2)+1},getLeftPageIndex:function(b){b=this.getPagesByIndex(b);
return 1==b.length&&(1==b[0]&&!bookConfig.RightToLeft||b[0]==totalPageCount&&bookConfig.RightToLeft)?null:b[0]},getRightPageIndex:function(b){b=this.getPagesByIndex(b);return 1==b.length?1==b[0]&&bookConfig.RightToLeft||b[0]==totalPageCount&&!bookConfig.RightToLeft?null:b[0]:b[1]},getLeftPages:function(b){void 0==b&&(b=this.getCurrentPageIndex());b=this.getMinPageIndex(b);return bookConfig.RightToLeft?[b+1,b+2,b+3]:[b,b-1,b-2]},getRightPages:function(b){void 0==b&&(b=this.getCurrentPageIndex());b=
this.getMinPageIndex(b);return bookConfig.RightToLeft?[b,b-1,b-2]:[b+1,b+2,b+3]},getAttachmentByName:function(b){var c=this.getBook();if(!c)return null;var d;return(b=null==c?void 0:null==(d=c.bookAttachments)?void 0:d.getItemByName(b))?b:null},getPageAnnotationByIndex:function(b){var c=this.getBook();if(!c)return null;var d,e,f,g,h=null==(e=null==c?void 0:null==(d=c.pageArray[b])?void 0:d.page)?void 0:null==(f=e.pageAttachments)?void 0:null==(g=f.pageAnnotation)?void 0:g.pageAnnotation;if(!h){var k,
l,m,q,p;h=null==c?void 0:null==(k=c.pageArray[b])?void 0:null==(l=k.pageArray)?void 0:null==(m=l[b])?void 0:null==(q=m.pageAttachments)?void 0:null==(p=q.pageAnnotation)?void 0:p.pageAnnotation}return h}}}),FlipHistory=Class({create:function(){this.array=[];this.currentIndex=0},backward:function(){var b=this.currentIndex-1;void 0!=this.array[b]&&(this.currentIndex=b,gotoPageFun(this.array[b].index,!0,"history"),window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons(),global.phoneGotoPagePanel&&
global.phoneGotoPagePanel.updateHistoryButtons&&global.phoneGotoPagePanel.updateHistoryButtons())},forward:function(){var b=this.currentIndex+1;void 0!=this.array[b]&&(this.currentIndex=b,gotoPageFun(this.array[b].index,!0,"history"),window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons(),global.phoneGotoPagePanel&&global.phoneGotoPagePanel.updateHistoryButtons&&global.phoneGotoPagePanel.updateHistoryButtons())},addFromCurrentIndex:function(b){this.array=this.array.slice(0,this.currentIndex+
1);this.array.push({index:b});this.currentIndex=this.array.length-1;window.toolBar&&toolBar.updateHistoryButtons&&toolBar.updateHistoryButtons();global.phoneGotoPagePanel&&global.phoneGotoPagePanel.updateHistoryButtons&&global.phoneGotoPagePanel.updateHistoryButtons()},push:function(b){this.array.push({index:b})},canBackward:function(){return void 0!=this.array[this.currentIndex-1]},canForward:function(){return void 0!=this.array[this.currentIndex+1]}}),flipHistory=new FlipHistory,IssuuPage=Class({create:function(b,
c,d,e){this._super(b,c,d,e);this.renderPage();this.addFlipShadow()},remove:function(){this.sideImage&&this.sideImage.remove();this.side.remove();this.sideImage=this.side=void 0;this.pageBackground&&this.pageBackground.destroy();this.render&&(this.render.taskPool.stop(),this.renderInterval&&(window.clearInterval(this.renderInterval),this.renderInterval=void 0));this.hasReader&&this.destroySlider()},destroy:function(){this.pageBackground&&this.pageBackground.destroy();this.sideImage=this.side=void 0;
this.hasReader&&this.destroySlider()},hasReader:function(){return window.readerConfig&&0<window.readerConfig.pages.length&&window.readerConfig.pages.length>=this.pageIndex&&(this.hasReaderItems()||window.inverseEditor&&window.inverseEditor.length&&window.inverseEditor[this.pageIndex-1]&&window.inverseEditor[this.pageIndex-1].length)?!0:!1},hasReaderItems:function(){var b=window.readerConfig.pages[this.pageIndex-1];return b&&0!==Object.values(b).filter(function(c){return Array.isArray(c)&&c.length}).length},
loading:function(){if("restrict"!=BookRestrict.isRestrictPage(this.pageIndex)){if(this.originalImageLoaded)if(this.hasReader()){if(this.pageReaderLoaded)return}else return;this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))}},unLoading:function(b){this.hasReader()&&!b||!this.loadingImage||(this.loadingImage.css({display:"none"}),
this.loadingImage.remove(),this.loadingImage=null)},restrict:function(){if(!this.restrictImage){this.restrictImage=$("<div class='loadingOuter'></div>");var b=1==this.pageIndex?getMeta("og:image"):bookConfig.pageRestrictUrl;this.restrictImage.css({"background-image":"url("+b+")"});1==this.pageIndex?this.restrictImage.css({"background-size":"contain"}):this.restrictImage.css({"background-size":"auto"});this.mirrorRestrict();this.sideContent.append(this.restrictImage)}},unRestrict:function(){this.restrictImage&&
(this.restrictImage.remove(),this.restrictImage=null)},mirrorRestrict:function(){if(this.isMirrorSide&&this.restrictImage){var b="scaleX(-1)";bookConfig.FlipDirection&&(b="scaleY(-1)");this.restrictImage.css({"-webkit-transform":b,"-moz-transform":b,"-o-transform":b,"-ms-transform":b,opacity:.2})}},mirrorSide:function(){this.isMirrorSide=!0;var b="scaleX(-1)";bookConfig.FlipDirection&&(b="scaleY(-1)");this.sideImage.css({"-webkit-transform":b,"-moz-transform":b,"-o-transform":b,"-ms-transform":b,
opacity:.2});this.rendering&&(this.rendering.destroy(),this.rendering=null);this.unLoading()},fillPreviewImage:function(){var b=this,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return bookConfig.loadPreviewImage?b.isMirrorSide||window.sliderJS&&window.sliderJS[b.pageIndex-1]&&sliderJS[b.pageIndex-1].elements&&sliderJS[b.pageIndex-1].elements.length?e.jumpTo(0):e.yield(getPageDir(b.pageIndex,"previewPage",originTotalPageCount),3):e.return();c=e.yieldResult;
c.startsWith("none")||(b.sideImage.css({"background-image":"url("+c+")","background-size":"contain","background-repeat":"no-repeat","background-position":"center"}),bookConfig.removeLoad&&(d=$("<img alt='' src='"+c+"'/>"),d[0].onload=function(){this.unLoading();this.unRestrict();this.removeLoad=!0}.bind(b)));e.jumpToEnd()})},setFlipShadow:function(b,c,d){this.pageFlipShadow&&this.pageFlipShadow.flip(b,c,d)},addFlipShadow:function(){bookConfig.HardInnerPageEnable?this.addHardFlipShadow():this.pageFlipShadow||
(this.pageFlipShadow="magazine"==bookConfig.pageHighlightType?new IssuuPageHighlightsFlipShadow(this.side,this.pageIndex):new IssuuPageFlipShadow(this.side,this.pageIndex))},addHardFlipShadow:function(){this.pageFlipShadow||(this.pageFlipShadow=new HardPageFlipShadow(this.side))},clearFlipShadow:function(){this.pageFlipShadow&&this.pageFlipShadow.clear();this.side.removeClass("boxShadow")},resizeFlipShadow:function(b,c){this.pageFlipShadow&&this.pageFlipShadow.resize(b,c)},centerPage:function(){this.isLeft=
!1;this.side.attr("class","center-side")},setLeftOrRight:function(b){(this.isLeft=b)?this.side.attr("class","left-side"):this.side.attr("class","right-side")},setUpOrDown:function(b){(this.isUp=b)?this.side.attr("class","up-side"):this.side.attr("class","down-side")},renderPage:function(){this.rendering&&(this.rendering.destroy(),this.rendering=null);this.rendering=new PageRendering(this.side,this.pageIndex,this.bookType);this.rendering.onResize(this.width,this.height);this.rendering.render()},hideMiddleShadow:function(){this.rendering&&
this.rendering.hideMiddleShadow()},fillContent:function(b){"restrict"==BookRestrict.isRestrictPage(this.pageIndex)?this.restrict():this.fillPage(this.pageIndex,b)},fillPage:function(b,c,d){this.isMirrorSide&&!bookConfig.showMirrorSide||b!=this.pageIndex||this.originalImageLoaded||(d||(d="normal",this.isMirrorSide&&(d="thumb")),"normal"==d&&(bookConfig.usePdfJs?(b=function(e,f,g){this.pageBackground.load.renderCnvas(e,f,g,this.pageIndex,this.pageWidth,this.pageHeight,this.initContents.bind(this))}.bind(this),
...
c();var d=window.setInterval(function(){window.readerConfigLoaded&&(window.clearInterval(d),c())},100)}catch(e){}},onPageLoaded:function(){this.pageReaderLoaded=!0;this.unLoading(!0);var b=this.pageIndex;BookInfo.getBook().getRealBookIndex&&(b=BookInfo.getBook().getRealBookIndex(this.pageIndex));BookInfo.getBook().onBookPageLoaded(b)},enterSide:function(){this._pageEnterTime=Date.now();this.pageAttachments&&this.pageAttachments.enterSide();this.pageBackground&&this.pageBackground.enterSide();window.vuePopDom&&
window.vuePopDom.enterPage&&window.vuePopDom.enterPage()},leaveSide:function(){if(null!=this._pageEnterTime){var b=Date.now()-this._pageEnterTime;this._pageEnterTime=void 0;BookEvent.trigger("customEvent",["time_on_page_"+this.pageIndex+"_"+b/1E3])}this.pageAttachments&&this.pageAttachments.leaveSide();this.pageBackground&&this.pageBackground.leaveSide();window.vuePopDom&&window.vuePopDom.leavePage&&window.vuePopDom.leavePage()},initSelectTextEvent:function(){this.pageAttachments&&this.pageAttachments.select()},
destroySelect:function(){this.pageAttachments&&this.pageAttachments.destroySelect()},initMagnifierEvent:function(){this.pageAttachments&&this.pageAttachments.initMagnifierEvent()},destroyMagnifier:function(){this.pageAttachments&&this.pageAttachments.destroyMagnifier()},pauseAnimation:function(){this.pageAttachments&&this.pageAttachments.pauseAnimation()},startAnimation:function(){this.pageAttachments&&this.pageAttachments.startAnimation()},resetSlider:function(){this.pageAttachments&&this.pageAttachments.resetSlider()},
destroySlider:function(){this.pageAttachments&&this.pageAttachments.destroySlider()},addHistoryTexts:function(){this.pageAttachments&&this.pageAttachments.addHistoryTexts()},highlightSearch:function(){this.pageAttachments&&this.pageAttachments.highlightSearch()},clearHighlight:function(){this.pageAttachments&&this.pageAttachments.clearHighlight()},initReaderOrSlider:function(){this.pageAttachments&&this.pageAttachments.initReaderOrSlider()},onResize:function(b,c){this.resizePage(b,c);this.resizeFlipShadow(b,
c);if(this.rendering)this.rendering.onResize(b,c);this.pageAttachments&&(fitPageWidthHeight(this.pageWidth,this.pageHeight,this.imageWidth,this.imageHeight),this.pageAttachments.onResize(this.pageWidth,this.pageHeight,this.pageWidth,this.pageHeight))},resizePage:function(b,c){this.width=b;this.height=c;this.pageWidth=parseInt(100*b/(-parseFloat(bookConfig.visibleAreaLeft)+parseFloat(bookConfig.visibleAreaRight)));this.pageHeight=parseInt(100*c/(parseFloat(bookConfig.visibleAreaBottom)-parseFloat(bookConfig.visibleAreaTop)));
this.side.css({width:b,height:c});this.sideContent.css({width:this.pageWidth,height:this.pageHeight,top:-this.pageHeight*parseFloat(bookConfig.visibleAreaTop)/100,left:-this.pageWidth*parseFloat(bookConfig.visibleAreaLeft)/100});if(this.pageBackground)this.pageBackground.onResize(this.pageWidth,this.pageHeight)},zoomInSideImage:function(){this.pageBackground.zoomIn()},zoomOutSideImage:function(){this.pageBackground.zoomOut()},switchLargeImage:function(){this.pageBackground&&this.pageBackground.zoomIn(this.onSwitchImage.bind(this))},
switchNormalImage:function(b){this.pageBackground&&this.pageBackground.zoomOut(b,this.onSwitchImage.bind(this))},onSwitchImage:function(b,c,d){if(!this.originalImageLoaded)this.initContents(b,c,d);else if(b)if("string"==typeof c)isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),this.sideImage.empty().append(d),this.imageWidth=d.naturalWidth,this.imageHeight=d.naturalHeight;else{this.sideImage.empty();
for(b=0;b<d.length;b++)isPhone()||isPad()?bookConfig.EnableRecognizeQRcodePressOnMobile||$(d).css({"pointer-events":"none"}):bookConfig.isStopMouseMenu&&$(d).css({"pointer-events":"none"}),this.sideImage.append(d[b]);this.imageWidth=d[b][0].naturalWidth;this.imageHeight=d[b][0].naturalHeight}},resizeSvg:function(b,c){try{this.pageBackground.resizeSvg(b,c)}catch(d){}}}).extend(Side);bdor[30]=function(b,c){return bdor[b]-c};bdor[38]=function(){return bdor[30](37,40)}();
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(y){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;q=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(q=q.removeStartFrom("?"));m.imageURL=q;m.imageObject=new ImageObject;m.imageObject.alt(m.index);
m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);
bookConfig.textSharpening&&(p="-webkit-optimize-contrast",_agent_.browser.firefox&&(p="-moz-crisp-edges"),_agent_.browser.opera&&(p="-o-crisp-edges"),m.$image.css({"image-rendering":p,"-ms-interpolation-mode":"nearest-neighbor"}));y.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&isPC()?this.switchNormalImage(b,c):(isPhone()||isPad())&&this.resize()},
...
c,d,e,f,g,h,k,l){var m=this,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;q=c;bookConfig.useTheAliCloudChart&&!bookConfig.isEncryptionBook&&(q=q.removeStartFrom("?"));m.imageURL=q;m.$image=$("<img alt='' src='"+m.imageURL+"' style='z-index:0;'/>");bookConfig.EnableRecognizeQRcodePressOnMobile&&m.$image.css({"-webkit-touch-callout":"default"});m.$image[0].onload=function(){this.callback&&
this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.errorCallback&&this.errorCallback(this.$image)}.bind(m);p.jumpToEnd()})},zoomIn:function(b){},zoomOut:function(b,c){},onResize:function(b,c){this.pageWidth=b;this.pageHeight=c;this.$image.css({width:"100%",height:"100%",position:"absolute",top:0,left:0});b=!1;if(isPhone()||isPad())b=!0;b=transformCSS({scale:1,
...
c,this.width,this.height),this.scale(b.x,b.y)}}),IssuuImageArrayLoad=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g){var h=this,k,l,m,q,p,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){if(1==u.nextAddress)return h.index=b,h.type=c,h.pageWidth=e,h.pageHeight=f,h.isMirrorSide=g,h.callback=d,h.$images=[],h.loadArray=[],u.yield(getPageDir(b,c,originTotalPageCount),2);k=u.yieldResult;h.imagesURL=k;l=
0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);q=function(r){l++;this.$images.removeElement(r);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(p=0;p<k.length;p++)y=-1<k[p].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[p],c,m,q,e,f,g,p):new IssuuImageArrayLoadImage(b,k[p],c,m,q,e,f,g,p),h.$images.push(y.$image),h.loadArray.push(y);u.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
k.enableRecognizeQRcode();k.setTextSharpening();q.jumpToEnd()})},onLoad:function(){this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;if(!(this.width>1.25*this.pageWidth&&this.height>1.25*this.pageHeight)||!0!==bookConfig.canvasRender&&"true"!==bookConfig.canvasRender||isPhone()||isPad())this.width=this.$image[0].naturalWidth,this.height=this.$image[0].naturalHeight,this.callback&&this.callback(this.realImageURL,this.realImageURL,this.$image[0],this.index),this.onResize();
else try{this.canvasDom=document.createElement("canvas");this.canvasDom.setAttribute("id","pageCanvas");this.canvasDom.setAttribute("width",this.width);this.canvasDom.setAttribute("height",this.height);var b=this.canvasDom.getContext("2d");b.width=this.width;b.height=this.height;b.drawImage(this.$image[0],0,0);canvasReload(this.canvasDom,this.pageWidth,this.pageHeight,!0);this.callback&&this.callback(this.realImageURL,this.realImageURL,this.canvasDom,this.index)}catch(c){this.width=this.$image[0].naturalWidth,
...
d,k.parent=h,l=k,q.yield(getPageDir(b,c,originTotalPageCount),2);if(3!=q.nextAddress)return l.imageURL=q.yieldResult,m=k,q.yield(getPageDir(b,"thumb",originTotalPageCount),3);m.thumbUrl=q.yieldResult;k.$content=$("<div style='position:absolute;left:0;top:0;width:100%;height:100%;'></div>");k.pdfLoadingTask=new PdfLoadingTask(k.index,k.type,e,f,k.loaded.bind(k));window.pdfLoadStack||(window.pdfLoadStack=new PdfLoadArray(3));window.pdfLoadStack&&pdfLoadStack.push(k.pdfLoadingTask);q.jumpToEnd()})},
...
c),pdfLoadStack.push(this.pdfLoadingTask))},destroy:function(){this.pdfLoadingTask&&(window.pdfLoadStack&&pdfLoadStack.pop(this.pdfLoadingTask),this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),IsuuPageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,m,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress){if(!b||!c)return p.return();k.type=c;k.pageWidth=e;k.pageHeight=f;return p.yield(getPageDir(b,c,originTotalPageCount),2)}l=p.yieldResult;m=getPageSize(b,
...
Class({create:function(b){this.book=b;this.flippingTime=1E3*bookConfig.flippingTime},flipIntervalTmp:function(b,c,d,e){if(b){this.book.flipping=!0;b.flipping=!0;var f=.05;if(isIE()||isFirefox())f=0;b.setFlipOriginPoint(e);b.coordinate||(b.coordinate=b.startPoint);var g=b.coordinate.x,h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var q=0;k=function(){m(q,25,"Sine");q++}.interval(this,
l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,y){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,t=$.easing["easeInOut"+y],v=$.easing["easeOut"+y];y=v(null,q,g,b.toPoint.x-g,p);v=v(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(y=t(null,q,g,b.toPoint.x-g,p),v=bookConfig.FlipDirection?f*Math.sqrt(r*r-y*y):r-f*Math.sqrt(u*u-y*y));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:y,y:v}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var m=1,q=1;m=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);q=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);for(c=0;c<b.length;c++){var p=this.pageArray[b[c]];if(p){var y=transformCSS({tran:l?l:{x:0,y:0},scale:{x:m,y:q},origin:g});this.isCoverPage(b[c])&&(p.tran=l?l:{x:0,y:0},p.scale={x:m,y:q},p.rotateY?(p.$page[0].style.removeProperty("transform-origin"),
d=void 0,y=transformCSS({scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})):(d=void 0,y=transformCSS({origin:g,scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})));p.setCSSByStyle(y);if(p.page.pageFlipShadow){var u=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});p.page.pageFlipShadow&&p.page.pageFlipShadow.setCSSByStyle(u)}}}return{x:m,y:q}}catch(r){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,
...
this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){var m=this;try{var q=1,p=1;q=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(u){if(u){var r=
transformCSS({tran:l?l:{x:0,y:0},scale:{x:q,y:p},origin:g});if(m.isCoverPage(u.pageIndex))if(u.tran=l?l:{x:0,y:0},u.scale={x:q,y:p},u.rotateY){u.$page[0].style.removeProperty("transform-origin");var t;r=transformCSS({scale:{x:q,y:p},perspective:6E3,rotateY:null!=(t=u.rotateY)?t:0})}else{var v;r=transformCSS({origin:g,scale:{x:q,y:p},perspective:6E3,rotateY:null!=(v=u.rotateY)?v:0})}u.setCSSByStyle(r);r=h?transformCSS({scale:{x:k.x/q,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});u.page.pageFlipShadow&&
u.page.pageFlipShadow.setCSSByStyle(r)}};for(d=0;d<b.length;d++){var y=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(y)}return{x:q,y:p}}catch(u){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&pageList[b[f]-1]?pageList[b[f]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):
...
var googleAnalytics=function(){bookConfig.googleAnalyticsID&&(createPageDurationTracker({onReport:function(b){window.gtag&&(gtag("event","time_on_book_"+b/1E3,{time_on_book:b/1E3}),gtag("event","exit_on_page_"+BookInfo.getCurrentPages().join("-"),{exit_on_page:BookInfo.getCurrentPages().join("-")}))}}),window.setTimeout(function(){loadJavascript("https://www.googletagmanager.com/gtag/js?id="+bookConfig.googleAnalyticsID,function(){window.dataLayer=window.dataLayer||[];window.gtag=function(){dataLayer.push(arguments)};
gtag("js",new Date);gtag("config",bookConfig.googleAnalyticsID);gtag("event","open_book");gtag("event","device_"+getDeviceType(),{device_type:getDeviceType()});gtag("event","operating_system_"+getDeviceOS(),{system_name_and_version:getDeviceOS()});gtag("event","browser_"+getBrowserAndVersion(),{browser_name_and_version:getBrowserAndVersion()})},function(){})},3E3))},googleTagManager=function(){bookConfig.googleTagManagerID&&window.setTimeout(function(){var b=window,c=bookConfig.googleTagManagerID;
b.dataLayer=b.dataLayer||[];b.dataLayer.push({"gtm.start":(new Date).getTime(),event:"gtm.js"});b=document.getElementsByTagName("script")[0];var d=document.createElement("script");d.async=!0;d.src="https://www.googletagmanager.com/gtm.js?id="+c;b.parentNode.insertBefore(d,b)},3E3)};
function createPageDurationTracker(b){function c(){l&&(l=!1,k+=Date.now()-h,h=null)}function d(){var m=k;l&&null!=h&&(m+=Date.now()-h);"function"===typeof g&&g(m)}function e(){"visible"===document.visibilityState?l||(l=!0,h=Date.now()):c()}function f(){c();d()}var g=(void 0===b?{}:b).onReport,h=Date.now(),k=0,l=!0;document.addEventListener("visibilitychange",e);window.addEventListener("beforeunload",f);return{report:d,destroy:function(){document.removeEventListener("visibilitychange",e);window.removeEventListener("beforeunload",
f)}}}
var PluginEvent=Class({statics:{bindEvent:function(b,c){"string"==typeof b&&c&&"function"==typeof c&&(this[b]||(this[b]=[]),this[b].push(c))},removeEvent:function(b,c){"string"==typeof b&&c&&"function"==typeof c&&this[b].removeElement(c)},trigger:function(b,c){if((b=this[b])&&0!=b.length){for(var d=!1,e=0;e<b.length;e++)"function"==typeof b[e]&&(d=b[e].apply(this,c)||d);return d}}}}),logEvent=Class({statics:{printLog:!1,visit:function(b,c,d,e,f,g){logEvent.printLog&&console.log("visit",b,c,d,e,f,
g)},beforeFlipPage:function(b){logEvent.printLog&&console.log("beforeFlipPage",b)},afterFlipPage:function(b){logEvent.printLog&&console.log("afterFlipPage",b)},flipPage:function(b,c,d,e){statisticalData(1,c);bookConfig.googleAnalyticsID&&window.gtag&&"popstate"!==b&&(gtag("event","go_to_page_"+d,{}),logEvent.printLog&&console.log("flipPage",b,c,d,e))},suspendFlipPage:4,zoomIn:function(b,c){logEvent.printLog&&console.log("zoomIn",b,c)},zoomOut:function(b,c){logEvent.printLog&&console.log("zoomOut",
b,c)},zoomMove:function(b,c){logEvent.printLog&&console.log("zoomMove",b,c)},jumpLink:function(b,c,d){logEvent.printLog&&console.log("jumpLink",b,c,d)},clickButton:function(b,c,d){bookConfig.googleAnalyticsID&&window.gtag&&gtag("event","click_"+c+"_button",{});logEvent.printLog&&console.log("clickButton",b,c,d)},search:function(b,c,d){statisticalData(6,b);logEvent.printLog&&console.log("search",b,c,d)},share:function(b,c,d){logEvent.printLog&&console.log("share",b,c,d)},print:function(b,c,d){logEvent.printLog&&
console.log("print",b,c,d)},addBookmark:function(b,c,d){logEvent.printLog&&console.log("addBookmark",b,c,d)},deleteBookmark:function(b){logEvent.printLog&&console.log("deleteBookmark",b)},editBookmark:function(b,c,d){logEvent.printLog&&console.log("deleteBookmark",b,c,d)},googleAdSense:function(b,c,d,e,f,g){logEvent.printLog&&console.log("googleAdSense",b,c,d,e,f,g)},playMedia:function(b,c,d,e,f){logEvent.printLog&&console.log("playMedia",b,c,d,e,f)},passward:function(b,c){logEvent.printLog&&console.log("passward",
b,c)},clickPageItem:function(b,c,d,e,f,g){logEvent.printLog&&console.log("clickPageItem",b,c,d,e,f,g)},orientationchange:function(b,c,d){logEvent.printLog&&console.log("orientationchange",b,c,d)},windowClick:function(b,c,d){logEvent.printLog&&console.log("windowClick",b,c,d)},readArticle:function(b){logEvent.readArticle&&console.log("readArticle",b)},errorLog:function(b){logEvent.errorLog&&console.log("errorLog",b)},customEvent:function(b,c){bookConfig.googleAnalyticsID&&window.gtag&&gtag("event",
b,Object.assign({},c));logEvent.printLog&&console.log("customEvent",b,c)}}});BookEvent.bindEvent("visit",logEvent.visit);BookEvent.bindEvent("flipPage",logEvent.flipPage);BookEvent.bindEvent("jumpLink",logEvent.jumpLink);BookEvent.bindEvent("zoomIn",logEvent.zoomIn);BookEvent.bindEvent("zoomOut",logEvent.zoomOut);BookEvent.bindEvent("zoomMove",logEvent.zoomMove);BookEvent.bindEvent("clickButton",logEvent.clickButton);BookEvent.bindEvent("search",logEvent.search);BookEvent.bindEvent("share",logEvent.share);
BookEvent.bindEvent("print",logEvent.print);BookEvent.bindEvent("addBookmark",logEvent.addBookmark);BookEvent.bindEvent("deleteBookmark",logEvent.deleteBookmark);BookEvent.bindEvent("editBookmark",logEvent.editBookmark);BookEvent.bindEvent("googleAdSense",logEvent.googleAdSense);BookEvent.bindEvent("playMedia",logEvent.playMedia);BookEvent.bindEvent("passward",logEvent.passward);BookEvent.bindEvent("clickPageItem",logEvent.clickPageItem);BookEvent.bindEvent("orientationchange",logEvent.orientationchange);
BookEvent.bindEvent("windowClick",logEvent.windowClick);BookEvent.bindEvent("suspendFlipPage",logEvent.suspendFlipPage);BookEvent.bindEvent("beforeFlipPage",logEvent.beforeFlipPage);BookEvent.bindEvent("errorLog",logEvent.errorLog);BookEvent.bindEvent("customEvent",logEvent.customEvent);
...
window.getWidth(),windowHeight=c=window.getHeight(),windowWidth=b,e.yield(checkFliphtml5PagesConfig(),2);case 2:return e.yield(checkBookConfig(),3);case 3:return e.yield(validateDomainAccess(),4);case 4:d=e.yieldResult;if(!d)return e.return();selectLanguage(bookConfig.language);initImageBaseUrl();global.onBookLoad=new LoadingBook(tmpContainer,bookConfig.loadingBackground);if("article4"===global.templeteName){e.jumpTo(5);break}return e.yield(initToolBarBrand(),5);case 5:delayLoading();var f=document.getElementById("aria-page-title-header");
if(f)var g=document.getElementById("aria-page-title");else f=document.createElement("header"),f.id="aria-page-title-header",f.setAttribute("aria-hidden","true"),f.style.cssText="position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0);",g=document.createElement("h1"),g.id="aria-page-title",f.appendChild(g),document.body.appendChild(f);g&&(g.textContent=document.title);e.jumpToEnd()}})}function extractBrandPath(b){b=b.split("/");b.pop();return b.join("/")}
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(q,p){var y=l[p];if(y){y.width=q.width;y.height=q.height;q=q.toDataURL();var u=new Image;p=new Promise(function(r){u.onload=function(){y.getContext("2d").drawImage(u,0,0);r()};u.onerror=function(){return r()}});u.src=q;m.push(p)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){p&&p();g.print(l)}var q=b(l.doc).find("img"),p=h&&"function"===typeof h.onReady?h.onReady:null;if(0===q.length)m();else{var y=0;q.each(function(u,r){if(r.complete)y++,y===q.length&&m();else b(r).on("load error",function(){y++;y===q.length&&
...
"strict")+'.dtd">'},getHead:function(){var h="";f.extraHead&&f.extraHead.replace(/([^,]+)/g,function(k){h+=k});return"<head><title>"+f.popTitle+"</title>"+h+"</head>"},getBody:function(h){var k="",l=f.retainAttr;h.each(function(){for(var m=g.getFormData(b(this)),q="",p=0;p<l.length;p++){var y=b(m).attr(l[p]);y&&(q+=(0<q.length?" ":"")+l[p]+"='"+y+"'")}k+="<div "+q+">"+b(m).html()+"</div>"});return"<body>"+k+"</body>"},getFormData:function(h){var k=h.clone(),l=b("input,select,textarea",k);b("input,select,textarea",
h).each(function(m){var q=b(this).attr("type");"undefined"===b.type(q)&&(q=b(this).is("select")?"select":b(this).is("textarea")?"textarea":"");var p=l.eq(m);"radio"==q||"checkbox"==q?p.attr("checked",b(this).is(":checked")):"text"==q?p.attr("value",b(this).val()):"select"==q?b(this).find("option").each(function(y){b(this).is(":selected")&&b("option",p).eq(y).attr("selected",!0)}):"textarea"==q&&p.text(b(this).val())});return k},getPrintWindow:function(){switch(f.mode){case "iframe":var h=new g.Iframe;
...
$("<div id='dialog'></div>");this.insetBox=$("<div></div>");this.leftBar=$("<div></div>");this.rightBar=$("<div></div>");this.img=$("<img alt='' style='position : absolute;' />");this.textBox=$("<div></div>");this.upIcon=$("<div><div></div></div>");this.titleBox=$("<div></div>");this.descBox=$("<div class='stage'></div>");this.descSwiper=$("<div class='swiper'></div>");this.descBox.append(this.descSwiper);this.textBox.append(this.titleBox).append(this.descBox).append(this.upIcon);this.initScroll();
this.closeButton=new button(this.parent,{buttonType:1,iconURL:uiBaseURL+"closecat.png"},!0);this.loadingImage=$("<div><img alt='' src='"+uiBaseURL+"progress.gif' style='position:absolute;'/></div>");this.insetBox.append(this.loadingImage);this.dialog.append(this.insetBox);this.dialog.append(this.textBox);this.parent.append(this.leftBar);this.parent.append(this.rightBar)},initScroll:function(){this.progress=$("<div class='progress'></div>");this.progressBar=$("<div class='progressBar'></div>");this.progress.append(this.progressBar);
